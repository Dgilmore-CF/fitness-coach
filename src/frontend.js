...
(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&n(s)}).observe(document,{childList:!0,subtree:!0});function r(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(a){if(a.ep)return;a.ep=!0;const o=r(a);fetch(a.href,o)}})();const ne=Symbol("raw"),Ee=Symbol("trusted");class W{constructor(t){this[Ee]=!0,this.value=String(t)}toString(){return this.value}}function q(e){return e==null||e===!1?new W(""):new W(e)}function Re(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ce(e){return String(e).replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;")}function pe(e){return e==null||e===!1?"":e===!0?"true":e instanceof W?e.value:e&&typeof e=="object"&&ne in e?e[ne]:Array.isArray(e)?e.map(pe).join(""):Re(e)}function i(e,...t){let r=e[0];for(let n=0;n<t.length;n++)r+=pe(t[n])+e[n+1];return new W(r)}function ge(e){const t=e instanceof W?e.value:String(e).trim(),r=document.createElement("template");return r.innerHTML=t,r.content.firstElementChild}const ue="fitness-coach:state",me={user:null,currentWorkout:null,currentProgram:null,currentTab:"dashboard",ui:{theme:"system",activeModal:null,lastVisitedTab:null},workout:{activeExerciseIndex:0,restTimerEndTime:null,workoutStartTime:null,exerciseHistory:{},modifications:{added:[],deleted:[]},pendingNotes:""},mealTracking:{searchResults:[],selectedFoods:[],currentMealType:null,scannerActive:!1},pastWorkout:{date:null,programId:null,programDayId:null,exercises:[]},analytics:{lastFetch:null,data:null},aiCoach:{conversationHistory:[],lastInsight:null}},ye=["ui"];function J(e,t){return t?t.split(".").reduce((r,n)=>r==null?r:r[n],e):e}function he(e,t,r){if(!t)return r;const n=t.split("."),a=n.pop(),o=n.reduce((s,l)=>((s[l]==null||typeof s[l]!="object")&&(s[l]={}),s[l]),e);return o[a]=r,e}function ae(e){return e==null||typeof e!="object"?e:JSON.parse(JSON.stringify(e))}function Pe(){try{const e=localStorage.getItem(ue);return e?JSON.parse(e):{}}catch{return{}}}function Ie(e){try{const t={};for(const r of ye){const n=J(e,r);n!==void 0&&he(t,r,n)}localStorage.setItem(ue,JSON.stringify(t))}catch{}}class Ae{constructor(t){this.data=ae(t),this.subscribers=new Map;const r=Pe();for(const[n,a]of Object.entries(r))this.data[n]={...this.data[n],...a}}get(t){return J(this.data,t)}set(t,r){const n=this.get(t);if(n===r)return;he(this.data,t,r),ye.some(o=>t===o||t.startsWith(\`\${o}.\`))&&Ie(this.data),this.notify(t,r,n);const a=t.split(".");for(let o=a.length-1;o>0;o--){const s=a.slice(0,o).join(".");this.notify(s,this.get(s),null)}}merge(t,r){const n=this.get(t)||{};this.set(t,{...n,...r})}reset(t){const r=J(me,t);this.set(t,ae(r))}subscribe(t,r){this.subscribers.has(t)||this.subscribers.set(t,new Set);const n=this.subscribers.get(t);return n.add(r),()=>n.delete(r)}notify(t,r,n){const a=this.subscribers.get(t);if(a)for(const o of a)try{o(r,n)}catch(s){console.error(\`Subscriber error for "\${t}":\`,s)}}}const f=new Ae(me);typeof window<"u"&&(window.__store=f);const ve="/api",Le=3e4,qe=6e4,N=new Map;class K extends Error{constructor(t,{status:r=0,code:n=null,details:a=null}={}){super(t),this.name="ApiError",this.status=r,this.code=n,this.details=a}}async function I(e,t={}){var B;const{method:r="GET",body:n,headers:a={},cache:o=!1,timeout:s=Le,signal:l}=t,c=\`\${ve}\${e}\`,u=\`\${r} \${c}\`;if(r==="GET"&&o){const \$=N.get(u);if(\$&&Date.now()-\$.at<qe)return \$.data}const m=new AbortController,y=setTimeout(()=>m.abort(),s);l&&l.addEventListener("abort",()=>m.abort(),{once:!0});const x={method:r,headers:{"Content-Type":"application/json",...a},signal:m.signal};n!=null&&(n instanceof FormData?(delete x.headers["Content-Type"],x.body=n):typeof n=="string"?x.body=n:x.body=JSON.stringify(n));let S;try{S=await fetch(c,x)}catch(\$){throw clearTimeout(y),\$.name==="AbortError"?new K("Request timed out",{code:"TIMEOUT"}):new K("Network error",{code:"NETWORK",details:\$.message})}clearTimeout(y);const M=(B=S.headers.get("content-type"))==null?void 0:B.includes("application/json"),v=M?await S.json().catch(()=>({})):await S.text();if(!S.ok){const \$=M&&(v==null?void 0:v.error)||\`Request failed (\${S.status})\`;throw new K(\$,{status:S.status,code:v==null?void 0:v.code,details:v==null?void 0:v.details})}return r==="GET"&&o&&N.set(u,{data:v,at:Date.now()}),v}function He(e=""){const t=\`GET \${ve}\${e}\`;for(const r of N.keys())r.startsWith(t)&&N.delete(r)}const p={get:(e,t)=>I(e,{...t,method:"GET"}),post:(e,t,r)=>I(e,{...r,method:"POST",body:t}),put:(e,t,r)=>I(e,{...r,method:"PUT",body:t}),patch:(e,t,r)=>I(e,{...r,method:"PATCH",body:t}),delete:(e,t)=>I(e,{...t,method:"DELETE"}),request:I,invalidateCache:He},ie={success:"fa-check-circle",error:"fa-exclamation-circle",warning:"fa-exclamation-triangle",info:"fa-info-circle"},Be=3e3;let w=null;function De(){return w&&document.body.contains(w)||(w=document.getElementById("toast-container"),w||(w=document.createElement("div"),w.id="toast-container",w.setAttribute("aria-live","polite"),w.setAttribute("aria-atomic","true"),document.body.appendChild(w))),w}function D(e,t={}){var m;const{type:r="info",duration:n=Be,icon:a,action:o}=t,s=a?\`fa-\${a}\`:ie[r]||ie.info,l=ge(i\`
    <div class="toast toast-\${ce(r)}" role="alert">
  ...
  \`);De().appendChild(l),o!=null&&o.onClick&&((m=l.querySelector(".toast-action"))==null||m.addEventListener("click",()=>{o.onClick(),u()}));let c=!1;const u=()=>{c||(c=!0,l.style.animation="slide-out-right var(--transition-base) forwards",l.addEventListener("animationend",()=>l.remove(),{once:!0}))};return n>0&&setTimeout(u,n),u}const g={show:(e,t)=>D(e,t),success:(e,t)=>D(e,{...t,type:"success"}),error:(e,t)=>D(e,{...t,type:"error",duration:(t==null?void 0:t.duration)??5e3}),warning:(e,t)=>D(e,{...t,type:"warning"}),info:(e,t)=>D(e,{...t,type:"info"})},A=[];function Fe(){let e=document.getElementById("modal-root");return e||(e=document.createElement("div"),e.id="modal-root",document.body.appendChild(e)),e}function We(e){const t=e.querySelectorAll('a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])');if(t.length===0)return null;const r=t[0],n=t[t.length-1],a=o=>{o.key==="Tab"&&(o.shiftKey&&document.activeElement===r?(o.preventDefault(),n.focus()):!o.shiftKey&&document.activeElement===n&&(o.preventDefault(),r.focus()))};return e.addEventListener("keydown",a),r.focus(),()=>e.removeEventListener("keydown",a)}function z(e){var re;const{title:t,content:r,actions:n=[],size:a="default",dismissable:o=!0,onOpen:s,onClose:l}=e,c=a==="wide"?"modal-wide":a==="fullscreen"?"modal-fullscreen":"",u=n.length?i\`
  ...
  \`),x=y.querySelector(".modal"),S=y.querySelector(".modal-body");r instanceof Node?S.appendChild(r):r!=null&&(S.innerHTML=String(r));const M=document.activeElement;let v=!1,B;const \$=new Promise(h=>B=h),R=h=>{if(v)return;v=!0;const E=A.indexOf(C);E>=0&&A.splice(E,1),U==null||U(),y.style.animation="fade-out var(--transition-fast) forwards",x.style.animation="slide-up var(--transition-fast) reverse forwards",y.addEventListener("animationend",()=>{var P;y.remove(),(P=M==null?void 0:M.focus)==null||P.call(M)},{once:!0}),A.length===0&&(document.body.style.overflow=""),l==null||l(h),B(h)},C={element:x,backdrop:y,close:R,promise:\$};y.querySelectorAll("[data-modal-action]").forEach(h=>{const E=parseInt(h.getAttribute("data-modal-action"),10),P=n[E];h.addEventListener("click",async()=>{P.onClick?await P.onClick(C):R(P.value??E)})}),(re=y.querySelector("[data-modal-close]"))==null||re.addEventListener("click",()=>R()),o&&y.addEventListener("click",h=>{h.target===y&&R()});const te=h=>{h.key==="Escape"&&o&&A[A.length-1]===C&&R()};document.addEventListener("keydown",te);const Ce=R;C.close=h=>{document.removeEventListener("keydown",te),Ce(h)},Fe().appendChild(y),document.body.style.overflow="hidden",A.push(C);const U=We(x);return s==null||s(C),C}function G(e,t={}){const{title:r="Are you sure?",confirmLabel:n="Confirm",cancelLabel:a="Cancel",confirmVariant:o="btn-primary"}=t;return new Promise(s=>{z({title:r,content:i\`<p>\${e}</p>\`,actions:[{label:a,variant:"btn-outline",onClick:l=>l.close(!1)},{label:n,variant:o,primary:!0,onClick:l=>l.close(!0)}],onClose:l=>s(l===!0)})})}function j({value:e,max:t,size:r=100,label:n,unit:a,color:o}){const s=Math.max(0,Math.min(100,e/(t||1)*100)),l=(r-16)/2,c=2*Math.PI*l,u=c-s/100*c,m=o?\`stroke: \${ce(o)};\`:"";return i\`
...
\`,Ve={hypertrophy:"#hypertrophy-section",strength:"#strength-section",endurance:"#endurance-section",cardio:"#cardio-section",comparison:"#comparison-section",variables:"#variables-section"};function Ge(e){e.innerHTML=Ne,e.addEventListener("click",t=>{var o;const r=t.target.closest("[data-learn-scroll]");if(!r)return;t.preventDefault();const n=r.getAttribute("data-learn-scroll"),a=Ve[n];a&&((o=e.querySelector(a))==null||o.scrollIntoView({behavior:"smooth",block:"start"}))})}function Ue(){const e=document.getElementById("learn");e&&Ge(e)}const be=2.20462,fe=1/2.54;function xe(e){return e==null?0:Math.round(e*be*10)/10}function Ke(e){return e==null?0:Math.round(e/be*100)/100}function je(e){return e*fe}function Ze(e){return e/fe}function Je(e){const t=Math.round(je(e)),r=Math.floor(t/12),n=t-r*12;return{feet:r,inches:n}}function Qe(e,t){return Ze((e||0)*12+(t||0))}function Ye(){const e=f.get("user");return e&&e.measurement_system||"metric"}function we(){return Ye()==="imperial"}function Xe(){return we()?"lbs":"kg"}function et(e){return e==null?0:we()?xe(e):e}function k(e,t={}){const{unit:r=!0,precision:n=1}=t;if(e==null)return"N/A";const a=et(e),o=Xe();let s;return Math.abs(a)>=1e3?s=Math.round(a).toLocaleString():a%1===0?s=String(a):s=a.toFixed(n),r?\`\${s} \${o}\`:s}function _(e){if(e==null||e<0)return"00:00";const t=Math.abs(Math.floor(e)),r=Math.floor(t/3600),n=Math.floor(t%3600/60),a=t%60,o=s=>String(s).padStart(2,"0");return r>0?\`\${o(r)}:\${o(n)}:\${o(a)}\`:\`\${o(n)}:\${o(a)}\`}function T(e,t={month:"short",day:"numeric",year:"numeric"}){if(!e)return"";const[r,n,a]=String(e).split("T")[0].split("-").map(Number);return!r||!n||!a?e:new Date(r,n-1,a).toLocaleDateString("en-US",t)}function tt(e){if(e==null||Number.isNaN(e))return"—";const t=Math.round(e*10)/10;return t===0?"0%":\`\${t>0?"↑":"↓"} \${Math.abs(t)}%\`}function rt(e){return e==null?"":e<=2?"😴":e<=4?"🙂":e<=6?"💪":e<=8?"🔥":"🥵"}const nt={consistency:"🔥",strength:"💪",volume:"📊",milestone:"⭐"},at={consistency:"Consistency",strength:"Strength",volume:"Volume",milestone:"Milestones"},it={bronze:"tier-bronze",silver:"tier-silver",gold:"tier-gold",platinum:"tier-platinum"};function ot(e){const t={};for(const r of e){const n=r.category||"other";t[n]||(t[n]=[]),t[n].push(r)}return t}function st(e,t){return!t||t===0?{text:"First PR!",isFirst:!0}:{text:\`+\${((e-t)/t*100).toFixed(1)}%\`,isFirst:!1}}function lt({currentWeeks:e,longestWeeks:t,totalWorkouts:r,totalPRs:n,earnedCount:a}){return i\`
  ...
  \`}function dt(e){return!e||e.length===0?i\`
    ...
    <div class="table-container">
      <table class="data-table">
        ...
        <tbody>
          \${e.map(t=>{const{text:r,isFirst:n}=st(t.record_value,t.previous_value);return i\`
              <tr>
                ...
                <td>\${T(t.achieved_at)}</td>
              </tr>
            \`})}
        </tbody>
      </table>
    </div>
  \`}function ct(e){const t=Object.keys(e);return t.length===0?i\`
      <div class="empty-state">
    ...
    <div class="stack stack-lg">
      \${t.map(r=>{const n=e[r];return i\`
          <div>
            ...
            <div class="grid grid-cols-auto">
              \${n.map(a=>i\`
                <div class="achievement-card \${it[a.tier]||""}">
                  <div class="achievement-icon">\${a.icon||"🏅"}</div>
                  <div class="achievement-name">\${a.name}</div>
                  <div class="achievement-description">\${a.description}</div>
                  <div class="achievement-date">
                    <i class="fas fa-calendar"></i> \${T(a.earned_at)}
                  </div>
                </div>
              \`)}
            </div>
  ...
  \`}function pt(e,t,r){return!e.current_streak||e.current_streak<=0?"":i\`
    <div class="streak-card">
      <div class="streak-row">
        ...
        <div class="streak-metric">
          ...
          <div class="streak-value-small">\${T(e.streak_start_date)}</div>
        </div>
      </div>
      \${e.last_workout_date?i\`<div class="text-muted" style="font-size: var(--text-sm);">
            Last workout: \${T(e.last_workout_date)}
          </div>\`:""}
    </div>
  ...
  \`}async function mt(){const e=document.getElementById("achievements");if(e){e.innerHTML=String(ut());try{const[t,r,n]=await Promise.all([p.get("/achievements"),p.get("/achievements/prs?limit=10"),p.get("/achievements/streak")]),a=t.earned||[],o=t.stats||{totalWorkouts:0,totalPRs:0},s=r.prs||[],l=n.streak||{},c=Math.floor((l.current_streak||0)/7),u=Math.floor((l.longest_streak||0)/7),m=ot(a);e.innerHTML=String(i\`
      <div class="card">
        ...
        \${lt({currentWeeks:c,longestWeeks:u,totalWorkouts:o.totalWorkouts||0,totalPRs:o.totalPRs||0,earnedCount:a.length})}
    ...
    \`)}catch(t){console.error("Error loading achievements:",t),e.innerHTML=String(gt(t.message))}}}function yt(e){return i\`
    <div class="grid grid-cols-auto">
      <div class="stat-card">
      ...
      <div class="stat-card">
        ...
        <div class="stat-value">\${_(e.total_time_seconds||0)}</div>
      </div>
      <div class="stat-card">
        <div class="stat-label">Avg Workout</div>
        <div class="stat-value">\${_(e.average_workout_time||0)}</div>
      </div>
    </div>
  \`}function ht(){return i\`
    <div class="cluster">
  ...
  \`}function vt(e){const t=!!e.completed,r=t?"✓ Complete":"In Progress",n=t?"badge-success":"badge-warning",a=T(e.start_time,{weekday:"short",month:"short",day:"numeric",year:"numeric"}),o=e.total_weight_kg?k(e.total_weight_kg):"N/A";return i\`
    <div class="workout-card" id="workout-card-\${e.id}">
        ...
        <div class="workout-card-header-main">
          ...
          <div class="workout-card-metrics">
            <span class="text-muted">
              <i class="fas fa-clock"></i> \${_(e.total_duration_seconds)}
            </span>
            <span class="text-muted">
      ...
      <div class="workout-card-details" id="workout-details-\${e.id}" hidden>
        <div class="grid grid-cols-auto" style="gap: var(--space-3);">
          \${F("Training Time",_(e.total_duration_seconds))}
          \${F("Exercises",e.exercise_count||0)}
          \${F("Total Sets",e.total_sets||0)}
          \${F("Total Volume",o)}
          \${F("Effort Level",e.perceived_exertion?\`\${e.perceived_exertion}/10 \${rt(e.perceived_exertion)}\`:"Not rated")}
        </div>
  ...
  \`}function F(e,t){return i\`
    <div class="mini-stat">
      <div class="stat-label">\${e}</div>
      <div class="mini-stat-value">\${t}</div>
    </div>
  \`}function bt(e){return!e||e.length===0?i\`
      <div class="empty-state">
        <div class="empty-state-icon">🏋️</div>
  ...
  \`}function wt(e){e.addEventListener("click",t=>{const r=t.target.closest("[data-legacy-call]");if(r){const l=r.getAttribute("data-legacy-call"),c=window[l];typeof c=="function"&&c();return}const n=t.target.closest("[data-tab]");if(n){const l=n.getAttribute("data-tab");typeof window.switchTab=="function"&&window.switchTab(l);return}const a=t.target.closest('[data-action="toggle-details"]');if(a){const l=a.getAttribute("data-workout-id"),c=document.getElementById(\`workout-details-\${l}\`),u=document.getElementById(\`workout-chevron-\${l}\`);c&&(c.hasAttribute("hidden")?(c.removeAttribute("hidden"),u==null||u.style.setProperty("transform","rotate(180deg)")):(c.setAttribute("hidden",""),u==null||u.style.removeProperty("transform")));return}const o=t.target.closest('[data-action="view-workout"]');if(o){t.stopPropagation();const l=parseInt(o.getAttribute("data-workout-id"),10);typeof window.viewWorkout=="function"&&window.viewWorkout(l);return}const s=t.target.closest('[data-action="delete-workout"]');if(s){t.stopPropagation();const l=parseInt(s.getAttribute("data-workout-id"),10);typeof window.deleteDashboardWorkout=="function"&&window.deleteDashboardWorkout(l);return}})}async function kt(){const e=document.getElementById("dashboard");if(e){e.innerHTML=String(ft());try{const[t,,r]=await Promise.all([p.get("/analytics/progress?days=30"),p.get("/programs"),p.get("/workouts?limit=5")]),n=t.overview||{},a=r.workouts||[];e.innerHTML=String(i\`
    ...
    \`),wt(e)}catch(t){console.error("Error loading dashboard:",t),e.innerHTML=String(xt(t.message))}}}function St(e){const r=(e.measurement_system||"metric")==="imperial";let n="",a="";if(r&&e.height_cm){const s=Je(e.height_cm);n=s.feet,a=s.inches}const o=r&&e.weight_kg?Math.round(xe(e.weight_kg)*10)/10:e.weight_kg||"";return i\`
  ...
  \`}function \$t(e){const t=e.querySelector("#profile-system"),r=t==null?void 0:t.value,n=e.querySelector("#metric-inputs"),a=e.querySelector("#imperial-inputs");!n||!a||(r==="imperial"?(n.setAttribute("hidden",""),a.removeAttribute("hidden")):(a.setAttribute("hidden",""),n.removeAttribute("hidden")))}async function Tt(e){try{const r=(await p.get("/reports/preferences")).preferences||{},n={weekly:"weeklyReport",monthly:"monthlyReport",yearly:"yearlyReport"};for(const[a,o]of Object.entries(n)){const s=e.querySelector(\`#profile-report-\${a}\`);s&&(s.checked=!!r[o])}}catch(t){console.error("Failed to load report preferences:",t)}}async function Mt(e){var t,r,n;try{return await p.put("/reports/preferences",{weeklyReport:!!((t=e.querySelector("#profile-report-weekly"))!=null&&t.checked),monthlyReport:!!((r=e.querySelector("#profile-report-monthly"))!=null&&r.checked),yearlyReport:!!((n=e.querySelector("#profile-report-yearly"))!=null&&n.checked)}),!0}catch(a){return console.error("Failed to save report preferences:",a),!1}}function _t(e){g.info(\`Generating \${e} report preview…\`);const t=localStorage.getItem("token")||"",r=t?\`?token=\${encodeURIComponent(t)}\`:"";window.open(\`/api/reports/html/\${e}\${r}\`,"_blank")}async function zt(e,t){const r=e.querySelector("#profile-name").value.trim(),n=parseInt(e.querySelector("#profile-age").value,10)||null,a=e.querySelector("#profile-gender").value,o=e.querySelector("#profile-system").value;let s,l;if(o==="imperial"){const c=parseFloat(e.querySelector("#profile-height-feet").value)||0,u=parseFloat(e.querySelector("#profile-height-inches").value)||0,m=parseFloat(e.querySelector("#profile-weight-lbs").value)||0;s=c||u?Qe(c,u):null,l=m?Ke(m):null}else s=parseFloat(e.querySelector("#profile-height-cm").value)||null,l=parseFloat(e.querySelector("#profile-weight-kg").value)||null;try{const c=await t.put("/auth/user",{name:r,age:n,gender:a,height_cm:s,weight_kg:l,measurement_system:o});f.set("user",c.user),await Mt(e),g.success("Profile updated");const u=window.loadUser;typeof u=="function"&&u()}catch(c){throw g.error(\`Error saving profile: \${c.message}\`),c}}function Ct(){const e=f.get("user")||{};return z({title:"User Profile",size:"default",content:String(St(e)),actions:[{label:"Cancel",variant:"btn-outline"},{label:"Save Profile",primary:!0,variant:"btn-primary",onClick:async r=>{try{await zt(r.element,p),r.close("saved")}catch{}}}],onOpen:({element:r})=>{Tt(r),r.addEventListener("change",n=>{n.target.matches("#profile-system")&&\$t(r)}),r.addEventListener("click",n=>{const a=n.target.closest('[data-action="preview"]');a&&(n.preventDefault(),_t(a.getAttribute("data-period")))})}})}const Et=[{value:"Smith Machine",label:"Smith Machine",default:!0},{value:"Olympic Bar",label:"Olympic Bar",default:!0},{value:"Cable Trainer",label:"Cable Machine",default:!0},{value:"Leg Extension/Curl",label:"Leg Ext/Curl",default:!0},{value:"Pull-up Bar",label:"Pull-up Bar"},{value:"Landmine",label:"Landmine"},{value:"Dip Bars",label:"Dip Bars"},{value:"Rower",label:"Rower"},{value:"Treadmill",label:"Treadmill"},{value:"Stationary Bike",label:"Bike"}],Rt={1:"cardio-zone-low",2:"cardio-zone-low",3:"cardio-zone-mid",4:"cardio-zone-high",5:"cardio-zone-high"};function H(){return ke()}function Pt(e){const t=e.active?i\`<span class="badge badge-success">ACTIVE</span>\`:i\`<button class="btn btn-outline btn-sm" data-action="activate" data-program-id="\${e.id}">Activate</button>\`;return i\`
  ...
  \`}async function ke(){const e=document.getElementById("program");if(e){e.innerHTML=String(i\`
    <div class="stack stack-lg">
      <div class="card">
  ...
  \`);try{const r=(await p.get("/programs")).programs||[],n=r.find(a=>a.active);e.innerHTML=String(i\`
      <div class="stack stack-lg">
        ...
        <div class="card">
          ...
          \${r.length>0?i\`<div class="stack stack-sm">\${r.map(Pt)}</div>\`:i\`
                <div class="empty-state">
                  <div class="empty-state-icon">📋</div>
    ...
    \`),It(e)}catch(t){console.error("Error loading programs:",t),e.innerHTML=String(i\`
      <div class="card">
        <div class="empty-state">
          <div class="empty-state-icon">⚠️</div>
    ...
    \`)}}}function It(e){e.addEventListener("click",t=>{const r=t.target.closest("[data-action]");if(!r)return;const n=r.getAttribute("data-action"),a=parseInt(r.getAttribute("data-program-id"),10);switch(n){case"view":t.stopPropagation(),X(a);break;case"activate":t.stopPropagation(),ee(a);break;case"generate":\$e();break;case"create-manual":Te();break}})}function At(e){return i\`
  ...
  \`}function Lt(e){const t=e.cardio_sessions||[];return i\`
    <strong class="cardio-day-title">
      <i class="fas fa-fire"></i> Cardio Sessions
    </strong>
    <div class="stack stack-sm">
      \${t.map(r=>i\`
        <div class="cardio-session \${Rt[r.heart_rate_zone]||"cardio-zone-mid"}">
  ...
  \`}function qt(e){return i\`
    <div class="program-day-card">
      ...
      \${e.is_cardio_day?Lt(e):At(e)}
    </div>
  \`}async function X(e){try{const r=(await p.get(\`/programs/\${e}\`)).program,n=r.created_at?T(r.created_at,{year:"numeric",month:"short",day:"numeric"}):"Unknown";return z({title:"Program Details",size:"wide",content:String(i\`
      ...
      \`),actions:[{label:"Start Workout",primary:!0,variant:"btn-primary",onClick:o=>{o.close(),Ut(e)}},...r.active?[]:[{label:"Set as Active",variant:"btn-secondary",onClick:async o=>{await ee(e,{silent:!1}),o.close()}}],{label:"Delete",variant:"btn-danger",onClick:async o=>{if(await G("Delete this program? This cannot be undone.",{title:"Delete program?",confirmLabel:"Delete",confirmVariant:"btn-danger"}))try{await p.delete(\`/programs/\${e}\`),g.success("Program deleted"),o.close(),H()}catch(l){g.error(\`Error deleting program: \${l.message}\`)}}}],onOpen:({element:o})=>{var s;(s=o.querySelector('[data-action="rename"]'))==null||s.addEventListener("click",()=>{Se(e,r.name)})}})}catch(t){g.error(\`Error loading program: \${t.message}\`)}}function Se(e,t){z({title:"Rename Program",size:"default",content:String(i\`
      <div class="form-group">
        <label class="form-label" for="rename-input">Program name</label>
        <input type="text" id="rename-input" class="input" value="\${t}" />
      </div>
    \`),actions:[{label:"Cancel",variant:"btn-outline"},{label:"Save Name",primary:!0,onClick:async r=>{const n=r.element.querySelector("#rename-input").value.trim();if(!n){g.warning("Please enter a program name");return}try{await p.patch(\`/programs/\${e}\`,{name:n}),g.success("Program renamed"),r.close(),H(),X(e)}catch(a){g.error(\`Failed to rename: \${a.message}\`)}}}],onOpen:({element:r})=>{const n=r.querySelector("#rename-input");n==null||n.focus(),n==null||n.select()}})}async function ee(e,t={}){try{await p.post(\`/programs/\${e}/activate\`),t.silent||g.success("Program activated"),H()}catch(r){g.error(\`Error activating program: \${r.message}\`)}}async function Ht(e){if(await G("Are you sure you want to delete this program?",{title:"Delete program?",confirmLabel:"Delete",confirmVariant:"btn-danger"}))try{await p.delete(\`/programs/\${e}\`),g.success("Program deleted"),H()}catch(r){g.error(\`Error deleting program: \${r.message}\`)}}function \$e(){z({title:"Generate AI Program",size:"default",content:String(i\`
      <div class="stack stack-md">
        <div class="form-group">
  ...
  \`);const l=t.querySelector(".modal-footer");l&&(l.style.display="none");try{await p.post("/programs/generate",{days_per_week:r,goal:n,custom_instructions:a,available_equipment:o}),s.innerHTML=String(i\`
    ...
    \`),setTimeout(()=>{e.close(),H()},1500)}catch(c){s.innerHTML=String(i\`
      <div class="generate-progress">
    ...
    \`),actions:[...d.currentDayIndex>0?[{label:"← Previous Day",variant:"btn-outline",onClick:()=>{Q(),d.currentDayIndex--,V()}}]:[],{label:"Cancel",variant:"btn-ghost"},{label:r?"Finish & Save":"Next Day →",primary:!0,onClick:async()=>{if(Q(),e.exercises.length===0){g.warning("Please select at least one exercise for this day");return}r?await Gt():(d.currentDayIndex++,V())}}],onOpen:({element:n})=>Ot(n)})}function Q(){var a;const e=(a=d.modalApi)==null?void 0:a.element;if(!e)return;const t=d.days[d.currentDayIndex],r=e.querySelector("#builder-day-name"),n=e.querySelector("#builder-day-focus");r&&(t.name=r.value.trim()||\`Day \${t.day_number}\`),n&&(t.focus=n.value.trim())}function Ft(e){const t={};for(const r of e){const n=r.muscle_group||"Other";t[n]||(t[n]=[]),t[n].push(r)}return t}function Wt(e,t){const r=t.exercises.find(n=>n.exercise_id===e.id);return i\`
  ...
  \`}function Ot(e){e.addEventListener("change",t=>{const r=t.target.closest("[data-builder-toggle]");if(r){const a=parseInt(r.getAttribute("data-builder-toggle"),10);Nt(a);return}const n=t.target.closest("[data-builder-config]");if(n){const[a,o]=n.getAttribute("data-builder-config").split(":");Vt(parseInt(a,10),o,t.target.value)}})}function Nt(e){Q();const t=d.days[d.currentDayIndex],r=t.exercises.findIndex(n=>n.exercise_id===e);if(r>=0)t.exercises.splice(r,1);else{const n=d.availableExercises.find(a=>a.id===e);t.exercises.push({exercise_id:e,name:(n==null?void 0:n.name)||"",sets:3,reps:"8-12",rest_seconds:90})}V()}function Vt(e,t,r){const a=d.days[d.currentDayIndex].exercises.find(o=>o.exercise_id===e);a&&(t==="reps"?a.reps=r:a[t]=parseInt(r,10)||0)}async function Gt(){var e;try{await p.post("/programs/manual",{name:d.name,days_per_week:d.days_per_week,goal:d.goal,days:d.days}),g.success("Custom program created!"),(e=d.modalApi)==null||e.close(),d.modalApi=null,H()}catch(t){g.error(\`Error creating program: \${t.message}\`)}}async function Ut(e){const t=window.__legacyStartWorkoutFromProgram;if(typeof t=="function")return t(e);typeof window.switchTab=="function"&&window.switchTab("workout")}function Z(e){if(e===0||e==null)return i\`<span class="text-muted">—</span>\`;const r=e>0?"text-success":"text-danger";return i\`<span class="\${r}" style="font-weight: var(--font-semibold);">\${tt(e)}</span>\`}function se(e,t){const r=n=>T(n,{month:"short",day:"numeric"});return\`\${r(e)} – \${r(t)}\`}function le(e,t,r){if(!r)return"";const{current:n,previous:a,changes:o}=r;return i\`
    <div style="margin-bottom: var(--space-5);">
      ...
      <div class="comparison-date-row">
        <span class="text-primary" style="font-weight: var(--font-medium);">
          \${se(n.start_date,n.end_date)}
        </span>
        <span class="text-muted">vs</span>
        <span>\${se(a.start_date,a.end_date)}</span>
      </div>
      <div class="progress-comparison-grid">
        <div class="progress-comparison-card">
          ...
          <div class="progress-comparison-values">
            <span class="progress-comparison-current">\${k(n.total_volume)}</span>
            <span class="progress-comparison-previous">vs \${k(a.total_volume)}</span>
          </div>
          <div class="progress-comparison-change">\${Z(o.total_volume)}</div>
        </div>
        <div class="progress-comparison-card">
          <div class="progress-comparison-label">Workout Time</div>
          <div class="progress-comparison-values">
            <span class="progress-comparison-current">\${_(n.total_time)}</span>
            <span class="progress-comparison-previous">vs \${_(a.total_time)}</span>
          </div>
          <div class="progress-comparison-change">\${Z(o.total_time)}</div>
        </div>
        <div class="progress-comparison-card">
          ...
          <div class="progress-comparison-change">\${Z(o.workout_count)}</div>
        </div>
      </div>
    </div>
  ...
  \`}function jt(e){return!e||e.length===0?i\`
      <div class="empty-state">
        <div class="empty-state-icon">📊</div>
  ...
  \`}function Qt(e){return!e||e.length===0?i\`
      <div class="empty-state">
          ...
          <div class="pr-row">
            <div>
              ...
              <span class="text-muted" style="font-size: var(--text-xs);">
                \${String(t.record_type||"").toUpperCase()} · \${T(t.achieved_at)}
              </span>
            </div>
            <div style="text-align: right;">
  ...
  \`}async function er(){if(await G("This will recalculate all your Personal Records from your workout history. Continue?",{title:"Recalculate PRs?",confirmLabel:"Recalculate",confirmVariant:"btn-primary"}))try{const t=await p.post("/achievements/prs/recalculate");g.success(t.message||"PRs recalculated"),Me()}catch(t){g.error(\`Failed to recalculate PRs: \${t.message}\`)}}function tr(e){e.addEventListener("click",t=>{if(t.target.closest('[data-action="recalc-prs"]')){er();return}t.target.closest('[data-action="open-exporter"]')&&(typeof window.openUnifiedExporter=="function"?window.openUnifiedExporter():g.info("Export center is not yet available"))})}async function Me(){const e=document.getElementById("analytics");if(e){e.innerHTML=String(Yt());try{const[t,r,n,a,o]=await Promise.all([p.get("/analytics/progress?days=90"),p.get("/analytics/volume?days=90&group_by=week"),p.get("/analytics/bodymap?days=7"),p.get("/achievements/prs?limit=10"),p.get("/analytics/progress-comparison")]),s=a.prs||[],l=t.overview||{},c=r.volume_by_muscle||[],u=n.body_map||[],m=t.top_exercises||[];e.innerHTML=String(i\`
      <div class="stack stack-lg">
        <div class="card">
          <div class="card-header">
            <h2 class="card-title"><i class="fas fa-chart-line"></i> Progress Comparison</h2>
          </div>
          \${le("This Week vs Last Week","fa-calendar-week",o.weekly)}
          \${le("This Month vs Last Month","fa-calendar-alt",o.monthly)}
        </div>
    ...
    \`),tr(e);const y=window.loadWorkoutHistory;if(typeof y=="function")try{await y(e)}catch(x){console.warn("Legacy loadWorkoutHistory failed:",x)}}catch(t){console.error("Error loading analytics:",t),e.innerHTML=String(Xt(t.message))}}}function rr(e){return i\`
    <div class="macro-rings">
      <div class="macro-ring-wrapper">
        \${q(j({value:Math.round(e.protein_grams||0),max:Math.round(e.protein_goal||150),size:120,unit:"g",label:"Protein",color:"var(--color-secondary)"}))}
      ...
      <div class="macro-ring-wrapper">
        \${q(j({value:Math.round(e.water_ml||0),max:Math.round(e.water_goal||2500),size:120,unit:"ml",label:"Water",color:"var(--color-primary)"}))}
        <div class="macro-ring-meta">
      ...
      <div class="macro-ring-wrapper">
        \${q(j({value:Math.round((e.creatine_grams||0)*10)/10,max:e.creatine_goal||5,size:120,unit:"g",label:"Creatine",color:"#8b5cf6"}))}
        <div class="macro-ring-meta">
  ...
  \`:""}function sr(e,t){if(!e||e.length===0)return i\`
      <div class="empty-state">
    ...
    <div class="nutrition-bar-chart">
      \${r.map(n=>{const a=Math.min(n.protein/n.protein_goal*100,100),o=Math.min(n.water/n.water_goal*100,100),s=n.date===new Date().toISOString().split("T")[0];return i\`
          <div class="nutrition-bar-day \${s?"is-today":""}">
            <div class="nutrition-bar-label">\${T(n.date,{month:"short",day:"numeric"})}</div>
  ...
  \`}function L(e,...t){const r=window[e];if(typeof r=="function")try{return r(...t)}catch(n){g.error(\`Error: \${n.message}\`)}else g.warning("This feature is not yet available.")}async function lr(){const e=parseFloat(document.getElementById("nq-protein").value)||0,t=parseFloat(document.getElementById("nq-water").value)||0,r=parseFloat(document.getElementById("nq-creatine").value)||0;if(!e&&!t&&!r){g.warning("Enter an amount in at least one field.");return}try{const n=[];e>0&&n.push(p.post("/nutrition/entries",{entry_type:"protein",amount:e,unit:"g"})),t>0&&n.push(p.post("/nutrition/entries",{entry_type:"water",amount:t,unit:"ml"})),r>0&&n.push(p.post("/nutrition/entries",{entry_type:"creatine",amount:r,unit:"g"})),await Promise.all(n),document.getElementById("nq-protein").value="",document.getElementById("nq-water").value="",document.getElementById("nq-creatine").value="",g.success("Nutrition logged!"),_e()}catch(n){g.error(\`Error logging nutrition: \${n.message}\`)}}function dr(e){e.addEventListener("click",t=>{const r=t.target.closest("[data-action]");if(!r)return;switch(r.getAttribute("data-action")){case"log-meal":L("showLogMealModal",r.getAttribute("data-meal-type"));break;case"scan-barcode":L("showBarcodeScanner");break;case"quick-macros":L("showQuickMacroEntry");break;case"saved-meals":L("showSavedMeals");break;case"log-all-quick":lr();break;case"view-entries":L("loadNutritionEntries");break;case"create-saved":L("showCreateSavedMeal");break}})}function cr(){return i\`
    <div class="stack stack-lg">
      <div class="card"><div class="skeleton skeleton-card"></div></div>
      <div class="card"><div class="skeleton skeleton-card"></div></div>
    </div>
  \`}function pr(e){return i\`
    <div class="card">
      <div class="empty-state">
        <div class="empty-state-icon">⚠️</div>
  ...
  \`}async function _e(){const e=document.getElementById("nutrition");if(e){e.innerHTML=String(cr());try{const[t,r,n]=await Promise.all([p.get("/nutrition/daily"),p.get("/nutrition/analytics?days=30"),p.get("/nutrition/streaks")]),a=r.summary,o=r.daily_data||[];e.innerHTML=String(i\`
      <div class="stack stack-lg">
        <div class="card">
          <div class="card-header">
    ...
    \`),dr(e)}catch(t){console.error("Error loading nutrition:",t),e.innerHTML=String(pr(t.message))}}}const gr=["How should I progress my bench press?","Am I training with enough volume?","What muscle groups am I neglecting?","Should I take a deload week?","How do I break through a plateau?","Is my training frequency optimal?"];function ur(e){const t=document.createElement("div");return t.textContent=e||"",t.innerHTML}function ze(e){return!e||e.length===0?i\`
    ...
    \${e.map(t=>i\`
      <div class="chat-message chat-message-\${t.role}">
        ...
        <div class="chat-message-body">\${q(mr(t.content))}</div>
      </div>
    \`)}
  \`}function mr(e){if(!e)return"";let t=ur(e);return t=t.replace(/\\*\\*(.+?)\\*\\*/g,"<strong>\$1</strong>"),t=t.replace(/^\\s*-\\s+(.+)\$/gm,"<li>\$1</li>"),t=t.replace(/(<li>.*<\\/li>\\n?)+/g,r=>\`<ul>\${r}</ul>\`),t=t.replace(/\\n(?!<\\/?(ul|li)>)/g,"<br />"),t}async function de(e){var a,o;const t=f.get("aiCoach.conversationHistory")||[],r=[...t,{role:"user",content:e}];f.set("aiCoach.conversationHistory",r),Y();const n=document.getElementById("ai-chat-messages");n&&(n.insertAdjacentHTML("beforeend",String(i\`
    ...
    \`)),n.scrollTop=n.scrollHeight);try{const s=await p.post("/ai/coach/chat",{message:e,conversationHistory:t.slice(-6)});(a=document.getElementById("chat-typing"))==null||a.remove();const l={role:"assistant",content:s.response||"Sorry, I could not generate a response."};f.set("aiCoach.conversationHistory",[...r,l]),Y()}catch(s){(o=document.getElementById("chat-typing"))==null||o.remove(),g.error(\`AI Coach error: \${s.message}\`)}}function Y(){const e=document.getElementById("ai-chat-messages");if(!e)return;const t=f.get("aiCoach.conversationHistory")||[];e.innerHTML=String(ze(t)),e.scrollTop=e.scrollHeight}function yr(e){const t=e.querySelector("#ai-chat-form");t&&t.addEventListener("submit",r=>{r.preventDefault();const n=t.querySelector("#ai-chat-input"),a=n.value.trim();a&&(n.value="",de(a))}),e.addEventListener("click",r=>{const n=r.target.closest("[data-action]");if(!n)return;switch(n.getAttribute("data-action")){case"quick-question":de(n.getAttribute("data-question"));break;case"clear-chat":f.set("aiCoach.conversationHistory",[]),Y();break;case"open-analysis":typeof window.generateAICoaching=="function"?window.generateAICoaching():g.info("Full analysis is not yet available.");break;case"open-advanced":typeof window.loadAdvancedAnalytics=="function"?window.loadAdvancedAnalytics():g.info("Advanced analytics is not yet available.");break}})}function hr(){return i\`
  ...
  \`}async function fr(){var t,r;const e=document.getElementById("insights");if(e){e.innerHTML=String(hr());try{const a=(await p.get("/ai/coach/analysis?days=90")).data;if(!a||(((t=a.summary)==null?void 0:t.total_workouts)||0)<1){e.innerHTML=String(vr()),(r=e.querySelector('[data-action="go-workout"]'))==null||r.addEventListener("click",()=>{typeof window.switchTab=="function"&&window.switchTab("workout")});return}f.set("aiCoach.lastInsight",a);const o=f.get("aiCoach.conversationHistory")||[];e.innerHTML=String(i\`
      <div class="stack stack-lg">
        <div class="card ai-coach-hero">
          <div class="ai-coach-hero-content">
            <h2><i class="fas fa-robot"></i> AI Fitness Coach</h2>
        ...
        <div class="card">
          ...
          <div class="chat-messages" id="ai-chat-messages">\${ze(o)}</div>
    ...
    \`),yr(e)}catch(n){console.error("Error loading AI coach:",n),e.innerHTML=String(br(n.message))}}}window.__fitnessApp={store:f,api:p,toast:g,openModal:z,confirmDialog:G};b("learn","loadLearn",Ue);b("achievements","loadAchievements",mt);b("dashboard","loadDashboard",kt);b("profile","showProfile",Ct);b("program","loadPrograms",ke);b("programs:view","viewProgram",X);b("programs:activate","activateProgram",ee);b("programs:delete","deleteProgram",Ht);b("programs:generate","showGenerateProgram",\$e);b("programs:manual","showCreateManualProgram",Te);b("programs:rename","showRenameProgramModal",Se);b("analytics","loadAnalytics",Me);b("nutrition","loadNutrition",_e);b("insights","loadInsights",fr);Oe();
//# sourceMappingURL=index-BtMavAP8.js.map
