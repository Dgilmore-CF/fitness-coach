...
(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const s of i.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&n(s)}).observe(document,{childList:!0,subtree:!0});function r(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(o){if(o.ep)return;o.ep=!0;const i=r(o);fetch(o.href,i)}})();const V=Symbol("raw"),oe=Symbol("trusted");class P{constructor(t){this[oe]=!0,this.value=String(t)}toString(){return this.value}}function N(e){return e==null||e===!1?new P(""):new P(e)}function ie(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ae(e){return String(e).replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;")}function j(e){return e==null||e===!1?"":e===!0?"true":e instanceof P?e.value:e&&typeof e=="object"&&V in e?e[V]:Array.isArray(e)?e.map(j).join(""):ie(e)}function l(e,...t){let r=e[0];for(let n=0;n<t.length;n++)r+=j(t[n])+e[n+1];return new P(r)}function J(e){const t=e instanceof P?e.value:String(e).trim(),r=document.createElement("template");return r.innerHTML=t,r.content.firstElementChild}const Z="fitness-coach:state",Y={user:null,currentWorkout:null,currentProgram:null,currentTab:"dashboard",ui:{theme:"system",activeModal:null,lastVisitedTab:null},workout:{activeExerciseIndex:0,restTimerEndTime:null,workoutStartTime:null,exerciseHistory:{},modifications:{added:[],deleted:[]},pendingNotes:""},mealTracking:{searchResults:[],selectedFoods:[],currentMealType:null,scannerActive:!1},pastWorkout:{date:null,programId:null,programDayId:null,exercises:[]},analytics:{lastFetch:null,data:null},aiCoach:{conversationHistory:[],lastInsight:null}},Q=["ui"];function D(e,t){return t?t.split(".").reduce((r,n)=>r==null?r:r[n],e):e}function X(e,t,r){if(!t)return r;const n=t.split("."),o=n.pop(),i=n.reduce((s,a)=>((s[a]==null||typeof s[a]!="object")&&(s[a]={}),s[a]),e);return i[o]=r,e}function K(e){return e==null||typeof e!="object"?e:JSON.parse(JSON.stringify(e))}function se(){try{const e=localStorage.getItem(Z);return e?JSON.parse(e):{}}catch{return{}}}function le(e){try{const t={};for(const r of Q){const n=D(e,r);n!==void 0&&X(t,r,n)}localStorage.setItem(Z,JSON.stringify(t))}catch{}}class de{constructor(t){this.data=K(t),this.subscribers=new Map;const r=se();for(const[n,o]of Object.entries(r))this.data[n]={...this.data[n],...o}}get(t){return D(this.data,t)}set(t,r){const n=this.get(t);if(n===r)return;X(this.data,t,r),Q.some(i=>t===i||t.startsWith(\`\${i}.\`))&&le(this.data),this.notify(t,r,n);const o=t.split(".");for(let i=o.length-1;i>0;i--){const s=o.slice(0,i).join(".");this.notify(s,this.get(s),null)}}merge(t,r){const n=this.get(t)||{};this.set(t,{...n,...r})}reset(t){const r=D(Y,t);this.set(t,K(r))}subscribe(t,r){this.subscribers.has(t)||this.subscribers.set(t,new Set);const n=this.subscribers.get(t);return n.add(r),()=>n.delete(r)}notify(t,r,n){const o=this.subscribers.get(t);if(o)for(const i of o)try{i(r,n)}catch(s){console.error(\`Subscriber error for "\${t}":\`,s)}}}const L=new de(Y);typeof window<"u"&&(window.__store=L);const ee="/api",ce=3e4,pe=6e4,A=new Map;class q extends Error{constructor(t,{status:r=0,code:n=null,details:o=null}={}){super(t),this.name="ApiError",this.status=r,this.code=n,this.details=o}}async function z(e,t={}){var M;const{method:r="GET",body:n,headers:o={},cache:i=!1,timeout:s=ce,signal:a}=t,d=\`\${ee}\${e}\`,c=\`\${r} \${d}\`;if(r==="GET"&&i){const b=A.get(c);if(b&&Date.now()-b.at<pe)return b.data}const h=new AbortController,g=setTimeout(()=>h.abort(),s);a&&a.addEventListener("abort",()=>h.abort(),{once:!0});const x={method:r,headers:{"Content-Type":"application/json",...o},signal:h.signal};n!=null&&(n instanceof FormData?(delete x.headers["Content-Type"],x.body=n):typeof n=="string"?x.body=n:x.body=JSON.stringify(n));let u;try{u=await fetch(d,x)}catch(b){throw clearTimeout(g),b.name==="AbortError"?new q("Request timed out",{code:"TIMEOUT"}):new q("Network error",{code:"NETWORK",details:b.message})}clearTimeout(g);const v=(M=u.headers.get("content-type"))==null?void 0:M.includes("application/json"),y=v?await u.json().catch(()=>({})):await u.text();if(!u.ok){const b=v&&(y==null?void 0:y.error)||\`Request failed (\${u.status})\`;throw new q(b,{status:u.status,code:y==null?void 0:y.code,details:y==null?void 0:y.details})}return r==="GET"&&i&&A.set(c,{data:y,at:Date.now()}),y}function ge(e=""){const t=\`GET \${ee}\${e}\`;for(const r of A.keys())r.startsWith(t)&&A.delete(r)}const k={get:(e,t)=>z(e,{...t,method:"GET"}),post:(e,t,r)=>z(e,{...r,method:"POST",body:t}),put:(e,t,r)=>z(e,{...r,method:"PUT",body:t}),patch:(e,t,r)=>z(e,{...r,method:"PATCH",body:t}),delete:(e,t)=>z(e,{...t,method:"DELETE"}),request:z,invalidateCache:ge},G={success:"fa-check-circle",error:"fa-exclamation-circle",warning:"fa-exclamation-triangle",info:"fa-info-circle"},ye=3e3;let m=null;function he(){return m&&document.body.contains(m)||(m=document.getElementById("toast-container"),m||(m=document.createElement("div"),m.id="toast-container",m.setAttribute("aria-live","polite"),m.setAttribute("aria-atomic","true"),document.body.appendChild(m))),m}function E(e,t={}){var h;const{type:r="info",duration:n=ye,icon:o,action:i}=t,s=o?\`fa-\${o}\`:G[r]||G.info,a=J(l\`
    <div class="toast toast-\${ae(r)}" role="alert">
  ...
  \`);he().appendChild(a),i!=null&&i.onClick&&((h=a.querySelector(".toast-action"))==null||h.addEventListener("click",()=>{i.onClick(),c()}));let d=!1;const c=()=>{d||(d=!0,a.style.animation="slide-out-right var(--transition-base) forwards",a.addEventListener("animationend",()=>a.remove(),{once:!0}))};return n>0&&setTimeout(c,n),c}const me={show:(e,t)=>E(e,t),success:(e,t)=>E(e,{...t,type:"success"}),error:(e,t)=>E(e,{...t,type:"error",duration:(t==null?void 0:t.duration)??5e3}),warning:(e,t)=>E(e,{...t,type:"warning"}),info:(e,t)=>E(e,{...t,type:"info"})},R=[];function ue(){let e=document.getElementById("modal-root");return e||(e=document.createElement("div"),e.id="modal-root",document.body.appendChild(e)),e}function be(e){const t=e.querySelectorAll('a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])');if(t.length===0)return null;const r=t[0],n=t[t.length-1],o=i=>{i.key==="Tab"&&(i.shiftKey&&document.activeElement===r?(i.preventDefault(),n.focus()):!i.shiftKey&&document.activeElement===n&&(i.preventDefault(),r.focus()))};return e.addEventListener("keydown",o),r.focus(),()=>e.removeEventListener("keydown",o)}function te(e){var O;const{title:t,content:r,actions:n=[],size:o="default",dismissable:i=!0,onOpen:s,onClose:a}=e,d=o==="wide"?"modal-wide":o==="fullscreen"?"modal-fullscreen":"",c=n.length?l\`
  ...
  \`),x=g.querySelector(".modal"),u=g.querySelector(".modal-body");r instanceof Node?u.appendChild(r):r!=null&&(u.innerHTML=String(r));const v=document.activeElement;let y=!1,M;const b=new Promise(p=>M=p),S=p=>{if(y)return;y=!0;const w=R.indexOf(f);w>=0&&R.splice(w,1),\$==null||\$(),g.style.animation="fade-out var(--transition-fast) forwards",x.style.animation="slide-up var(--transition-fast) reverse forwards",g.addEventListener("animationend",()=>{var T;g.remove(),(T=v==null?void 0:v.focus)==null||T.call(v)},{once:!0}),R.length===0&&(document.body.style.overflow=""),a==null||a(p),M(p)},f={element:x,backdrop:g,close:S,promise:b};g.querySelectorAll("[data-modal-action]").forEach(p=>{const w=parseInt(p.getAttribute("data-modal-action"),10),T=n[w];p.addEventListener("click",async()=>{T.onClick?await T.onClick(f):S(T.value??w)})}),(O=g.querySelector("[data-modal-close]"))==null||O.addEventListener("click",()=>S()),i&&g.addEventListener("click",p=>{p.target===g&&S()});const W=p=>{p.key==="Escape"&&i&&R[R.length-1]===f&&S()};document.addEventListener("keydown",W);const ne=S;f.close=p=>{document.removeEventListener("keydown",W),ne(p)},ue().appendChild(g),document.body.style.overflow="hidden",R.push(f);const \$=be(x);return s==null||s(f),f}function xe(e,t={}){const{title:r="Are you sure?",confirmLabel:n="Confirm",cancelLabel:o="Cancel",confirmVariant:i="btn-primary"}=t;return new Promise(s=>{te({title:r,content:l\`<p>\${e}</p>\`,actions:[{label:o,variant:"btn-outline",onClick:a=>a.close(!1)},{label:n,variant:i,primary:!0,onClick:a=>a.close(!0)}],onClose:a=>s(a===!0)})})}const _=new Map;function F(e,t,r){_.set(e,{legacyGlobal:t,handler:r})}function U(){for(const[t,{legacyGlobal:r,handler:n}]of _){const o=window[r];window[r]=function(...s){try{return n(...s)}catch(a){if(console.error(\`[bridge] "\${r}" handler failed, falling back to legacy:\`,a),typeof o=="function")return o.apply(this,s);throw a}},window[r].__legacy=o,window[r].__modular=!0}const e=window.switchTab;typeof e=="function"&&!e.__bridged&&(window.switchTab=function(r,...n){return L.set("currentTab",r),e.call(this,r,...n)},window.switchTab.__bridged=!0,window.switchTab.__legacy=e),console.info(\`[bridge] Installed \${_.size} modular screen handler(s):\`,Array.from(_.keys()).join(", "))}function ve(){document.readyState==="loading"?document.addEventListener("DOMContentLoaded",U,{once:!0}):U()}const fe=\`    <div class="card">
...
\`,we={hypertrophy:"#hypertrophy-section",strength:"#strength-section",endurance:"#endurance-section",cardio:"#cardio-section",comparison:"#comparison-section",variables:"#variables-section"};function ke(e){e.innerHTML=fe,e.addEventListener("click",t=>{var i;const r=t.target.closest("[data-learn-scroll]");if(!r)return;t.preventDefault();const n=r.getAttribute("data-learn-scroll"),o=we[n];o&&((i=e.querySelector(o))==null||i.scrollIntoView({behavior:"smooth",block:"start"}))})}function Se(){const e=document.getElementById("learn");e&&ke(e)}const Te=2.20462;function ze(e){return e==null?0:Math.round(e*Te*10)/10}function Re(){const e=L.get("user");return e&&e.measurement_system||"metric"}function re(){return Re()==="imperial"}function Me(){return re()?"lbs":"kg"}function Ee(e){return e==null?0:re()?ze(e):e}function B(e,t={}){const{unit:r=!0,precision:n=1}=t;if(e==null)return"N/A";const o=Ee(e),i=Me();let s;return Math.abs(o)>=1e3?s=Math.round(o).toLocaleString():o%1===0?s=String(o):s=o.toFixed(n),r?\`\${s} \${i}\`:s}function H(e){if(e==null||e<0)return"00:00";const t=Math.abs(Math.floor(e)),r=Math.floor(t/3600),n=Math.floor(t%3600/60),o=t%60,i=s=>String(s).padStart(2,"0");return r>0?\`\${i(r)}:\${i(n)}:\${i(o)}\`:\`\${i(n)}:\${i(o)}\`}function I(e,t={month:"short",day:"numeric",year:"numeric"}){if(!e)return"";const[r,n,o]=String(e).split("T")[0].split("-").map(Number);return!r||!n||!o?e:new Date(r,n-1,o).toLocaleDateString("en-US",t)}function Ce(e){return e==null?"":e<=2?"😴":e<=4?"🙂":e<=6?"💪":e<=8?"🔥":"🥵"}const Pe={consistency:"🔥",strength:"💪",volume:"📊",milestone:"⭐"},Ie={consistency:"Consistency",strength:"Strength",volume:"Volume",milestone:"Milestones"},_e={bronze:"tier-bronze",silver:"tier-silver",gold:"tier-gold",platinum:"tier-platinum"};function Ae(e){const t={};for(const r of e){const n=r.category||"other";t[n]||(t[n]=[]),t[n].push(r)}return t}function Be(e,t){return!t||t===0?{text:"First PR!",isFirst:!0}:{text:\`+\${((e-t)/t*100).toFixed(1)}%\`,isFirst:!1}}function He({currentWeeks:e,longestWeeks:t,totalWorkouts:r,totalPRs:n,earnedCount:o}){return l\`
  ...
  \`}function Le(e){return!e||e.length===0?l\`
    ...
    <div class="table-container">
      <table class="data-table">
        ...
        <tbody>
          \${e.map(t=>{const{text:r,isFirst:n}=Be(t.record_value,t.previous_value);return l\`
              <tr>
  ...
  \`}function \$e(e){const t=Object.keys(e);return t.length===0?l\`
      <div class="empty-state">
    ...
    <div class="stack stack-lg">
      \${t.map(r=>{const n=e[r];return l\`
          <div>
            ...
            <div class="grid grid-cols-auto">
              \${n.map(o=>l\`
                <div class="achievement-card \${_e[o.tier]||""}">
  ...
  \`}function qe(e,t,r){return!e.current_streak||e.current_streak<=0?"":l\`
  ...
  \`}function Fe(){return l\`
    <div class="card">
      <div class="grid grid-cols-auto">
        \${[1,2,3,4].map(()=>l\`<div class="skeleton skeleton-card"></div>\`)}
      </div>
    </div>
  \`}async function We(){const e=document.getElementById("achievements");if(e){e.innerHTML=String(Fe());try{const[t,r,n]=await Promise.all([k.get("/achievements"),k.get("/achievements/prs?limit=10"),k.get("/achievements/streak")]),o=t.earned||[],i=t.stats||{totalWorkouts:0,totalPRs:0},s=r.prs||[],a=n.streak||{},d=Math.floor((a.current_streak||0)/7),c=Math.floor((a.longest_streak||0)/7),h=Ae(o);e.innerHTML=String(l\`
      <div class="card">
        ...
        \${He({currentWeeks:d,longestWeeks:c,totalWorkouts:i.totalWorkouts||0,totalPRs:i.totalPRs||0,earnedCount:o.length})}
    ...
    \`)}catch(t){console.error("Error loading achievements:",t),e.innerHTML=String(De(t.message))}}}function Oe(e){return l\`
    <div class="grid grid-cols-auto">
      <div class="stat-card">
      ...
      <div class="stat-card">
        ...
        <div class="stat-value">\${H(e.total_time_seconds||0)}</div>
      </div>
      <div class="stat-card">
        <div class="stat-label">Avg Workout</div>
        <div class="stat-value">\${H(e.average_workout_time||0)}</div>
      </div>
    </div>
  ...
  \`}function Ne(e){const t=!!e.completed,r=t?"✓ Complete":"In Progress",n=t?"badge-success":"badge-warning",o=I(e.start_time,{weekday:"short",month:"short",day:"numeric",year:"numeric"}),i=e.total_weight_kg?B(e.total_weight_kg):"N/A";return l\`
    <div class="workout-card" id="workout-card-\${e.id}">
        ...
        <div class="workout-card-header-main">
          ...
          <div class="workout-card-metrics">
            <span class="text-muted">
              <i class="fas fa-clock"></i> \${H(e.total_duration_seconds)}
            </span>
            <span class="text-muted">
      ...
      <div class="workout-card-details" id="workout-details-\${e.id}" hidden>
        <div class="grid grid-cols-auto" style="gap: var(--space-3);">
          \${C("Training Time",H(e.total_duration_seconds))}
          \${C("Exercises",e.exercise_count||0)}
          \${C("Total Sets",e.total_sets||0)}
          \${C("Total Volume",i)}
          \${C("Effort Level",e.perceived_exertion?\`\${e.perceived_exertion}/10 \${Ce(e.perceived_exertion)}\`:"Not rated")}
        </div>
  ...
  \`}function C(e,t){return l\`
    <div class="mini-stat">
      <div class="stat-label">\${e}</div>
      <div class="mini-stat-value">\${t}</div>
    </div>
  \`}function Ke(e){return!e||e.length===0?l\`
      <div class="empty-state">
        <div class="empty-state-icon">🏋️</div>
  ...
  \`}function je(e){e.addEventListener("click",t=>{const r=t.target.closest("[data-legacy-call]");if(r){const a=r.getAttribute("data-legacy-call"),d=window[a];typeof d=="function"&&d();return}const n=t.target.closest("[data-tab]");if(n){const a=n.getAttribute("data-tab");typeof window.switchTab=="function"&&window.switchTab(a);return}const o=t.target.closest('[data-action="toggle-details"]');if(o){const a=o.getAttribute("data-workout-id"),d=document.getElementById(\`workout-details-\${a}\`),c=document.getElementById(\`workout-chevron-\${a}\`);d&&(d.hasAttribute("hidden")?(d.removeAttribute("hidden"),c==null||c.style.setProperty("transform","rotate(180deg)")):(d.setAttribute("hidden",""),c==null||c.style.removeProperty("transform")));return}const i=t.target.closest('[data-action="view-workout"]');if(i){t.stopPropagation();const a=parseInt(i.getAttribute("data-workout-id"),10);typeof window.viewWorkout=="function"&&window.viewWorkout(a);return}const s=t.target.closest('[data-action="delete-workout"]');if(s){t.stopPropagation();const a=parseInt(s.getAttribute("data-workout-id"),10);typeof window.deleteDashboardWorkout=="function"&&window.deleteDashboardWorkout(a);return}})}async function Je(){const e=document.getElementById("dashboard");if(e){e.innerHTML=String(Ge());try{const[t,,r]=await Promise.all([k.get("/analytics/progress?days=30"),k.get("/programs"),k.get("/workouts?limit=5")]),n=t.overview||{},o=r.workouts||[];e.innerHTML=String(l\`
      <div class="stack stack-lg">
        <div class="card">
          <div class="card-header">
    ...
    \`),je(e)}catch(t){console.error("Error loading dashboard:",t),e.innerHTML=String(Ue(t.message))}}}window.__fitnessApp={store:L,api:k,toast:me,openModal:te,confirmDialog:xe};F("learn","loadLearn",Se);F("achievements","loadAchievements",We);F("dashboard","loadDashboard",Je);ve();
//# sourceMappingURL=index-DQR1W7r8.js.map
