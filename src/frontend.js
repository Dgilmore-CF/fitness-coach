...
(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&n(s)}).observe(document,{childList:!0,subtree:!0});function r(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(a){if(a.ep)return;a.ep=!0;const o=r(a);fetch(a.href,o)}})();const re=Symbol("raw"),ze=Symbol("trusted");class W{constructor(t){this[ze]=!0,this.value=String(t)}toString(){return this.value}}function F(e){return e==null||e===!1?new W(""):new W(e)}function Me(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function le(e){return String(e).replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;")}function de(e){return e==null||e===!1?"":e===!0?"true":e instanceof W?e.value:e&&typeof e=="object"&&re in e?e[re]:Array.isArray(e)?e.map(de).join(""):Me(e)}function i(e,...t){let r=e[0];for(let n=0;n<t.length;n++)r+=de(t[n])+e[n+1];return new W(r)}function ce(e){const t=e instanceof W?e.value:String(e).trim(),r=document.createElement("template");return r.innerHTML=t,r.content.firstElementChild}const pe="fitness-coach:state",ge={user:null,currentWorkout:null,currentProgram:null,currentTab:"dashboard",ui:{theme:"system",activeModal:null,lastVisitedTab:null},workout:{activeExerciseIndex:0,restTimerEndTime:null,workoutStartTime:null,exerciseHistory:{},modifications:{added:[],deleted:[]},pendingNotes:""},mealTracking:{searchResults:[],selectedFoods:[],currentMealType:null,scannerActive:!1},pastWorkout:{date:null,programId:null,programDayId:null,exercises:[]},analytics:{lastFetch:null,data:null},aiCoach:{conversationHistory:[],lastInsight:null}},ue=["ui"];function J(e,t){return t?t.split(".").reduce((r,n)=>r==null?r:r[n],e):e}function me(e,t,r){if(!t)return r;const n=t.split("."),a=n.pop(),o=n.reduce((s,l)=>((s[l]==null||typeof s[l]!="object")&&(s[l]={}),s[l]),e);return o[a]=r,e}function ne(e){return e==null||typeof e!="object"?e:JSON.parse(JSON.stringify(e))}function Re(){try{const e=localStorage.getItem(pe);return e?JSON.parse(e):{}}catch{return{}}}function Ee(e){try{const t={};for(const r of ue){const n=J(e,r);n!==void 0&&me(t,r,n)}localStorage.setItem(pe,JSON.stringify(t))}catch{}}class Ce{constructor(t){this.data=ne(t),this.subscribers=new Map;const r=Re();for(const[n,a]of Object.entries(r))this.data[n]={...this.data[n],...a}}get(t){return J(this.data,t)}set(t,r){const n=this.get(t);if(n===r)return;me(this.data,t,r),ue.some(o=>t===o||t.startsWith(\`\${o}.\`))&&Ee(this.data),this.notify(t,r,n);const a=t.split(".");for(let o=a.length-1;o>0;o--){const s=a.slice(0,o).join(".");this.notify(s,this.get(s),null)}}merge(t,r){const n=this.get(t)||{};this.set(t,{...n,...r})}reset(t){const r=J(ge,t);this.set(t,ne(r))}subscribe(t,r){this.subscribers.has(t)||this.subscribers.set(t,new Set);const n=this.subscribers.get(t);return n.add(r),()=>n.delete(r)}notify(t,r,n){const a=this.subscribers.get(t);if(a)for(const o of a)try{o(r,n)}catch(s){console.error(\`Subscriber error for "\${t}":\`,s)}}}const L=new Ce(ge);typeof window<"u"&&(window.__store=L);const ye="/api",Pe=3e4,Ie=6e4,N=new Map;class K extends Error{constructor(t,{status:r=0,code:n=null,details:a=null}={}){super(t),this.name="ApiError",this.status=r,this.code=n,this.details=a}}async function P(e,t={}){var q;const{method:r="GET",body:n,headers:a={},cache:o=!1,timeout:s=Pe,signal:l}=t,c=\`\${ye}\${e}\`,g=\`\${r} \${c}\`;if(r==="GET"&&o){const S=N.get(g);if(S&&Date.now()-S.at<Ie)return S.data}const m=new AbortController,y=setTimeout(()=>m.abort(),s);l&&l.addEventListener("abort",()=>m.abort(),{once:!0});const f={method:r,headers:{"Content-Type":"application/json",...a},signal:m.signal};n!=null&&(n instanceof FormData?(delete f.headers["Content-Type"],f.body=n):typeof n=="string"?f.body=n:f.body=JSON.stringify(n));let w;try{w=await fetch(c,f)}catch(S){throw clearTimeout(y),S.name==="AbortError"?new K("Request timed out",{code:"TIMEOUT"}):new K("Network error",{code:"NETWORK",details:S.message})}clearTimeout(y);const T=(q=w.headers.get("content-type"))==null?void 0:q.includes("application/json"),v=T?await w.json().catch(()=>({})):await w.text();if(!w.ok){const S=T&&(v==null?void 0:v.error)||\`Request failed (\${w.status})\`;throw new K(S,{status:w.status,code:v==null?void 0:v.code,details:v==null?void 0:v.details})}return r==="GET"&&o&&N.set(g,{data:v,at:Date.now()}),v}function Ae(e=""){const t=\`GET \${ye}\${e}\`;for(const r of N.keys())r.startsWith(t)&&N.delete(r)}const p={get:(e,t)=>P(e,{...t,method:"GET"}),post:(e,t,r)=>P(e,{...r,method:"POST",body:t}),put:(e,t,r)=>P(e,{...r,method:"PUT",body:t}),patch:(e,t,r)=>P(e,{...r,method:"PATCH",body:t}),delete:(e,t)=>P(e,{...t,method:"DELETE"}),request:P,invalidateCache:Ae},ae={success:"fa-check-circle",error:"fa-exclamation-circle",warning:"fa-exclamation-triangle",info:"fa-info-circle"},Le=3e3;let x=null;function Be(){return x&&document.body.contains(x)||(x=document.getElementById("toast-container"),x||(x=document.createElement("div"),x.id="toast-container",x.setAttribute("aria-live","polite"),x.setAttribute("aria-atomic","true"),document.body.appendChild(x))),x}function H(e,t={}){var m;const{type:r="info",duration:n=Le,icon:a,action:o}=t,s=a?\`fa-\${a}\`:ae[r]||ae.info,l=ce(i\`
    <div class="toast toast-\${le(r)}" role="alert">
  ...
  \`);Be().appendChild(l),o!=null&&o.onClick&&((m=l.querySelector(".toast-action"))==null||m.addEventListener("click",()=>{o.onClick(),g()}));let c=!1;const g=()=>{c||(c=!0,l.style.animation="slide-out-right var(--transition-base) forwards",l.addEventListener("animationend",()=>l.remove(),{once:!0}))};return n>0&&setTimeout(g,n),g}const u={show:(e,t)=>H(e,t),success:(e,t)=>H(e,{...t,type:"success"}),error:(e,t)=>H(e,{...t,type:"error",duration:(t==null?void 0:t.duration)??5e3}),warning:(e,t)=>H(e,{...t,type:"warning"}),info:(e,t)=>H(e,{...t,type:"info"})},I=[];function qe(){let e=document.getElementById("modal-root");return e||(e=document.createElement("div"),e.id="modal-root",document.body.appendChild(e)),e}function He(e){const t=e.querySelectorAll('a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])');if(t.length===0)return null;const r=t[0],n=t[t.length-1],a=o=>{o.key==="Tab"&&(o.shiftKey&&document.activeElement===r?(o.preventDefault(),n.focus()):!o.shiftKey&&document.activeElement===n&&(o.preventDefault(),r.focus()))};return e.addEventListener("keydown",a),r.focus(),()=>e.removeEventListener("keydown",a)}function z(e){var te;const{title:t,content:r,actions:n=[],size:a="default",dismissable:o=!0,onOpen:s,onClose:l}=e,c=a==="wide"?"modal-wide":a==="fullscreen"?"modal-fullscreen":"",g=n.length?i\`
  ...
  \`),f=y.querySelector(".modal"),w=y.querySelector(".modal-body");r instanceof Node?w.appendChild(r):r!=null&&(w.innerHTML=String(r));const T=document.activeElement;let v=!1,q;const S=new Promise(h=>q=h),E=h=>{if(v)return;v=!0;const R=I.indexOf(M);R>=0&&I.splice(R,1),U==null||U(),y.style.animation="fade-out var(--transition-fast) forwards",f.style.animation="slide-up var(--transition-fast) reverse forwards",y.addEventListener("animationend",()=>{var C;y.remove(),(C=T==null?void 0:T.focus)==null||C.call(T)},{once:!0}),I.length===0&&(document.body.style.overflow=""),l==null||l(h),q(h)},M={element:f,backdrop:y,close:E,promise:S};y.querySelectorAll("[data-modal-action]").forEach(h=>{const R=parseInt(h.getAttribute("data-modal-action"),10),C=n[R];h.addEventListener("click",async()=>{C.onClick?await C.onClick(M):E(C.value??R)})}),(te=y.querySelector("[data-modal-close]"))==null||te.addEventListener("click",()=>E()),o&&y.addEventListener("click",h=>{h.target===y&&E()});const ee=h=>{h.key==="Escape"&&o&&I[I.length-1]===M&&E()};document.addEventListener("keydown",ee);const _e=E;M.close=h=>{document.removeEventListener("keydown",ee),_e(h)},qe().appendChild(y),document.body.style.overflow="hidden",I.push(M);const U=He(f);return s==null||s(M),M}function G(e,t={}){const{title:r="Are you sure?",confirmLabel:n="Confirm",cancelLabel:a="Cancel",confirmVariant:o="btn-primary"}=t;return new Promise(s=>{z({title:r,content:i\`<p>\${e}</p>\`,actions:[{label:a,variant:"btn-outline",onClick:l=>l.close(!1)},{label:n,variant:o,primary:!0,onClick:l=>l.close(!0)}],onClose:l=>s(l===!0)})})}function j({value:e,max:t,size:r=100,label:n,unit:a,color:o}){const s=Math.max(0,Math.min(100,e/(t||1)*100)),l=(r-16)/2,c=2*Math.PI*l,g=c-s/100*c,m=o?\`stroke: \${le(o)};\`:"";return i\`
  ...
  \`}const O=new Map;function b(e,t,r){O.set(e,{legacyGlobal:t,handler:r})}function ie(){for(const[t,{legacyGlobal:r,handler:n}]of O){const a=window[r];window[r]=function(...s){try{return n(...s)}catch(l){if(console.error(\`[bridge] "\${r}" handler failed, falling back to legacy:\`,l),typeof a=="function")return a.apply(this,s);throw l}},window[r].__legacy=a,window[r].__modular=!0}const e=window.switchTab;typeof e=="function"&&!e.__bridged&&(window.switchTab=function(r,...n){return L.set("currentTab",r),e.call(this,r,...n)},window.switchTab.__bridged=!0,window.switchTab.__legacy=e),console.info(\`[bridge] Installed \${O.size} modular screen handler(s):\`,Array.from(O.keys()).join(", "))}function De(){document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ie,{once:!0}):ie()}const Fe=\`    <div class="card">
...
\`,We={hypertrophy:"#hypertrophy-section",strength:"#strength-section",endurance:"#endurance-section",cardio:"#cardio-section",comparison:"#comparison-section",variables:"#variables-section"};function Oe(e){e.innerHTML=Fe,e.addEventListener("click",t=>{var o;const r=t.target.closest("[data-learn-scroll]");if(!r)return;t.preventDefault();const n=r.getAttribute("data-learn-scroll"),a=We[n];a&&((o=e.querySelector(a))==null||o.scrollIntoView({behavior:"smooth",block:"start"}))})}function Ne(){const e=document.getElementById("learn");e&&Oe(e)}const he=2.20462,ve=1/2.54;function be(e){return e==null?0:Math.round(e*he*10)/10}function Ve(e){return e==null?0:Math.round(e/he*100)/100}function Ge(e){return e*ve}function Ue(e){return e/ve}function Ke(e){const t=Math.round(Ge(e)),r=Math.floor(t/12),n=t-r*12;return{feet:r,inches:n}}function je(e,t){return Ue((e||0)*12+(t||0))}function Ze(){const e=L.get("user");return e&&e.measurement_system||"metric"}function fe(){return Ze()==="imperial"}function Je(){return fe()?"lbs":"kg"}function Qe(e){return e==null?0:fe()?be(e):e}function k(e,t={}){const{unit:r=!0,precision:n=1}=t;if(e==null)return"N/A";const a=Qe(e),o=Je();let s;return Math.abs(a)>=1e3?s=Math.round(a).toLocaleString():a%1===0?s=String(a):s=a.toFixed(n),r?\`\${s} \${o}\`:s}function _(e){if(e==null||e<0)return"00:00";const t=Math.abs(Math.floor(e)),r=Math.floor(t/3600),n=Math.floor(t%3600/60),a=t%60,o=s=>String(s).padStart(2,"0");return r>0?\`\${o(r)}:\${o(n)}:\${o(a)}\`:\`\${o(n)}:\${o(a)}\`}function \$(e,t={month:"short",day:"numeric",year:"numeric"}){if(!e)return"";const[r,n,a]=String(e).split("T")[0].split("-").map(Number);return!r||!n||!a?e:new Date(r,n-1,a).toLocaleDateString("en-US",t)}function Ye(e){if(e==null||Number.isNaN(e))return"—";const t=Math.round(e*10)/10;return t===0?"0%":\`\${t>0?"↑":"↓"} \${Math.abs(t)}%\`}function Xe(e){return e==null?"":e<=2?"😴":e<=4?"🙂":e<=6?"💪":e<=8?"🔥":"🥵"}const et={consistency:"🔥",strength:"💪",volume:"📊",milestone:"⭐"},tt={consistency:"Consistency",strength:"Strength",volume:"Volume",milestone:"Milestones"},rt={bronze:"tier-bronze",silver:"tier-silver",gold:"tier-gold",platinum:"tier-platinum"};function nt(e){const t={};for(const r of e){const n=r.category||"other";t[n]||(t[n]=[]),t[n].push(r)}return t}function at(e,t){return!t||t===0?{text:"First PR!",isFirst:!0}:{text:\`+\${((e-t)/t*100).toFixed(1)}%\`,isFirst:!1}}function it({currentWeeks:e,longestWeeks:t,totalWorkouts:r,totalPRs:n,earnedCount:a}){return i\`
  ...
  \`}function ot(e){return!e||e.length===0?i\`
    ...
    <div class="table-container">
      <table class="data-table">
        ...
        <tbody>
          \${e.map(t=>{const{text:r,isFirst:n}=at(t.record_value,t.previous_value);return i\`
              <tr>
  ...
  \`}function st(e){const t=Object.keys(e);return t.length===0?i\`
      <div class="empty-state">
    ...
    <div class="stack stack-lg">
      \${t.map(r=>{const n=e[r];return i\`
          <div>
            ...
            <div class="grid grid-cols-auto">
              \${n.map(a=>i\`
                <div class="achievement-card \${rt[a.tier]||""}">
                  <div class="achievement-icon">\${a.icon||"🏅"}</div>
                  <div class="achievement-name">\${a.name}</div>
                  <div class="achievement-description">\${a.description}</div>
                  <div class="achievement-date">
                    <i class="fas fa-calendar"></i> \${\$(a.earned_at)}
                  </div>
                </div>
              \`)}
            </div>
  ...
  \`}function lt(e,t,r){return!e.current_streak||e.current_streak<=0?"":i\`
    <div class="streak-card">
      <div class="streak-row">
        ...
        <div class="streak-metric">
          ...
          <div class="streak-value-small">\${\$(e.streak_start_date)}</div>
        </div>
      </div>
      \${e.last_workout_date?i\`<div class="text-muted" style="font-size: var(--text-sm);">
            Last workout: \${\$(e.last_workout_date)}
          </div>\`:""}
    </div>
  ...
  \`}async function pt(){const e=document.getElementById("achievements");if(e){e.innerHTML=String(ct());try{const[t,r,n]=await Promise.all([p.get("/achievements"),p.get("/achievements/prs?limit=10"),p.get("/achievements/streak")]),a=t.earned||[],o=t.stats||{totalWorkouts:0,totalPRs:0},s=r.prs||[],l=n.streak||{},c=Math.floor((l.current_streak||0)/7),g=Math.floor((l.longest_streak||0)/7),m=nt(a);e.innerHTML=String(i\`
      <div class="card">
        ...
        \${it({currentWeeks:c,longestWeeks:g,totalWorkouts:o.totalWorkouts||0,totalPRs:o.totalPRs||0,earnedCount:a.length})}
    ...
    \`)}catch(t){console.error("Error loading achievements:",t),e.innerHTML=String(dt(t.message))}}}function gt(e){return i\`
    <div class="grid grid-cols-auto">
      <div class="stat-card">
  ...
  \`}function mt(e){const t=!!e.completed,r=t?"✓ Complete":"In Progress",n=t?"badge-success":"badge-warning",a=\$(e.start_time,{weekday:"short",month:"short",day:"numeric",year:"numeric"}),o=e.total_weight_kg?k(e.total_weight_kg):"N/A";return i\`
    <div class="workout-card" id="workout-card-\${e.id}">
      ...
      <div class="workout-card-details" id="workout-details-\${e.id}" hidden>
        <div class="grid grid-cols-auto" style="gap: var(--space-3);">
          \${D("Training Time",_(e.total_duration_seconds))}
          \${D("Exercises",e.exercise_count||0)}
          \${D("Total Sets",e.total_sets||0)}
          \${D("Total Volume",o)}
          \${D("Effort Level",e.perceived_exertion?\`\${e.perceived_exertion}/10 \${Xe(e.perceived_exertion)}\`:"Not rated")}
        </div>
  ...
  \`}function D(e,t){return i\`
    <div class="mini-stat">
      <div class="stat-label">\${e}</div>
      <div class="mini-stat-value">\${t}</div>
    </div>
  \`}function yt(e){return!e||e.length===0?i\`
      <div class="empty-state">
        <div class="empty-state-icon">🏋️</div>
  ...
  \`}function bt(e){e.addEventListener("click",t=>{const r=t.target.closest("[data-legacy-call]");if(r){const l=r.getAttribute("data-legacy-call"),c=window[l];typeof c=="function"&&c();return}const n=t.target.closest("[data-tab]");if(n){const l=n.getAttribute("data-tab");typeof window.switchTab=="function"&&window.switchTab(l);return}const a=t.target.closest('[data-action="toggle-details"]');if(a){const l=a.getAttribute("data-workout-id"),c=document.getElementById(\`workout-details-\${l}\`),g=document.getElementById(\`workout-chevron-\${l}\`);c&&(c.hasAttribute("hidden")?(c.removeAttribute("hidden"),g==null||g.style.setProperty("transform","rotate(180deg)")):(c.setAttribute("hidden",""),g==null||g.style.removeProperty("transform")));return}const o=t.target.closest('[data-action="view-workout"]');if(o){t.stopPropagation();const l=parseInt(o.getAttribute("data-workout-id"),10);typeof window.viewWorkout=="function"&&window.viewWorkout(l);return}const s=t.target.closest('[data-action="delete-workout"]');if(s){t.stopPropagation();const l=parseInt(s.getAttribute("data-workout-id"),10);typeof window.deleteDashboardWorkout=="function"&&window.deleteDashboardWorkout(l);return}})}async function ft(){const e=document.getElementById("dashboard");if(e){e.innerHTML=String(ht());try{const[t,,r]=await Promise.all([p.get("/analytics/progress?days=30"),p.get("/programs"),p.get("/workouts?limit=5")]),n=t.overview||{},a=r.workouts||[];e.innerHTML=String(i\`
      <div class="stack stack-lg">
        <div class="card">
          <div class="card-header">
    ...
    \`),bt(e)}catch(t){console.error("Error loading dashboard:",t),e.innerHTML=String(vt(t.message))}}}function xt(e){const r=(e.measurement_system||"metric")==="imperial";let n="",a="";if(r&&e.height_cm){const s=Ke(e.height_cm);n=s.feet,a=s.inches}const o=r&&e.weight_kg?Math.round(be(e.weight_kg)*10)/10:e.weight_kg||"";return i\`
  ...
  \`}function kt(e){const t=e.querySelector("#profile-system"),r=t==null?void 0:t.value,n=e.querySelector("#metric-inputs"),a=e.querySelector("#imperial-inputs");!n||!a||(r==="imperial"?(n.setAttribute("hidden",""),a.removeAttribute("hidden")):(a.setAttribute("hidden",""),n.removeAttribute("hidden")))}async function wt(e){try{const r=(await p.get("/reports/preferences")).preferences||{},n={weekly:"weeklyReport",monthly:"monthlyReport",yearly:"yearlyReport"};for(const[a,o]of Object.entries(n)){const s=e.querySelector(\`#profile-report-\${a}\`);s&&(s.checked=!!r[o])}}catch(t){console.error("Failed to load report preferences:",t)}}async function St(e){var t,r,n;try{return await p.put("/reports/preferences",{weeklyReport:!!((t=e.querySelector("#profile-report-weekly"))!=null&&t.checked),monthlyReport:!!((r=e.querySelector("#profile-report-monthly"))!=null&&r.checked),yearlyReport:!!((n=e.querySelector("#profile-report-yearly"))!=null&&n.checked)}),!0}catch(a){return console.error("Failed to save report preferences:",a),!1}}function \$t(e){u.info(\`Generating \${e} report preview…\`);const t=localStorage.getItem("token")||"",r=t?\`?token=\${encodeURIComponent(t)}\`:"";window.open(\`/api/reports/html/\${e}\${r}\`,"_blank")}async function Tt(e,t){const r=e.querySelector("#profile-name").value.trim(),n=parseInt(e.querySelector("#profile-age").value,10)||null,a=e.querySelector("#profile-gender").value,o=e.querySelector("#profile-system").value;let s,l;if(o==="imperial"){const c=parseFloat(e.querySelector("#profile-height-feet").value)||0,g=parseFloat(e.querySelector("#profile-height-inches").value)||0,m=parseFloat(e.querySelector("#profile-weight-lbs").value)||0;s=c||g?je(c,g):null,l=m?Ve(m):null}else s=parseFloat(e.querySelector("#profile-height-cm").value)||null,l=parseFloat(e.querySelector("#profile-weight-kg").value)||null;try{const c=await t.put("/auth/user",{name:r,age:n,gender:a,height_cm:s,weight_kg:l,measurement_system:o});L.set("user",c.user),await St(e),u.success("Profile updated");const g=window.loadUser;typeof g=="function"&&g()}catch(c){throw u.error(\`Error saving profile: \${c.message}\`),c}}function _t(){const e=L.get("user")||{};return z({title:"User Profile",size:"default",content:String(xt(e)),actions:[{label:"Cancel",variant:"btn-outline"},{label:"Save Profile",primary:!0,variant:"btn-primary",onClick:async r=>{try{await Tt(r.element,p),r.close("saved")}catch{}}}],onOpen:({element:r})=>{wt(r),r.addEventListener("change",n=>{n.target.matches("#profile-system")&&kt(r)}),r.addEventListener("click",n=>{const a=n.target.closest('[data-action="preview"]');a&&(n.preventDefault(),\$t(a.getAttribute("data-period")))})}})}const zt=[{value:"Smith Machine",label:"Smith Machine",default:!0},{value:"Olympic Bar",label:"Olympic Bar",default:!0},{value:"Cable Trainer",label:"Cable Machine",default:!0},{value:"Leg Extension/Curl",label:"Leg Ext/Curl",default:!0},{value:"Pull-up Bar",label:"Pull-up Bar"},{value:"Landmine",label:"Landmine"},{value:"Dip Bars",label:"Dip Bars"},{value:"Rower",label:"Rower"},{value:"Treadmill",label:"Treadmill"},{value:"Stationary Bike",label:"Bike"}],Mt={1:"cardio-zone-low",2:"cardio-zone-low",3:"cardio-zone-mid",4:"cardio-zone-high",5:"cardio-zone-high"};function B(){return xe()}function Rt(e){const t=e.active?i\`<span class="badge badge-success">ACTIVE</span>\`:i\`<button class="btn btn-outline btn-sm" data-action="activate" data-program-id="\${e.id}">Activate</button>\`;return i\`
  ...
  \`}async function xe(){const e=document.getElementById("program");if(e){e.innerHTML=String(i\`
    <div class="stack stack-lg">
      <div class="card">
  ...
  \`);try{const r=(await p.get("/programs")).programs||[],n=r.find(a=>a.active);e.innerHTML=String(i\`
      <div class="stack stack-lg">
        ...
        <div class="card">
          ...
          \${r.length>0?i\`<div class="stack stack-sm">\${r.map(Rt)}</div>\`:i\`
                <div class="empty-state">
                  <div class="empty-state-icon">📋</div>
    ...
    \`),Et(e)}catch(t){console.error("Error loading programs:",t),e.innerHTML=String(i\`
      <div class="card">
        <div class="empty-state">
          <div class="empty-state-icon">⚠️</div>
    ...
    \`)}}}function Et(e){e.addEventListener("click",t=>{const r=t.target.closest("[data-action]");if(!r)return;const n=r.getAttribute("data-action"),a=parseInt(r.getAttribute("data-program-id"),10);switch(n){case"view":t.stopPropagation(),Y(a);break;case"activate":t.stopPropagation(),X(a);break;case"generate":we();break;case"create-manual":Se();break}})}function Ct(e){return i\`
  ...
  \`}function Pt(e){const t=e.cardio_sessions||[];return i\`
    <strong class="cardio-day-title">
      <i class="fas fa-fire"></i> Cardio Sessions
    </strong>
    <div class="stack stack-sm">
      \${t.map(r=>i\`
        <div class="cardio-session \${Mt[r.heart_rate_zone]||"cardio-zone-mid"}">
  ...
  \`}function It(e){return i\`
    <div class="program-day-card">
      ...
      \${e.is_cardio_day?Pt(e):Ct(e)}
    </div>
  \`}async function Y(e){try{const r=(await p.get(\`/programs/\${e}\`)).program,n=r.created_at?\$(r.created_at,{year:"numeric",month:"short",day:"numeric"}):"Unknown";return z({title:"Program Details",size:"wide",content:String(i\`
      ...
      \`),actions:[{label:"Start Workout",primary:!0,variant:"btn-primary",onClick:o=>{o.close(),Nt(e)}},...r.active?[]:[{label:"Set as Active",variant:"btn-secondary",onClick:async o=>{await X(e,{silent:!1}),o.close()}}],{label:"Delete",variant:"btn-danger",onClick:async o=>{if(await G("Delete this program? This cannot be undone.",{title:"Delete program?",confirmLabel:"Delete",confirmVariant:"btn-danger"}))try{await p.delete(\`/programs/\${e}\`),u.success("Program deleted"),o.close(),B()}catch(l){u.error(\`Error deleting program: \${l.message}\`)}}}],onOpen:({element:o})=>{var s;(s=o.querySelector('[data-action="rename"]'))==null||s.addEventListener("click",()=>{ke(e,r.name)})}})}catch(t){u.error(\`Error loading program: \${t.message}\`)}}function ke(e,t){z({title:"Rename Program",size:"default",content:String(i\`
      <div class="form-group">
        <label class="form-label" for="rename-input">Program name</label>
        <input type="text" id="rename-input" class="input" value="\${t}" />
      </div>
    \`),actions:[{label:"Cancel",variant:"btn-outline"},{label:"Save Name",primary:!0,onClick:async r=>{const n=r.element.querySelector("#rename-input").value.trim();if(!n){u.warning("Please enter a program name");return}try{await p.patch(\`/programs/\${e}\`,{name:n}),u.success("Program renamed"),r.close(),B(),Y(e)}catch(a){u.error(\`Failed to rename: \${a.message}\`)}}}],onOpen:({element:r})=>{const n=r.querySelector("#rename-input");n==null||n.focus(),n==null||n.select()}})}async function X(e,t={}){try{await p.post(\`/programs/\${e}/activate\`),t.silent||u.success("Program activated"),B()}catch(r){u.error(\`Error activating program: \${r.message}\`)}}async function At(e){if(await G("Are you sure you want to delete this program?",{title:"Delete program?",confirmLabel:"Delete",confirmVariant:"btn-danger"}))try{await p.delete(\`/programs/\${e}\`),u.success("Program deleted"),B()}catch(r){u.error(\`Error deleting program: \${r.message}\`)}}function we(){z({title:"Generate AI Program",size:"default",content:String(i\`
      <div class="stack stack-md">
        <div class="form-group">
  ...
  \`);const l=t.querySelector(".modal-footer");l&&(l.style.display="none");try{await p.post("/programs/generate",{days_per_week:r,goal:n,custom_instructions:a,available_equipment:o}),s.innerHTML=String(i\`
    ...
    \`),setTimeout(()=>{e.close(),B()},1500)}catch(c){s.innerHTML=String(i\`
      <div class="generate-progress">
    ...
    \`),actions:[...d.currentDayIndex>0?[{label:"← Previous Day",variant:"btn-outline",onClick:()=>{Q(),d.currentDayIndex--,V()}}]:[],{label:"Cancel",variant:"btn-ghost"},{label:r?"Finish & Save":"Next Day →",primary:!0,onClick:async()=>{if(Q(),e.exercises.length===0){u.warning("Please select at least one exercise for this day");return}r?await Ot():(d.currentDayIndex++,V())}}],onOpen:({element:n})=>Dt(n)})}function Q(){var a;const e=(a=d.modalApi)==null?void 0:a.element;if(!e)return;const t=d.days[d.currentDayIndex],r=e.querySelector("#builder-day-name"),n=e.querySelector("#builder-day-focus");r&&(t.name=r.value.trim()||\`Day \${t.day_number}\`),n&&(t.focus=n.value.trim())}function qt(e){const t={};for(const r of e){const n=r.muscle_group||"Other";t[n]||(t[n]=[]),t[n].push(r)}return t}function Ht(e,t){const r=t.exercises.find(n=>n.exercise_id===e.id);return i\`
  ...
  \`}function Dt(e){e.addEventListener("change",t=>{const r=t.target.closest("[data-builder-toggle]");if(r){const a=parseInt(r.getAttribute("data-builder-toggle"),10);Ft(a);return}const n=t.target.closest("[data-builder-config]");if(n){const[a,o]=n.getAttribute("data-builder-config").split(":");Wt(parseInt(a,10),o,t.target.value)}})}function Ft(e){Q();const t=d.days[d.currentDayIndex],r=t.exercises.findIndex(n=>n.exercise_id===e);if(r>=0)t.exercises.splice(r,1);else{const n=d.availableExercises.find(a=>a.id===e);t.exercises.push({exercise_id:e,name:(n==null?void 0:n.name)||"",sets:3,reps:"8-12",rest_seconds:90})}V()}function Wt(e,t,r){const a=d.days[d.currentDayIndex].exercises.find(o=>o.exercise_id===e);a&&(t==="reps"?a.reps=r:a[t]=parseInt(r,10)||0)}async function Ot(){var e;try{await p.post("/programs/manual",{name:d.name,days_per_week:d.days_per_week,goal:d.goal,days:d.days}),u.success("Custom program created!"),(e=d.modalApi)==null||e.close(),d.modalApi=null,B()}catch(t){u.error(\`Error creating program: \${t.message}\`)}}async function Nt(e){const t=window.__legacyStartWorkoutFromProgram;if(typeof t=="function")return t(e);typeof window.switchTab=="function"&&window.switchTab("workout")}function Z(e){if(e===0||e==null)return i\`<span class="text-muted">—</span>\`;const r=e>0?"text-success":"text-danger";return i\`<span class="\${r}" style="font-weight: var(--font-semibold);">\${Ye(e)}</span>\`}function oe(e,t){const r=n=>\$(n,{month:"short",day:"numeric"});return\`\${r(e)} – \${r(t)}\`}function se(e,t,r){if(!r)return"";const{current:n,previous:a,changes:o}=r;return i\`
    <div style="margin-bottom: var(--space-5);">
      ...
      <div class="comparison-date-row">
        <span class="text-primary" style="font-weight: var(--font-medium);">
          \${oe(n.start_date,n.end_date)}
        </span>
        <span class="text-muted">vs</span>
        <span>\${oe(a.start_date,a.end_date)}</span>
      </div>
  ...
  \`}function Gt(e){return!e||e.length===0?i\`
      <div class="empty-state">
        <div class="empty-state-icon">📊</div>
  ...
  \`}function Ut(e){return!e||e.length===0?i\`
      <div class="empty-state">
  ...
  \`}function Kt(e){return!e||e.length===0?i\`
      <div class="empty-state">
          ...
          <div class="pr-row">
            <div>
              ...
              <span class="text-muted" style="font-size: var(--text-xs);">
                \${String(t.record_type||"").toUpperCase()} · \${\$(t.achieved_at)}
              </span>
            </div>
            <div style="text-align: right;">
  ...
  \`}async function Qt(){if(await G("This will recalculate all your Personal Records from your workout history. Continue?",{title:"Recalculate PRs?",confirmLabel:"Recalculate",confirmVariant:"btn-primary"}))try{const t=await p.post("/achievements/prs/recalculate");u.success(t.message||"PRs recalculated"),\$e()}catch(t){u.error(\`Failed to recalculate PRs: \${t.message}\`)}}function Yt(e){e.addEventListener("click",t=>{if(t.target.closest('[data-action="recalc-prs"]')){Qt();return}t.target.closest('[data-action="open-exporter"]')&&(typeof window.openUnifiedExporter=="function"?window.openUnifiedExporter():u.info("Export center is not yet available"))})}async function \$e(){const e=document.getElementById("analytics");if(e){e.innerHTML=String(Zt());try{const[t,r,n,a,o]=await Promise.all([p.get("/analytics/progress?days=90"),p.get("/analytics/volume?days=90&group_by=week"),p.get("/analytics/bodymap?days=7"),p.get("/achievements/prs?limit=10"),p.get("/analytics/progress-comparison")]),s=a.prs||[],l=t.overview||{},c=r.volume_by_muscle||[],g=n.body_map||[],m=t.top_exercises||[];e.innerHTML=String(i\`
      <div class="stack stack-lg">
        <div class="card">
          <div class="card-header">
            <h2 class="card-title"><i class="fas fa-chart-line"></i> Progress Comparison</h2>
          </div>
          \${se("This Week vs Last Week","fa-calendar-week",o.weekly)}
          \${se("This Month vs Last Month","fa-calendar-alt",o.monthly)}
        </div>
    ...
    \`),Yt(e);const y=window.loadWorkoutHistory;if(typeof y=="function")try{await y(e)}catch(f){console.warn("Legacy loadWorkoutHistory failed:",f)}}catch(t){console.error("Error loading analytics:",t),e.innerHTML=String(Jt(t.message))}}}function Xt(e){return i\`
    <div class="macro-rings">
      <div class="macro-ring-wrapper">
        \${F(j({value:Math.round(e.protein_grams||0),max:Math.round(e.protein_goal||150),size:120,unit:"g",label:"Protein",color:"var(--color-secondary)"}))}
      ...
      <div class="macro-ring-wrapper">
        \${F(j({value:Math.round(e.water_ml||0),max:Math.round(e.water_goal||2500),size:120,unit:"ml",label:"Water",color:"var(--color-primary)"}))}
        <div class="macro-ring-meta">
      ...
      <div class="macro-ring-wrapper">
        \${F(j({value:Math.round((e.creatine_grams||0)*10)/10,max:e.creatine_goal||5,size:120,unit:"g",label:"Creatine",color:"#8b5cf6"}))}
        <div class="macro-ring-meta">
  ...
  \`:""}function ar(e,t){if(!e||e.length===0)return i\`
      <div class="empty-state">
    ...
    <div class="nutrition-bar-chart">
      \${r.map(n=>{const a=Math.min(n.protein/n.protein_goal*100,100),o=Math.min(n.water/n.water_goal*100,100),s=n.date===new Date().toISOString().split("T")[0];return i\`
          <div class="nutrition-bar-day \${s?"is-today":""}">
            <div class="nutrition-bar-label">\${\$(n.date,{month:"short",day:"numeric"})}</div>
  ...
  \`}function A(e,...t){const r=window[e];if(typeof r=="function")try{return r(...t)}catch(n){u.error(\`Error: \${n.message}\`)}else u.warning("This feature is not yet available.")}async function ir(){const e=parseFloat(document.getElementById("nq-protein").value)||0,t=parseFloat(document.getElementById("nq-water").value)||0,r=parseFloat(document.getElementById("nq-creatine").value)||0;if(!e&&!t&&!r){u.warning("Enter an amount in at least one field.");return}try{const n=[];e>0&&n.push(p.post("/nutrition/entries",{entry_type:"protein",amount:e,unit:"g"})),t>0&&n.push(p.post("/nutrition/entries",{entry_type:"water",amount:t,unit:"ml"})),r>0&&n.push(p.post("/nutrition/entries",{entry_type:"creatine",amount:r,unit:"g"})),await Promise.all(n),document.getElementById("nq-protein").value="",document.getElementById("nq-water").value="",document.getElementById("nq-creatine").value="",u.success("Nutrition logged!"),Te()}catch(n){u.error(\`Error logging nutrition: \${n.message}\`)}}function or(e){e.addEventListener("click",t=>{const r=t.target.closest("[data-action]");if(!r)return;switch(r.getAttribute("data-action")){case"log-meal":A("showLogMealModal",r.getAttribute("data-meal-type"));break;case"scan-barcode":A("showBarcodeScanner");break;case"quick-macros":A("showQuickMacroEntry");break;case"saved-meals":A("showSavedMeals");break;case"log-all-quick":ir();break;case"view-entries":A("loadNutritionEntries");break;case"create-saved":A("showCreateSavedMeal");break}})}function sr(){return i\`
    <div class="stack stack-lg">
      <div class="card"><div class="skeleton skeleton-card"></div></div>
      <div class="card"><div class="skeleton skeleton-card"></div></div>
    </div>
  \`}function lr(e){return i\`
    <div class="card">
      <div class="empty-state">
        <div class="empty-state-icon">⚠️</div>
  ...
  \`}async function Te(){const e=document.getElementById("nutrition");if(e){e.innerHTML=String(sr());try{const[t,r,n]=await Promise.all([p.get("/nutrition/daily"),p.get("/nutrition/analytics?days=30"),p.get("/nutrition/streaks")]),a=r.summary,o=r.daily_data||[];e.innerHTML=String(i\`
      <div class="stack stack-lg">
        <div class="card">
          <div class="card-header">
    ...
    \`),or(e)}catch(t){console.error("Error loading nutrition:",t),e.innerHTML=String(lr(t.message))}}}window.__fitnessApp={store:L,api:p,toast:u,openModal:z,confirmDialog:G};b("learn","loadLearn",Ne);b("achievements","loadAchievements",pt);b("dashboard","loadDashboard",ft);b("profile","showProfile",_t);b("program","loadPrograms",xe);b("programs:view","viewProgram",Y);b("programs:activate","activateProgram",X);b("programs:delete","deleteProgram",At);b("programs:generate","showGenerateProgram",we);b("programs:manual","showCreateManualProgram",Se);b("programs:rename","showRenameProgramModal",ke);b("analytics","loadAnalytics",\$e);b("nutrition","loadNutrition",Te);De();
//# sourceMappingURL=index-CmV1f95Z.js.map
