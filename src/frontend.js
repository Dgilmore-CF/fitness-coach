...
(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function r(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(o){if(o.ep)return;o.ep=!0;const i=r(o);fetch(o.href,i)}})();const K=Symbol("raw"),le=Symbol("trusted");class _{constructor(t){this[le]=!0,this.value=String(t)}toString(){return this.value}}function G(e){return e==null||e===!1?new _(""):new _(e)}function de(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ce(e){return String(e).replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;")}function Z(e){return e==null||e===!1?"":e===!0?"true":e instanceof _?e.value:e&&typeof e=="object"&&K in e?e[K]:Array.isArray(e)?e.map(Z).join(""):de(e)}function l(e,...t){let r=e[0];for(let n=0;n<t.length;n++)r+=Z(t[n])+e[n+1];return new _(r)}function Y(e){const t=e instanceof _?e.value:String(e).trim(),r=document.createElement("template");return r.innerHTML=t,r.content.firstElementChild}const Q="fitness-coach:state",X={user:null,currentWorkout:null,currentProgram:null,currentTab:"dashboard",ui:{theme:"system",activeModal:null,lastVisitedTab:null},workout:{activeExerciseIndex:0,restTimerEndTime:null,workoutStartTime:null,exerciseHistory:{},modifications:{added:[],deleted:[]},pendingNotes:""},mealTracking:{searchResults:[],selectedFoods:[],currentMealType:null,scannerActive:!1},pastWorkout:{date:null,programId:null,programDayId:null,exercises:[]},analytics:{lastFetch:null,data:null},aiCoach:{conversationHistory:[],lastInsight:null}},ee=["ui"];function W(e,t){return t?t.split(".").reduce((r,n)=>r==null?r:r[n],e):e}function te(e,t,r){if(!t)return r;const n=t.split("."),o=n.pop(),i=n.reduce((a,s)=>((a[s]==null||typeof a[s]!="object")&&(a[s]={}),a[s]),e);return i[o]=r,e}function U(e){return e==null||typeof e!="object"?e:JSON.parse(JSON.stringify(e))}function pe(){try{const e=localStorage.getItem(Q);return e?JSON.parse(e):{}}catch{return{}}}function ge(e){try{const t={};for(const r of ee){const n=W(e,r);n!==void 0&&te(t,r,n)}localStorage.setItem(Q,JSON.stringify(t))}catch{}}class he{constructor(t){this.data=U(t),this.subscribers=new Map;const r=pe();for(const[n,o]of Object.entries(r))this.data[n]={...this.data[n],...o}}get(t){return W(this.data,t)}set(t,r){const n=this.get(t);if(n===r)return;te(this.data,t,r),ee.some(i=>t===i||t.startsWith(\`\${i}.\`))&&ge(this.data),this.notify(t,r,n);const o=t.split(".");for(let i=o.length-1;i>0;i--){const a=o.slice(0,i).join(".");this.notify(a,this.get(a),null)}}merge(t,r){const n=this.get(t)||{};this.set(t,{...n,...r})}reset(t){const r=W(X,t);this.set(t,U(r))}subscribe(t,r){this.subscribers.has(t)||this.subscribers.set(t,new Set);const n=this.subscribers.get(t);return n.add(r),()=>n.delete(r)}notify(t,r,n){const o=this.subscribers.get(t);if(o)for(const i of o)try{i(r,n)}catch(a){console.error(\`Subscriber error for "\${t}":\`,a)}}}const M=new he(X);typeof window<"u"&&(window.__store=M);const re="/api",ye=3e4,me=6e4,\$=new Map;class D extends Error{constructor(t,{status:r=0,code:n=null,details:o=null}={}){super(t),this.name="ApiError",this.status=r,this.code=n,this.details=o}}async function z(e,t={}){var E;const{method:r="GET",body:n,headers:o={},cache:i=!1,timeout:a=ye,signal:s}=t,d=\`\${re}\${e}\`,c=\`\${r} \${d}\`;if(r==="GET"&&i){const b=\$.get(c);if(b&&Date.now()-b.at<me)return b.data}const g=new AbortController,h=setTimeout(()=>g.abort(),a);s&&s.addEventListener("abort",()=>g.abort(),{once:!0});const x={method:r,headers:{"Content-Type":"application/json",...o},signal:g.signal};n!=null&&(n instanceof FormData?(delete x.headers["Content-Type"],x.body=n):typeof n=="string"?x.body=n:x.body=JSON.stringify(n));let u;try{u=await fetch(d,x)}catch(b){throw clearTimeout(h),b.name==="AbortError"?new D("Request timed out",{code:"TIMEOUT"}):new D("Network error",{code:"NETWORK",details:b.message})}clearTimeout(h);const f=(E=u.headers.get("content-type"))==null?void 0:E.includes("application/json"),y=f?await u.json().catch(()=>({})):await u.text();if(!u.ok){const b=f&&(y==null?void 0:y.error)||\`Request failed (\${u.status})\`;throw new D(b,{status:u.status,code:y==null?void 0:y.code,details:y==null?void 0:y.details})}return r==="GET"&&i&&\$.set(c,{data:y,at:Date.now()}),y}function ue(e=""){const t=\`GET \${re}\${e}\`;for(const r of \$.keys())r.startsWith(t)&&\$.delete(r)}const v={get:(e,t)=>z(e,{...t,method:"GET"}),post:(e,t,r)=>z(e,{...r,method:"POST",body:t}),put:(e,t,r)=>z(e,{...r,method:"PUT",body:t}),patch:(e,t,r)=>z(e,{...r,method:"PATCH",body:t}),delete:(e,t)=>z(e,{...t,method:"DELETE"}),request:z,invalidateCache:ue},j={success:"fa-check-circle",error:"fa-exclamation-circle",warning:"fa-exclamation-triangle",info:"fa-info-circle"},be=3e3;let m=null;function ve(){return m&&document.body.contains(m)||(m=document.getElementById("toast-container"),m||(m=document.createElement("div"),m.id="toast-container",m.setAttribute("aria-live","polite"),m.setAttribute("aria-atomic","true"),document.body.appendChild(m))),m}function C(e,t={}){var g;const{type:r="info",duration:n=be,icon:o,action:i}=t,a=o?\`fa-\${o}\`:j[r]||j.info,s=Y(l\`
    <div class="toast toast-\${ce(r)}" role="alert">
      <i class="fas \${a} toast-icon" aria-hidden="true"></i>
      <div class="toast-message">\${e}</div>
      \${i?l\`<button class="btn btn-sm btn-ghost toast-action">\${i.label}</button>\`:""}
    </div>
  \`);ve().appendChild(s),i!=null&&i.onClick&&((g=s.querySelector(".toast-action"))==null||g.addEventListener("click",()=>{i.onClick(),c()}));let d=!1;const c=()=>{d||(d=!0,s.style.animation="slide-out-right var(--transition-base) forwards",s.addEventListener("animationend",()=>s.remove(),{once:!0}))};return n>0&&setTimeout(c,n),c}const H={show:(e,t)=>C(e,t),success:(e,t)=>C(e,{...t,type:"success"}),error:(e,t)=>C(e,{...t,type:"error",duration:(t==null?void 0:t.duration)??5e3}),warning:(e,t)=>C(e,{...t,type:"warning"}),info:(e,t)=>C(e,{...t,type:"info"})},R=[];function xe(){let e=document.getElementById("modal-root");return e||(e=document.createElement("div"),e.id="modal-root",document.body.appendChild(e)),e}function fe(e){const t=e.querySelectorAll('a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])');if(t.length===0)return null;const r=t[0],n=t[t.length-1],o=i=>{i.key==="Tab"&&(i.shiftKey&&document.activeElement===r?(i.preventDefault(),n.focus()):!i.shiftKey&&document.activeElement===n&&(i.preventDefault(),r.focus()))};return e.addEventListener("keydown",o),r.focus(),()=>e.removeEventListener("keydown",o)}function O(e){var V;const{title:t,content:r,actions:n=[],size:o="default",dismissable:i=!0,onOpen:a,onClose:s}=e,d=o==="wide"?"modal-wide":o==="fullscreen"?"modal-fullscreen":"",c=n.length?l\`
        <div class="modal-footer">
          \${n.map((p,k)=>l\`
            <button
              class="btn \${p.variant||(p.primary?"btn-primary":"btn-outline")}"
              data-modal-action="\${k}"
            >\${p.label}</button>
          \`)}
        </div>
  ...
  \`),x=h.querySelector(".modal"),u=h.querySelector(".modal-body");r instanceof Node?u.appendChild(r):r!=null&&(u.innerHTML=String(r));const f=document.activeElement;let y=!1,E;const b=new Promise(p=>E=p),S=p=>{if(y)return;y=!0;const k=R.indexOf(w);k>=0&&R.splice(k,1),F==null||F(),h.style.animation="fade-out var(--transition-fast) forwards",x.style.animation="slide-up var(--transition-fast) reverse forwards",h.addEventListener("animationend",()=>{var T;h.remove(),(T=f==null?void 0:f.focus)==null||T.call(f)},{once:!0}),R.length===0&&(document.body.style.overflow=""),s==null||s(p),E(p)},w={element:x,backdrop:h,close:S,promise:b};h.querySelectorAll("[data-modal-action]").forEach(p=>{const k=parseInt(p.getAttribute("data-modal-action"),10),T=n[k];p.addEventListener("click",async()=>{T.onClick?await T.onClick(w):S(T.value??k)})}),(V=h.querySelector("[data-modal-close]"))==null||V.addEventListener("click",()=>S()),i&&h.addEventListener("click",p=>{p.target===h&&S()});const N=p=>{p.key==="Escape"&&i&&R[R.length-1]===w&&S()};document.addEventListener("keydown",N);const se=S;w.close=p=>{document.removeEventListener("keydown",N),se(p)},xe().appendChild(h),document.body.style.overflow="hidden",R.push(w);const F=fe(x);return a==null||a(w),w}function we(e,t={}){const{title:r="Are you sure?",confirmLabel:n="Confirm",cancelLabel:o="Cancel",confirmVariant:i="btn-primary"}=t;return new Promise(a=>{O({title:r,content:l\`<p>\${e}</p>\`,actions:[{label:o,variant:"btn-outline",onClick:s=>s.close(!1)},{label:n,variant:i,primary:!0,onClick:s=>s.close(!0)}],onClose:s=>a(s===!0)})})}const A=new Map;function q(e,t,r){A.set(e,{legacyGlobal:t,handler:r})}function J(){for(const[t,{legacyGlobal:r,handler:n}]of A){const o=window[r];window[r]=function(...a){try{return n(...a)}catch(s){if(console.error(\`[bridge] "\${r}" handler failed, falling back to legacy:\`,s),typeof o=="function")return o.apply(this,a);throw s}},window[r].__legacy=o,window[r].__modular=!0}const e=window.switchTab;typeof e=="function"&&!e.__bridged&&(window.switchTab=function(r,...n){return M.set("currentTab",r),e.call(this,r,...n)},window.switchTab.__bridged=!0,window.switchTab.__legacy=e),console.info(\`[bridge] Installed \${A.size} modular screen handler(s):\`,Array.from(A.keys()).join(", "))}function ke(){document.readyState==="loading"?document.addEventListener("DOMContentLoaded",J,{once:!0}):J()}const Se=\`    <div class="card">
...
\`,Te={hypertrophy:"#hypertrophy-section",strength:"#strength-section",endurance:"#endurance-section",cardio:"#cardio-section",comparison:"#comparison-section",variables:"#variables-section"};function ze(e){e.innerHTML=Se,e.addEventListener("click",t=>{var i;const r=t.target.closest("[data-learn-scroll]");if(!r)return;t.preventDefault();const n=r.getAttribute("data-learn-scroll"),o=Te[n];o&&((i=e.querySelector(o))==null||i.scrollIntoView({behavior:"smooth",block:"start"}))})}function Re(){const e=document.getElementById("learn");e&&ze(e)}const ne=2.20462,oe=1/2.54;function ie(e){return e==null?0:Math.round(e*ne*10)/10}function Me(e){return e==null?0:Math.round(e/ne*100)/100}function Ee(e){return e*oe}function Ce(e){return e/oe}function Pe(e){const t=Math.round(Ee(e)),r=Math.floor(t/12),n=t-r*12;return{feet:r,inches:n}}function _e(e,t){return Ce((e||0)*12+(t||0))}function Ie(){const e=M.get("user");return e&&e.measurement_system||"metric"}function ae(){return Ie()==="imperial"}function Ae(){return ae()?"lbs":"kg"}function \$e(e){return e==null?0:ae()?ie(e):e}function B(e,t={}){const{unit:r=!0,precision:n=1}=t;if(e==null)return"N/A";const o=\$e(e),i=Ae();let a;return Math.abs(o)>=1e3?a=Math.round(o).toLocaleString():o%1===0?a=String(o):a=o.toFixed(n),r?\`\${a} \${i}\`:a}function L(e){if(e==null||e<0)return"00:00";const t=Math.abs(Math.floor(e)),r=Math.floor(t/3600),n=Math.floor(t%3600/60),o=t%60,i=a=>String(a).padStart(2,"0");return r>0?\`\${i(r)}:\${i(n)}:\${i(o)}\`:\`\${i(n)}:\${i(o)}\`}function I(e,t={month:"short",day:"numeric",year:"numeric"}){if(!e)return"";const[r,n,o]=String(e).split("T")[0].split("-").map(Number);return!r||!n||!o?e:new Date(r,n-1,o).toLocaleDateString("en-US",t)}function He(e){return e==null?"":e<=2?"😴":e<=4?"🙂":e<=6?"💪":e<=8?"🔥":"🥵"}const Be={consistency:"🔥",strength:"💪",volume:"📊",milestone:"⭐"},Le={consistency:"Consistency",strength:"Strength",volume:"Volume",milestone:"Milestones"},qe={bronze:"tier-bronze",silver:"tier-silver",gold:"tier-gold",platinum:"tier-platinum"};function Fe(e){const t={};for(const r of e){const n=r.category||"other";t[n]||(t[n]=[]),t[n].push(r)}return t}function De(e,t){return!t||t===0?{text:"First PR!",isFirst:!0}:{text:\`+\${((e-t)/t*100).toFixed(1)}%\`,isFirst:!1}}function We({currentWeeks:e,longestWeeks:t,totalWorkouts:r,totalPRs:n,earnedCount:o}){return l\`
  ...
  \`}function Oe(e){return!e||e.length===0?l\`
    ...
    <div class="table-container">
      <table class="data-table">
        ...
        <tbody>
          \${e.map(t=>{const{text:r,isFirst:n}=De(t.record_value,t.previous_value);return l\`
              <tr>
                ...
                <td>\${I(t.achieved_at)}</td>
              </tr>
            \`})}
        </tbody>
      </table>
    </div>
  \`}function Ne(e){const t=Object.keys(e);return t.length===0?l\`
      <div class="empty-state">
    ...
    <div class="stack stack-lg">
      \${t.map(r=>{const n=e[r];return l\`
          <div>
            ...
            <div class="grid grid-cols-auto">
              \${n.map(o=>l\`
                <div class="achievement-card \${qe[o.tier]||""}">
                  ...
                  <div class="achievement-date">
                    <i class="fas fa-calendar"></i> \${I(o.earned_at)}
                  </div>
                </div>
              \`)}
            </div>
  ...
  \`}function Ve(e,t,r){return!e.current_streak||e.current_streak<=0?"":l\`
    <div class="streak-card">
      <div class="streak-row">
        ...
        <div class="streak-metric">
          ...
          <div class="streak-value-small">\${I(e.streak_start_date)}</div>
        </div>
      </div>
      \${e.last_workout_date?l\`<div class="text-muted" style="font-size: var(--text-sm);">
            Last workout: \${I(e.last_workout_date)}
          </div>\`:""}
    </div>
  \`}function Ke(e){return l\`
    <div class="card">
      <div class="empty-state">
        <div class="empty-state-icon">⚠️</div>
  ...
  \`}function Ge(){return l\`
    <div class="card">
      <div class="grid grid-cols-auto">
        \${[1,2,3,4].map(()=>l\`<div class="skeleton skeleton-card"></div>\`)}
      </div>
    </div>
  \`}async function Ue(){const e=document.getElementById("achievements");if(e){e.innerHTML=String(Ge());try{const[t,r,n]=await Promise.all([v.get("/achievements"),v.get("/achievements/prs?limit=10"),v.get("/achievements/streak")]),o=t.earned||[],i=t.stats||{totalWorkouts:0,totalPRs:0},a=r.prs||[],s=n.streak||{},d=Math.floor((s.current_streak||0)/7),c=Math.floor((s.longest_streak||0)/7),g=Fe(o);e.innerHTML=String(l\`
      <div class="card">
        ...
        \${We({currentWeeks:d,longestWeeks:c,totalWorkouts:i.totalWorkouts||0,totalPRs:i.totalPRs||0,earnedCount:o.length})}
    ...
    \`)}catch(t){console.error("Error loading achievements:",t),e.innerHTML=String(Ke(t.message))}}}function je(e){return l\`
    <div class="grid grid-cols-auto">
      <div class="stat-card">
  ...
  \`}function Ze(e){const t=!!e.completed,r=t?"✓ Complete":"In Progress",n=t?"badge-success":"badge-warning",o=I(e.start_time,{weekday:"short",month:"short",day:"numeric",year:"numeric"}),i=e.total_weight_kg?B(e.total_weight_kg):"N/A";return l\`
    <div class="workout-card" id="workout-card-\${e.id}">
      ...
      <div class="workout-card-details" id="workout-details-\${e.id}" hidden>
        <div class="grid grid-cols-auto" style="gap: var(--space-3);">
          \${P("Training Time",L(e.total_duration_seconds))}
          \${P("Exercises",e.exercise_count||0)}
          \${P("Total Sets",e.total_sets||0)}
          \${P("Total Volume",i)}
          \${P("Effort Level",e.perceived_exertion?\`\${e.perceived_exertion}/10 \${He(e.perceived_exertion)}\`:"Not rated")}
        </div>
  ...
  \`}function P(e,t){return l\`
    <div class="mini-stat">
      <div class="stat-label">\${e}</div>
      <div class="mini-stat-value">\${t}</div>
    </div>
  \`}function Ye(e){return!e||e.length===0?l\`
      <div class="empty-state">
        <div class="empty-state-icon">🏋️</div>
  ...
  \`}function et(e){e.addEventListener("click",t=>{const r=t.target.closest("[data-legacy-call]");if(r){const s=r.getAttribute("data-legacy-call"),d=window[s];typeof d=="function"&&d();return}const n=t.target.closest("[data-tab]");if(n){const s=n.getAttribute("data-tab");typeof window.switchTab=="function"&&window.switchTab(s);return}const o=t.target.closest('[data-action="toggle-details"]');if(o){const s=o.getAttribute("data-workout-id"),d=document.getElementById(\`workout-details-\${s}\`),c=document.getElementById(\`workout-chevron-\${s}\`);d&&(d.hasAttribute("hidden")?(d.removeAttribute("hidden"),c==null||c.style.setProperty("transform","rotate(180deg)")):(d.setAttribute("hidden",""),c==null||c.style.removeProperty("transform")));return}const i=t.target.closest('[data-action="view-workout"]');if(i){t.stopPropagation();const s=parseInt(i.getAttribute("data-workout-id"),10);typeof window.viewWorkout=="function"&&window.viewWorkout(s);return}const a=t.target.closest('[data-action="delete-workout"]');if(a){t.stopPropagation();const s=parseInt(a.getAttribute("data-workout-id"),10);typeof window.deleteDashboardWorkout=="function"&&window.deleteDashboardWorkout(s);return}})}async function tt(){const e=document.getElementById("dashboard");if(e){e.innerHTML=String(Qe());try{const[t,,r]=await Promise.all([v.get("/analytics/progress?days=30"),v.get("/programs"),v.get("/workouts?limit=5")]),n=t.overview||{},o=r.workouts||[];e.innerHTML=String(l\`
      <div class="stack stack-lg">
        <div class="card">
          <div class="card-header">
    ...
    \`),et(e)}catch(t){console.error("Error loading dashboard:",t),e.innerHTML=String(Xe(t.message))}}}function rt(e){const r=(e.measurement_system||"metric")==="imperial";let n="",o="";if(r&&e.height_cm){const a=Pe(e.height_cm);n=a.feet,o=a.inches}const i=r&&e.weight_kg?Math.round(ie(e.weight_kg)*10)/10:e.weight_kg||"";return l\`
    <div class="stack stack-md">
      ...
      <div>
        ...
        <div class="stack stack-sm">
          \${[{id:"weekly",label:"Weekly Report",hint:"Sent every Monday morning"},{id:"monthly",label:"Monthly Report",hint:"Sent on the 1st of each month"},{id:"yearly",label:"Yearly Report",hint:"Sent on January 1st"}].map(a=>l\`
            <label class="report-pref-row">
              <input type="checkbox" id="profile-report-\${a.id}" data-report-toggle="\${a.id}" />
              <div>
                <strong>\${a.label}</strong>
                <div class="text-muted" style="font-size: var(--text-xs);">\${a.hint}</div>
              </div>
            </label>
          \`)}
        </div>
  ...
  \`}function nt(e){const t=e.querySelector("#profile-system"),r=t==null?void 0:t.value,n=e.querySelector("#metric-inputs"),o=e.querySelector("#imperial-inputs");!n||!o||(r==="imperial"?(n.setAttribute("hidden",""),o.removeAttribute("hidden")):(o.setAttribute("hidden",""),n.removeAttribute("hidden")))}async function ot(e){try{const r=(await v.get("/reports/preferences")).preferences||{},n={weekly:"weeklyReport",monthly:"monthlyReport",yearly:"yearlyReport"};for(const[o,i]of Object.entries(n)){const a=e.querySelector(\`#profile-report-\${o}\`);a&&(a.checked=!!r[i])}}catch(t){console.error("Failed to load report preferences:",t)}}async function it(e){var t,r,n;try{return await v.put("/reports/preferences",{weeklyReport:!!((t=e.querySelector("#profile-report-weekly"))!=null&&t.checked),monthlyReport:!!((r=e.querySelector("#profile-report-monthly"))!=null&&r.checked),yearlyReport:!!((n=e.querySelector("#profile-report-yearly"))!=null&&n.checked)}),!0}catch(o){return console.error("Failed to save report preferences:",o),!1}}function at(e){H.info(\`Generating \${e} report preview…\`);const t=localStorage.getItem("token")||"",r=t?\`?token=\${encodeURIComponent(t)}\`:"";window.open(\`/api/reports/html/\${e}\${r}\`,"_blank")}async function st(e,t){const r=e.querySelector("#profile-name").value.trim(),n=parseInt(e.querySelector("#profile-age").value,10)||null,o=e.querySelector("#profile-gender").value,i=e.querySelector("#profile-system").value;let a,s;if(i==="imperial"){const d=parseFloat(e.querySelector("#profile-height-feet").value)||0,c=parseFloat(e.querySelector("#profile-height-inches").value)||0,g=parseFloat(e.querySelector("#profile-weight-lbs").value)||0;a=d||c?_e(d,c):null,s=g?Me(g):null}else a=parseFloat(e.querySelector("#profile-height-cm").value)||null,s=parseFloat(e.querySelector("#profile-weight-kg").value)||null;try{const d=await t.put("/auth/user",{name:r,age:n,gender:o,height_cm:a,weight_kg:s,measurement_system:i});M.set("user",d.user),await it(e),H.success("Profile updated");const c=window.loadUser;typeof c=="function"&&c()}catch(d){throw H.error(\`Error saving profile: \${d.message}\`),d}}function lt(){const e=M.get("user")||{};return O({title:"User Profile",size:"default",content:String(rt(e)),actions:[{label:"Cancel",variant:"btn-outline"},{label:"Save Profile",primary:!0,variant:"btn-primary",onClick:async r=>{try{await st(r.element,v),r.close("saved")}catch{}}}],onOpen:({element:r})=>{ot(r),r.addEventListener("change",n=>{n.target.matches("#profile-system")&&nt(r)}),r.addEventListener("click",n=>{const o=n.target.closest('[data-action="preview"]');o&&(n.preventDefault(),at(o.getAttribute("data-period")))})}})}window.__fitnessApp={store:M,api:v,toast:H,openModal:O,confirmDialog:we};q("learn","loadLearn",Re);q("achievements","loadAchievements",Ue);q("dashboard","loadDashboard",tt);q("profile","showProfile",lt);ke();
//# sourceMappingURL=index-CgoRs9Q7.js.map
