...
(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const s of i.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&n(s)}).observe(document,{childList:!0,subtree:!0});function r(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(o){if(o.ep)return;o.ep=!0;const i=r(o);fetch(o.href,i)}})();const Q=Symbol("raw"),fe=Symbol("trusted");class L{constructor(t){this[fe]=!0,this.value=String(t)}toString(){return this.value}}function X(e){return e==null||e===!1?new L(""):new L(e)}function xe(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function we(e){return String(e).replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;")}function ne(e){return e==null||e===!1?"":e===!0?"true":e instanceof L?e.value:e&&typeof e=="object"&&Q in e?e[Q]:Array.isArray(e)?e.map(ne).join(""):xe(e)}function a(e,...t){let r=e[0];for(let n=0;n<t.length;n++)r+=ne(t[n])+e[n+1];return new L(r)}function oe(e){const t=e instanceof L?e.value:String(e).trim(),r=document.createElement("template");return r.innerHTML=t,r.content.firstElementChild}const ie="fitness-coach:state",ae={user:null,currentWorkout:null,currentProgram:null,currentTab:"dashboard",ui:{theme:"system",activeModal:null,lastVisitedTab:null},workout:{activeExerciseIndex:0,restTimerEndTime:null,workoutStartTime:null,exerciseHistory:{},modifications:{added:[],deleted:[]},pendingNotes:""},mealTracking:{searchResults:[],selectedFoods:[],currentMealType:null,scannerActive:!1},pastWorkout:{date:null,programId:null,programDayId:null,exercises:[]},analytics:{lastFetch:null,data:null},aiCoach:{conversationHistory:[],lastInsight:null}},se=["ui"];function G(e,t){return t?t.split(".").reduce((r,n)=>r==null?r:r[n],e):e}function le(e,t,r){if(!t)return r;const n=t.split("."),o=n.pop(),i=n.reduce((s,l)=>((s[l]==null||typeof s[l]!="object")&&(s[l]={}),s[l]),e);return i[o]=r,e}function ee(e){return e==null||typeof e!="object"?e:JSON.parse(JSON.stringify(e))}function ke(){try{const e=localStorage.getItem(ie);return e?JSON.parse(e):{}}catch{return{}}}function Se(e){try{const t={};for(const r of se){const n=G(e,r);n!==void 0&&le(t,r,n)}localStorage.setItem(ie,JSON.stringify(t))}catch{}}class Te{constructor(t){this.data=ee(t),this.subscribers=new Map;const r=ke();for(const[n,o]of Object.entries(r))this.data[n]={...this.data[n],...o}}get(t){return G(this.data,t)}set(t,r){const n=this.get(t);if(n===r)return;le(this.data,t,r),se.some(i=>t===i||t.startsWith(\`\${i}.\`))&&Se(this.data),this.notify(t,r,n);const o=t.split(".");for(let i=o.length-1;i>0;i--){const s=o.slice(0,i).join(".");this.notify(s,this.get(s),null)}}merge(t,r){const n=this.get(t)||{};this.set(t,{...n,...r})}reset(t){const r=G(ae,t);this.set(t,ee(r))}subscribe(t,r){this.subscribers.has(t)||this.subscribers.set(t,new Set);const n=this.subscribers.get(t);return n.add(r),()=>n.delete(r)}notify(t,r,n){const o=this.subscribers.get(t);if(o)for(const i of o)try{i(r,n)}catch(s){console.error(\`Subscriber error for "\${t}":\`,s)}}}const _=new Te(ae);typeof window<"u"&&(window.__store=_);const de="/api",ze=3e4,Me=6e4,D=new Map;class V extends Error{constructor(t,{status:r=0,code:n=null,details:o=null}={}){super(t),this.name="ApiError",this.status=r,this.code=n,this.details=o}}async function E(e,t={}){var A;const{method:r="GET",body:n,headers:o={},cache:i=!1,timeout:s=ze,signal:l}=t,c=\`\${de}\${e}\`,p=\`\${r} \${c}\`;if(r==="GET"&&i){const w=D.get(p);if(w&&Date.now()-w.at<Me)return w.data}const u=new AbortController,h=setTimeout(()=>u.abort(),s);l&&l.addEventListener("abort",()=>u.abort(),{once:!0});const k={method:r,headers:{"Content-Type":"application/json",...o},signal:u.signal};n!=null&&(n instanceof FormData?(delete k.headers["Content-Type"],k.body=n):typeof n=="string"?k.body=n:k.body=JSON.stringify(n));let x;try{x=await fetch(c,k)}catch(w){throw clearTimeout(h),w.name==="AbortError"?new V("Request timed out",{code:"TIMEOUT"}):new V("Network error",{code:"NETWORK",details:w.message})}clearTimeout(h);const S=(A=x.headers.get("content-type"))==null?void 0:A.includes("application/json"),b=S?await x.json().catch(()=>({})):await x.text();if(!x.ok){const w=S&&(b==null?void 0:b.error)||\`Request failed (\${x.status})\`;throw new V(w,{status:x.status,code:b==null?void 0:b.code,details:b==null?void 0:b.details})}return r==="GET"&&i&&D.set(p,{data:b,at:Date.now()}),b}function Re(e=""){const t=\`GET \${de}\${e}\`;for(const r of D.keys())r.startsWith(t)&&D.delete(r)}const g={get:(e,t)=>E(e,{...t,method:"GET"}),post:(e,t,r)=>E(e,{...r,method:"POST",body:t}),put:(e,t,r)=>E(e,{...r,method:"PUT",body:t}),patch:(e,t,r)=>E(e,{...r,method:"PATCH",body:t}),delete:(e,t)=>E(e,{...t,method:"DELETE"}),request:E,invalidateCache:Re},te={success:"fa-check-circle",error:"fa-exclamation-circle",warning:"fa-exclamation-triangle",info:"fa-info-circle"},Ce=3e3;let v=null;function Ee(){return v&&document.body.contains(v)||(v=document.getElementById("toast-container"),v||(v=document.createElement("div"),v.id="toast-container",v.setAttribute("aria-live","polite"),v.setAttribute("aria-atomic","true"),document.body.appendChild(v))),v}function B(e,t={}){var u;const{type:r="info",duration:n=Ce,icon:o,action:i}=t,s=o?\`fa-\${o}\`:te[r]||te.info,l=oe(a\`
    <div class="toast toast-\${we(r)}" role="alert">
  ...
  \`);Ee().appendChild(l),i!=null&&i.onClick&&((u=l.querySelector(".toast-action"))==null||u.addEventListener("click",()=>{i.onClick(),p()}));let c=!1;const p=()=>{c||(c=!0,l.style.animation="slide-out-right var(--transition-base) forwards",l.addEventListener("animationend",()=>l.remove(),{once:!0}))};return n>0&&setTimeout(p,n),p}const m={show:(e,t)=>B(e,t),success:(e,t)=>B(e,{...t,type:"success"}),error:(e,t)=>B(e,{...t,type:"error",duration:(t==null?void 0:t.duration)??5e3}),warning:(e,t)=>B(e,{...t,type:"warning"}),info:(e,t)=>B(e,{...t,type:"info"})},P=[];function Pe(){let e=document.getElementById("modal-root");return e||(e=document.createElement("div"),e.id="modal-root",document.body.appendChild(e)),e}function \$e(e){const t=e.querySelectorAll('a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])');if(t.length===0)return null;const r=t[0],n=t[t.length-1],o=i=>{i.key==="Tab"&&(i.shiftKey&&document.activeElement===r?(i.preventDefault(),n.focus()):!i.shiftKey&&document.activeElement===n&&(i.preventDefault(),r.focus()))};return e.addEventListener("keydown",o),r.focus(),()=>e.removeEventListener("keydown",o)}function T(e){var Y;const{title:t,content:r,actions:n=[],size:o="default",dismissable:i=!0,onOpen:s,onClose:l}=e,c=o==="wide"?"modal-wide":o==="fullscreen"?"modal-fullscreen":"",p=n.length?a\`
  ...
  \`),k=h.querySelector(".modal"),x=h.querySelector(".modal-body");r instanceof Node?x.appendChild(r):r!=null&&(x.innerHTML=String(r));const S=document.activeElement;let b=!1,A;const w=new Promise(y=>A=y),R=y=>{if(b)return;b=!0;const M=P.indexOf(z);M>=0&&P.splice(M,1),N==null||N(),h.style.animation="fade-out var(--transition-fast) forwards",k.style.animation="slide-up var(--transition-fast) reverse forwards",h.addEventListener("animationend",()=>{var C;h.remove(),(C=S==null?void 0:S.focus)==null||C.call(S)},{once:!0}),P.length===0&&(document.body.style.overflow=""),l==null||l(y),A(y)},z={element:k,backdrop:h,close:R,promise:w};h.querySelectorAll("[data-modal-action]").forEach(y=>{const M=parseInt(y.getAttribute("data-modal-action"),10),C=n[M];y.addEventListener("click",async()=>{C.onClick?await C.onClick(z):R(C.value??M)})}),(Y=h.querySelector("[data-modal-close]"))==null||Y.addEventListener("click",()=>R()),i&&h.addEventListener("click",y=>{y.target===h&&R()});const J=y=>{y.key==="Escape"&&i&&P[P.length-1]===z&&R()};document.addEventListener("keydown",J);const ve=R;z.close=y=>{document.removeEventListener("keydown",J),ve(y)},Pe().appendChild(h),document.body.style.overflow="hidden",P.push(z);const N=\$e(k);return s==null||s(z),z}function K(e,t={}){const{title:r="Are you sure?",confirmLabel:n="Confirm",cancelLabel:o="Cancel",confirmVariant:i="btn-primary"}=t;return new Promise(s=>{T({title:r,content:a\`<p>\${e}</p>\`,actions:[{label:o,variant:"btn-outline",onClick:l=>l.close(!1)},{label:n,variant:i,primary:!0,onClick:l=>l.close(!0)}],onClose:l=>s(l===!0)})})}const q=new Map;function f(e,t,r){q.set(e,{legacyGlobal:t,handler:r})}function re(){for(const[t,{legacyGlobal:r,handler:n}]of q){const o=window[r];window[r]=function(...s){try{return n(...s)}catch(l){if(console.error(\`[bridge] "\${r}" handler failed, falling back to legacy:\`,l),typeof o=="function")return o.apply(this,s);throw l}},window[r].__legacy=o,window[r].__modular=!0}const e=window.switchTab;typeof e=="function"&&!e.__bridged&&(window.switchTab=function(r,...n){return _.set("currentTab",r),e.call(this,r,...n)},window.switchTab.__bridged=!0,window.switchTab.__legacy=e),console.info(\`[bridge] Installed \${q.size} modular screen handler(s):\`,Array.from(q.keys()).join(", "))}function _e(){document.readyState==="loading"?document.addEventListener("DOMContentLoaded",re,{once:!0}):re()}const Ie=\`    <div class="card">
...
\`,Ae={hypertrophy:"#hypertrophy-section",strength:"#strength-section",endurance:"#endurance-section",cardio:"#cardio-section",comparison:"#comparison-section",variables:"#variables-section"};function Be(e){e.innerHTML=Ie,e.addEventListener("click",t=>{var i;const r=t.target.closest("[data-learn-scroll]");if(!r)return;t.preventDefault();const n=r.getAttribute("data-learn-scroll"),o=Ae[n];o&&((i=e.querySelector(o))==null||i.scrollIntoView({behavior:"smooth",block:"start"}))})}function He(){const e=document.getElementById("learn");e&&Be(e)}const ce=2.20462,pe=1/2.54;function ge(e){return e==null?0:Math.round(e*ce*10)/10}function Le(e){return e==null?0:Math.round(e/ce*100)/100}function qe(e){return e*pe}function De(e){return e/pe}function Fe(e){const t=Math.round(qe(e)),r=Math.floor(t/12),n=t-r*12;return{feet:r,inches:n}}function Oe(e,t){return De((e||0)*12+(t||0))}function We(){const e=_.get("user");return e&&e.measurement_system||"metric"}function me(){return We()==="imperial"}function Ne(){return me()?"lbs":"kg"}function Ve(e){return e==null?0:me()?ge(e):e}function F(e,t={}){const{unit:r=!0,precision:n=1}=t;if(e==null)return"N/A";const o=Ve(e),i=Ne();let s;return Math.abs(o)>=1e3?s=Math.round(o).toLocaleString():o%1===0?s=String(o):s=o.toFixed(n),r?\`\${s} \${i}\`:s}function O(e){if(e==null||e<0)return"00:00";const t=Math.abs(Math.floor(e)),r=Math.floor(t/3600),n=Math.floor(t%3600/60),o=t%60,i=s=>String(s).padStart(2,"0");return r>0?\`\${i(r)}:\${i(n)}:\${i(o)}\`:\`\${i(n)}:\${i(o)}\`}function \$(e,t={month:"short",day:"numeric",year:"numeric"}){if(!e)return"";const[r,n,o]=String(e).split("T")[0].split("-").map(Number);return!r||!n||!o?e:new Date(r,n-1,o).toLocaleDateString("en-US",t)}function Ge(e){return e==null?"":e<=2?"😴":e<=4?"🙂":e<=6?"💪":e<=8?"🔥":"🥵"}const Ue={consistency:"🔥",strength:"💪",volume:"📊",milestone:"⭐"},Ke={consistency:"Consistency",strength:"Strength",volume:"Volume",milestone:"Milestones"},je={bronze:"tier-bronze",silver:"tier-silver",gold:"tier-gold",platinum:"tier-platinum"};function Ze(e){const t={};for(const r of e){const n=r.category||"other";t[n]||(t[n]=[]),t[n].push(r)}return t}function Je(e,t){return!t||t===0?{text:"First PR!",isFirst:!0}:{text:\`+\${((e-t)/t*100).toFixed(1)}%\`,isFirst:!1}}function Ye({currentWeeks:e,longestWeeks:t,totalWorkouts:r,totalPRs:n,earnedCount:o}){return a\`
  ...
  \`}function Qe(e){return!e||e.length===0?a\`
    ...
    <div class="table-container">
      <table class="data-table">
        ...
        <tbody>
          \${e.map(t=>{const{text:r,isFirst:n}=Je(t.record_value,t.previous_value);return a\`
              <tr>
  ...
  \`}function Xe(e){const t=Object.keys(e);return t.length===0?a\`
      <div class="empty-state">
    ...
    <div class="stack stack-lg">
      \${t.map(r=>{const n=e[r];return a\`
          <div>
            ...
            <div class="grid grid-cols-auto">
              \${n.map(o=>a\`
                <div class="achievement-card \${je[o.tier]||""}">
  ...
  \`}function et(e,t,r){return!e.current_streak||e.current_streak<=0?"":a\`
  ...
  \`}function rt(){return a\`
    <div class="card">
      <div class="grid grid-cols-auto">
        \${[1,2,3,4].map(()=>a\`<div class="skeleton skeleton-card"></div>\`)}
      </div>
    </div>
  \`}async function nt(){const e=document.getElementById("achievements");if(e){e.innerHTML=String(rt());try{const[t,r,n]=await Promise.all([g.get("/achievements"),g.get("/achievements/prs?limit=10"),g.get("/achievements/streak")]),o=t.earned||[],i=t.stats||{totalWorkouts:0,totalPRs:0},s=r.prs||[],l=n.streak||{},c=Math.floor((l.current_streak||0)/7),p=Math.floor((l.longest_streak||0)/7),u=Ze(o);e.innerHTML=String(a\`
      <div class="card">
        ...
        \${Ye({currentWeeks:c,longestWeeks:p,totalWorkouts:i.totalWorkouts||0,totalPRs:i.totalPRs||0,earnedCount:o.length})}
    ...
    \`)}catch(t){console.error("Error loading achievements:",t),e.innerHTML=String(tt(t.message))}}}function ot(e){return a\`
    <div class="grid grid-cols-auto">
      <div class="stat-card">
      ...
      <div class="stat-card">
        ...
        <div class="stat-value">\${O(e.total_time_seconds||0)}</div>
      </div>
      <div class="stat-card">
        <div class="stat-label">Avg Workout</div>
        <div class="stat-value">\${O(e.average_workout_time||0)}</div>
      </div>
    </div>
  ...
  \`}function at(e){const t=!!e.completed,r=t?"✓ Complete":"In Progress",n=t?"badge-success":"badge-warning",o=\$(e.start_time,{weekday:"short",month:"short",day:"numeric",year:"numeric"}),i=e.total_weight_kg?F(e.total_weight_kg):"N/A";return a\`
    <div class="workout-card" id="workout-card-\${e.id}">
        ...
        <div class="workout-card-header-main">
          ...
          <div class="workout-card-metrics">
            <span class="text-muted">
              <i class="fas fa-clock"></i> \${O(e.total_duration_seconds)}
            </span>
            <span class="text-muted">
      ...
      <div class="workout-card-details" id="workout-details-\${e.id}" hidden>
        <div class="grid grid-cols-auto" style="gap: var(--space-3);">
          \${H("Training Time",O(e.total_duration_seconds))}
          \${H("Exercises",e.exercise_count||0)}
          \${H("Total Sets",e.total_sets||0)}
          \${H("Total Volume",i)}
          \${H("Effort Level",e.perceived_exertion?\`\${e.perceived_exertion}/10 \${Ge(e.perceived_exertion)}\`:"Not rated")}
        </div>
  ...
  \`}function H(e,t){return a\`
    <div class="mini-stat">
      <div class="stat-label">\${e}</div>
      <div class="mini-stat-value">\${t}</div>
    </div>
  \`}function st(e){return!e||e.length===0?a\`
      <div class="empty-state">
        <div class="empty-state-icon">🏋️</div>
  ...
  \`}function ct(e){e.addEventListener("click",t=>{const r=t.target.closest("[data-legacy-call]");if(r){const l=r.getAttribute("data-legacy-call"),c=window[l];typeof c=="function"&&c();return}const n=t.target.closest("[data-tab]");if(n){const l=n.getAttribute("data-tab");typeof window.switchTab=="function"&&window.switchTab(l);return}const o=t.target.closest('[data-action="toggle-details"]');if(o){const l=o.getAttribute("data-workout-id"),c=document.getElementById(\`workout-details-\${l}\`),p=document.getElementById(\`workout-chevron-\${l}\`);c&&(c.hasAttribute("hidden")?(c.removeAttribute("hidden"),p==null||p.style.setProperty("transform","rotate(180deg)")):(c.setAttribute("hidden",""),p==null||p.style.removeProperty("transform")));return}const i=t.target.closest('[data-action="view-workout"]');if(i){t.stopPropagation();const l=parseInt(i.getAttribute("data-workout-id"),10);typeof window.viewWorkout=="function"&&window.viewWorkout(l);return}const s=t.target.closest('[data-action="delete-workout"]');if(s){t.stopPropagation();const l=parseInt(s.getAttribute("data-workout-id"),10);typeof window.deleteDashboardWorkout=="function"&&window.deleteDashboardWorkout(l);return}})}async function pt(){const e=document.getElementById("dashboard");if(e){e.innerHTML=String(lt());try{const[t,,r]=await Promise.all([g.get("/analytics/progress?days=30"),g.get("/programs"),g.get("/workouts?limit=5")]),n=t.overview||{},o=r.workouts||[];e.innerHTML=String(a\`
    ...
    \`),ct(e)}catch(t){console.error("Error loading dashboard:",t),e.innerHTML=String(dt(t.message))}}}function gt(e){const r=(e.measurement_system||"metric")==="imperial";let n="",o="";if(r&&e.height_cm){const s=Fe(e.height_cm);n=s.feet,o=s.inches}const i=r&&e.weight_kg?Math.round(ge(e.weight_kg)*10)/10:e.weight_kg||"";return a\`
  ...
  \`}function mt(e){const t=e.querySelector("#profile-system"),r=t==null?void 0:t.value,n=e.querySelector("#metric-inputs"),o=e.querySelector("#imperial-inputs");!n||!o||(r==="imperial"?(n.setAttribute("hidden",""),o.removeAttribute("hidden")):(o.setAttribute("hidden",""),n.removeAttribute("hidden")))}async function yt(e){try{const r=(await g.get("/reports/preferences")).preferences||{},n={weekly:"weeklyReport",monthly:"monthlyReport",yearly:"yearlyReport"};for(const[o,i]of Object.entries(n)){const s=e.querySelector(\`#profile-report-\${o}\`);s&&(s.checked=!!r[i])}}catch(t){console.error("Failed to load report preferences:",t)}}async function ut(e){var t,r,n;try{return await g.put("/reports/preferences",{weeklyReport:!!((t=e.querySelector("#profile-report-weekly"))!=null&&t.checked),monthlyReport:!!((r=e.querySelector("#profile-report-monthly"))!=null&&r.checked),yearlyReport:!!((n=e.querySelector("#profile-report-yearly"))!=null&&n.checked)}),!0}catch(o){return console.error("Failed to save report preferences:",o),!1}}function ht(e){m.info(\`Generating \${e} report preview…\`);const t=localStorage.getItem("token")||"",r=t?\`?token=\${encodeURIComponent(t)}\`:"";window.open(\`/api/reports/html/\${e}\${r}\`,"_blank")}async function bt(e,t){const r=e.querySelector("#profile-name").value.trim(),n=parseInt(e.querySelector("#profile-age").value,10)||null,o=e.querySelector("#profile-gender").value,i=e.querySelector("#profile-system").value;let s,l;if(i==="imperial"){const c=parseFloat(e.querySelector("#profile-height-feet").value)||0,p=parseFloat(e.querySelector("#profile-height-inches").value)||0,u=parseFloat(e.querySelector("#profile-weight-lbs").value)||0;s=c||p?Oe(c,p):null,l=u?Le(u):null}else s=parseFloat(e.querySelector("#profile-height-cm").value)||null,l=parseFloat(e.querySelector("#profile-weight-kg").value)||null;try{const c=await t.put("/auth/user",{name:r,age:n,gender:o,height_cm:s,weight_kg:l,measurement_system:i});_.set("user",c.user),await ut(e),m.success("Profile updated");const p=window.loadUser;typeof p=="function"&&p()}catch(c){throw m.error(\`Error saving profile: \${c.message}\`),c}}function vt(){const e=_.get("user")||{};return T({title:"User Profile",size:"default",content:String(gt(e)),actions:[{label:"Cancel",variant:"btn-outline"},{label:"Save Profile",primary:!0,variant:"btn-primary",onClick:async r=>{try{await bt(r.element,g),r.close("saved")}catch{}}}],onOpen:({element:r})=>{yt(r),r.addEventListener("change",n=>{n.target.matches("#profile-system")&&mt(r)}),r.addEventListener("click",n=>{const o=n.target.closest('[data-action="preview"]');o&&(n.preventDefault(),ht(o.getAttribute("data-period")))})}})}const ft=[{value:"Smith Machine",label:"Smith Machine",default:!0},{value:"Olympic Bar",label:"Olympic Bar",default:!0},{value:"Cable Trainer",label:"Cable Machine",default:!0},{value:"Leg Extension/Curl",label:"Leg Ext/Curl",default:!0},{value:"Pull-up Bar",label:"Pull-up Bar"},{value:"Landmine",label:"Landmine"},{value:"Dip Bars",label:"Dip Bars"},{value:"Rower",label:"Rower"},{value:"Treadmill",label:"Treadmill"},{value:"Stationary Bike",label:"Bike"}],xt={1:"cardio-zone-low",2:"cardio-zone-low",3:"cardio-zone-mid",4:"cardio-zone-high",5:"cardio-zone-high"};function I(){return ye()}function wt(e){const t=e.active?a\`<span class="badge badge-success">ACTIVE</span>\`:a\`<button class="btn btn-outline btn-sm" data-action="activate" data-program-id="\${e.id}">Activate</button>\`;return a\`
  ...
  \`}async function ye(){const e=document.getElementById("program");if(e){e.innerHTML=String(a\`
    <div class="stack stack-lg">
      <div class="card">
  ...
  \`);try{const r=(await g.get("/programs")).programs||[],n=r.find(o=>o.active);e.innerHTML=String(a\`
      <div class="stack stack-lg">
        ...
        <div class="card">
          ...
          \${r.length>0?a\`<div class="stack stack-sm">\${r.map(wt)}</div>\`:a\`
                <div class="empty-state">
                  <div class="empty-state-icon">📋</div>
    ...
    \`),kt(e)}catch(t){console.error("Error loading programs:",t),e.innerHTML=String(a\`
      <div class="card">
        <div class="empty-state">
          <div class="empty-state-icon">⚠️</div>
    ...
    \`)}}}function kt(e){e.addEventListener("click",t=>{const r=t.target.closest("[data-action]");if(!r)return;const n=r.getAttribute("data-action"),o=parseInt(r.getAttribute("data-program-id"),10);switch(n){case"view":t.stopPropagation(),j(o);break;case"activate":t.stopPropagation(),Z(o);break;case"generate":he();break;case"create-manual":be();break}})}function St(e){return a\`
  ...
  \`}function Tt(e){const t=e.cardio_sessions||[];return a\`
    <strong class="cardio-day-title">
      <i class="fas fa-fire"></i> Cardio Sessions
    </strong>
    <div class="stack stack-sm">
      \${t.map(r=>a\`
        <div class="cardio-session \${xt[r.heart_rate_zone]||"cardio-zone-mid"}">
  ...
  \`}function zt(e){return a\`
    <div class="program-day-card">
      ...
      \${e.is_cardio_day?Tt(e):St(e)}
    </div>
  \`}async function j(e){try{const r=(await g.get(\`/programs/\${e}\`)).program,n=r.created_at?\$(r.created_at,{year:"numeric",month:"short",day:"numeric"}):"Unknown";return T({title:"Program Details",size:"wide",content:String(a\`
      ...
      \`),actions:[{label:"Start Workout",primary:!0,variant:"btn-primary",onClick:i=>{i.close(),Bt(e)}},...r.active?[]:[{label:"Set as Active",variant:"btn-secondary",onClick:async i=>{await Z(e,{silent:!1}),i.close()}}],{label:"Delete",variant:"btn-danger",onClick:async i=>{if(await K("Delete this program? This cannot be undone.",{title:"Delete program?",confirmLabel:"Delete",confirmVariant:"btn-danger"}))try{await g.delete(\`/programs/\${e}\`),m.success("Program deleted"),i.close(),I()}catch(l){m.error(\`Error deleting program: \${l.message}\`)}}}],onOpen:({element:i})=>{var s;(s=i.querySelector('[data-action="rename"]'))==null||s.addEventListener("click",()=>{ue(e,r.name)})}})}catch(t){m.error(\`Error loading program: \${t.message}\`)}}function ue(e,t){T({title:"Rename Program",size:"default",content:String(a\`
      <div class="form-group">
        <label class="form-label" for="rename-input">Program name</label>
        <input type="text" id="rename-input" class="input" value="\${t}" />
      </div>
    \`),actions:[{label:"Cancel",variant:"btn-outline"},{label:"Save Name",primary:!0,onClick:async r=>{const n=r.element.querySelector("#rename-input").value.trim();if(!n){m.warning("Please enter a program name");return}try{await g.patch(\`/programs/\${e}\`,{name:n}),m.success("Program renamed"),r.close(),I(),j(e)}catch(o){m.error(\`Failed to rename: \${o.message}\`)}}}],onOpen:({element:r})=>{const n=r.querySelector("#rename-input");n==null||n.focus(),n==null||n.select()}})}async function Z(e,t={}){try{await g.post(\`/programs/\${e}/activate\`),t.silent||m.success("Program activated"),I()}catch(r){m.error(\`Error activating program: \${r.message}\`)}}async function Mt(e){if(await K("Are you sure you want to delete this program?",{title:"Delete program?",confirmLabel:"Delete",confirmVariant:"btn-danger"}))try{await g.delete(\`/programs/\${e}\`),m.success("Program deleted"),I()}catch(r){m.error(\`Error deleting program: \${r.message}\`)}}function he(){T({title:"Generate AI Program",size:"default",content:String(a\`
      <div class="stack stack-md">
        <div class="form-group">
  ...
  \`);const l=t.querySelector(".modal-footer");l&&(l.style.display="none");try{await g.post("/programs/generate",{days_per_week:r,goal:n,custom_instructions:o,available_equipment:i}),s.innerHTML=String(a\`
    ...
    \`),setTimeout(()=>{e.close(),I()},1500)}catch(c){s.innerHTML=String(a\`
      <div class="generate-progress">
    ...
    \`),actions:[...d.currentDayIndex>0?[{label:"← Previous Day",variant:"btn-outline",onClick:()=>{U(),d.currentDayIndex--,W()}}]:[],{label:"Cancel",variant:"btn-ghost"},{label:r?"Finish & Save":"Next Day →",primary:!0,onClick:async()=>{if(U(),e.exercises.length===0){m.warning("Please select at least one exercise for this day");return}r?await At():(d.currentDayIndex++,W())}}],onOpen:({element:n})=>\$t(n)})}function U(){var o;const e=(o=d.modalApi)==null?void 0:o.element;if(!e)return;const t=d.days[d.currentDayIndex],r=e.querySelector("#builder-day-name"),n=e.querySelector("#builder-day-focus");r&&(t.name=r.value.trim()||\`Day \${t.day_number}\`),n&&(t.focus=n.value.trim())}function Et(e){const t={};for(const r of e){const n=r.muscle_group||"Other";t[n]||(t[n]=[]),t[n].push(r)}return t}function Pt(e,t){const r=t.exercises.find(n=>n.exercise_id===e.id);return a\`
  ...
  \`}function \$t(e){e.addEventListener("change",t=>{const r=t.target.closest("[data-builder-toggle]");if(r){const o=parseInt(r.getAttribute("data-builder-toggle"),10);_t(o);return}const n=t.target.closest("[data-builder-config]");if(n){const[o,i]=n.getAttribute("data-builder-config").split(":");It(parseInt(o,10),i,t.target.value)}})}function _t(e){U();const t=d.days[d.currentDayIndex],r=t.exercises.findIndex(n=>n.exercise_id===e);if(r>=0)t.exercises.splice(r,1);else{const n=d.availableExercises.find(o=>o.id===e);t.exercises.push({exercise_id:e,name:(n==null?void 0:n.name)||"",sets:3,reps:"8-12",rest_seconds:90})}W()}function It(e,t,r){const o=d.days[d.currentDayIndex].exercises.find(i=>i.exercise_id===e);o&&(t==="reps"?o.reps=r:o[t]=parseInt(r,10)||0)}async function At(){var e;try{await g.post("/programs/manual",{name:d.name,days_per_week:d.days_per_week,goal:d.goal,days:d.days}),m.success("Custom program created!"),(e=d.modalApi)==null||e.close(),d.modalApi=null,I()}catch(t){m.error(\`Error creating program: \${t.message}\`)}}async function Bt(e){const t=window.__legacyStartWorkoutFromProgram;if(typeof t=="function")return t(e);typeof window.switchTab=="function"&&window.switchTab("workout")}window.__fitnessApp={store:_,api:g,toast:m,openModal:T,confirmDialog:K};f("learn","loadLearn",He);f("achievements","loadAchievements",nt);f("dashboard","loadDashboard",pt);f("profile","showProfile",vt);f("program","loadPrograms",ye);f("programs:view","viewProgram",j);f("programs:activate","activateProgram",Z);f("programs:delete","deleteProgram",Mt);f("programs:generate","showGenerateProgram",he);f("programs:manual","showCreateManualProgram",be);f("programs:rename","showRenameProgramModal",ue);_e();
//# sourceMappingURL=index-D8IBHN35.js.map
