...
(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))t(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&t(a)}).observe(document,{childList:!0,subtree:!0});function n(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function t(o){if(o.ep)return;o.ep=!0;const i=n(o);fetch(o.href,i)}})();const L=Symbol("raw"),Y=Symbol("trusted");class E{constructor(r){this[Y]=!0,this.value=String(r)}toString(){return this.value}}function F(e){return e==null||e===!1?new E(""):new E(e)}function Q(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function X(e){return String(e).replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;")}function W(e){return e==null||e===!1?"":e===!0?"true":e instanceof E?e.value:e&&typeof e=="object"&&L in e?e[L]:Array.isArray(e)?e.map(W).join(""):Q(e)}function w(e,...r){let n=e[0];for(let t=0;t<r.length;t++)n+=W(r[t])+e[t+1];return new E(n)}function N(e){const r=e instanceof E?e.value:String(e).trim(),n=document.createElement("template");return n.innerHTML=r,n.content.firstElementChild}const K="fitness-coach:state",U={user:null,currentWorkout:null,currentProgram:null,currentTab:"dashboard",ui:{theme:"system",activeModal:null,lastVisitedTab:null},workout:{activeExerciseIndex:0,restTimerEndTime:null,workoutStartTime:null,exerciseHistory:{},modifications:{added:[],deleted:[]},pendingNotes:""},mealTracking:{searchResults:[],selectedFoods:[],currentMealType:null,scannerActive:!1},pastWorkout:{date:null,programId:null,programDayId:null,exercises:[]},analytics:{lastFetch:null,data:null},aiCoach:{conversationHistory:[],lastInsight:null}},G=["ui"];function H(e,r){return r?r.split(".").reduce((n,t)=>n==null?n:n[t],e):e}function \$(e,r,n){if(!r)return n;const t=r.split("."),o=t.pop(),i=t.reduce((a,s)=>((a[s]==null||typeof a[s]!="object")&&(a[s]={}),a[s]),e);return i[o]=n,e}function O(e){return e==null||typeof e!="object"?e:JSON.parse(JSON.stringify(e))}function ee(){try{const e=localStorage.getItem(K);return e?JSON.parse(e):{}}catch{return{}}}function re(e){try{const r={};for(const n of G){const t=H(e,n);t!==void 0&&\$(r,n,t)}localStorage.setItem(K,JSON.stringify(r))}catch{}}class ne{constructor(r){this.data=O(r),this.subscribers=new Map;const n=ee();for(const[t,o]of Object.entries(n))this.data[t]={...this.data[t],...o}}get(r){return H(this.data,r)}set(r,n){const t=this.get(r);if(t===n)return;\$(this.data,r,n),G.some(i=>r===i||r.startsWith(\`\${i}.\`))&&re(this.data),this.notify(r,n,t);const o=r.split(".");for(let i=o.length-1;i>0;i--){const a=o.slice(0,i).join(".");this.notify(a,this.get(a),null)}}merge(r,n){const t=this.get(r)||{};this.set(r,{...t,...n})}reset(r){const n=H(U,r);this.set(r,O(n))}subscribe(r,n){this.subscribers.has(r)||this.subscribers.set(r,new Set);const t=this.subscribers.get(r);return t.add(n),()=>t.delete(n)}notify(r,n,t){const o=this.subscribers.get(r);if(o)for(const i of o)try{i(n,t)}catch(a){console.error(\`Subscriber error for "\${r}":\`,a)}}}const B=new ne(U);typeof window<"u"&&(window.__store=B);const j="/api",te=3e4,oe=6e4,P=new Map;class A extends Error{constructor(r,{status:n=0,code:t=null,details:o=null}={}){super(r),this.name="ApiError",this.status=n,this.code=t,this.details=o}}async function S(e,r={}){var R;const{method:n="GET",body:t,headers:o={},cache:i=!1,timeout:a=te,signal:s}=r,x=\`\${j}\${e}\`,m=\`\${n} \${x}\`;if(n==="GET"&&i){const y=P.get(m);if(y&&Date.now()-y.at<oe)return y.data}const u=new AbortController,d=setTimeout(()=>u.abort(),a);s&&s.addEventListener("abort",()=>u.abort(),{once:!0});const h={method:n,headers:{"Content-Type":"application/json",...o},signal:u.signal};t!=null&&(t instanceof FormData?(delete h.headers["Content-Type"],h.body=t):typeof t=="string"?h.body=t:h.body=JSON.stringify(t));let c;try{c=await fetch(x,h)}catch(y){throw clearTimeout(d),y.name==="AbortError"?new A("Request timed out",{code:"TIMEOUT"}):new A("Network error",{code:"NETWORK",details:y.message})}clearTimeout(d);const b=(R=c.headers.get("content-type"))==null?void 0:R.includes("application/json"),p=b?await c.json().catch(()=>({})):await c.text();if(!c.ok){const y=b&&(p==null?void 0:p.error)||\`Request failed (\${c.status})\`;throw new A(y,{status:c.status,code:p==null?void 0:p.code,details:p==null?void 0:p.details})}return n==="GET"&&i&&P.set(m,{data:p,at:Date.now()}),p}function ie(e=""){const r=\`GET \${j}\${e}\`;for(const n of P.keys())n.startsWith(r)&&P.delete(n)}const ae={get:(e,r)=>S(e,{...r,method:"GET"}),post:(e,r,n)=>S(e,{...n,method:"POST",body:r}),put:(e,r,n)=>S(e,{...n,method:"PUT",body:r}),patch:(e,r,n)=>S(e,{...n,method:"PATCH",body:r}),delete:(e,r)=>S(e,{...r,method:"DELETE"}),request:S,invalidateCache:ie},D={success:"fa-check-circle",error:"fa-exclamation-circle",warning:"fa-exclamation-triangle",info:"fa-info-circle"},se=3e3;let g=null;function le(){return g&&document.body.contains(g)||(g=document.getElementById("toast-container"),g||(g=document.createElement("div"),g.id="toast-container",g.setAttribute("aria-live","polite"),g.setAttribute("aria-atomic","true"),document.body.appendChild(g))),g}function M(e,r={}){var u;const{type:n="info",duration:t=se,icon:o,action:i}=r,a=o?\`fa-\${o}\`:D[n]||D.info,s=N(w\`
    <div class="toast toast-\${X(n)}" role="alert">
      <i class="fas \${a} toast-icon" aria-hidden="true"></i>
      <div class="toast-message">\${e}</div>
      \${i?w\`<button class="btn btn-sm btn-ghost toast-action">\${i.label}</button>\`:""}
    </div>
  \`);le().appendChild(s),i!=null&&i.onClick&&((u=s.querySelector(".toast-action"))==null||u.addEventListener("click",()=>{i.onClick(),m()}));let x=!1;const m=()=>{x||(x=!0,s.style.animation="slide-out-right var(--transition-base) forwards",s.addEventListener("animationend",()=>s.remove(),{once:!0}))};return t>0&&setTimeout(m,t),m}const de={show:(e,r)=>M(e,r),success:(e,r)=>M(e,{...r,type:"success"}),error:(e,r)=>M(e,{...r,type:"error",duration:(r==null?void 0:r.duration)??5e3}),warning:(e,r)=>M(e,{...r,type:"warning"}),info:(e,r)=>M(e,{...r,type:"info"})},T=[];function pe(){let e=document.getElementById("modal-root");return e||(e=document.createElement("div"),e.id="modal-root",document.body.appendChild(e)),e}function ge(e){const r=e.querySelectorAll('a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])');if(r.length===0)return null;const n=r[0],t=r[r.length-1],o=i=>{i.key==="Tab"&&(i.shiftKey&&document.activeElement===n?(i.preventDefault(),t.focus()):!i.shiftKey&&document.activeElement===t&&(i.preventDefault(),n.focus()))};return e.addEventListener("keydown",o),n.focus(),()=>e.removeEventListener("keydown",o)}function J(e){var q;const{title:r,content:n,actions:t=[],size:o="default",dismissable:i=!0,onOpen:a,onClose:s}=e,x=o==="wide"?"modal-wide":o==="fullscreen"?"modal-fullscreen":"",m=t.length?w\`
        <div class="modal-footer">
          \${t.map((l,f)=>w\`
            <button
              class="btn \${l.variant||(l.primary?"btn-primary":"btn-outline")}"
              data-modal-action="\${f}"
            >\${l.label}</button>
          \`)}
        </div>
    ...
    <div class="modal-backdrop" role="dialog" aria-modal="true">
      <div class="modal \${x}" role="document">
        \${F(u)}
        <div class="modal-body"></div>
        \${F(m)}
      </div>
    </div>
  \`),h=d.querySelector(".modal"),c=d.querySelector(".modal-body");n instanceof Node?c.appendChild(n):n!=null&&(c.innerHTML=String(n));const b=document.activeElement;let p=!1,R;const y=new Promise(l=>R=l),k=l=>{if(p)return;p=!0;const f=T.indexOf(v);f>=0&&T.splice(f,1),I==null||I(),d.style.animation="fade-out var(--transition-fast) forwards",h.style.animation="slide-up var(--transition-fast) reverse forwards",d.addEventListener("animationend",()=>{var z;d.remove(),(z=b==null?void 0:b.focus)==null||z.call(b)},{once:!0}),T.length===0&&(document.body.style.overflow=""),s==null||s(l),R(l)},v={element:h,backdrop:d,close:k,promise:y};d.querySelectorAll("[data-modal-action]").forEach(l=>{const f=parseInt(l.getAttribute("data-modal-action"),10),z=t[f];l.addEventListener("click",async()=>{z.onClick?await z.onClick(v):k(z.value??f)})}),(q=d.querySelector("[data-modal-close]"))==null||q.addEventListener("click",()=>k()),i&&d.addEventListener("click",l=>{l.target===d&&k()});const _=l=>{l.key==="Escape"&&i&&T[T.length-1]===v&&k()};document.addEventListener("keydown",_);const Z=k;v.close=l=>{document.removeEventListener("keydown",_),Z(l)},pe().appendChild(d),document.body.style.overflow="hidden",T.push(v);const I=ge(h);return a==null||a(v),v}function ce(e,r={}){const{title:n="Are you sure?",confirmLabel:t="Confirm",cancelLabel:o="Cancel",confirmVariant:i="btn-primary"}=r;return new Promise(a=>{J({title:n,content:w\`<p>\${e}</p>\`,actions:[{label:o,variant:"btn-outline",onClick:s=>s.close(!1)},{label:t,variant:i,primary:!0,onClick:s=>s.close(!0)}],onClose:s=>a(s===!0)})})}const C=new Map;function ye(e,r,n){C.set(e,{legacyGlobal:r,handler:n})}function V(){for(const[r,{legacyGlobal:n,handler:t}]of C){const o=window[n];window[n]=function(...a){try{return t(...a)}catch(s){if(console.error(\`[bridge] "\${n}" handler failed, falling back to legacy:\`,s),typeof o=="function")return o.apply(this,a);throw s}},window[n].__legacy=o,window[n].__modular=!0}const e=window.switchTab;typeof e=="function"&&!e.__bridged&&(window.switchTab=function(n,...t){return B.set("currentTab",n),e.call(this,n,...t)},window.switchTab.__bridged=!0,window.switchTab.__legacy=e),console.info(\`[bridge] Installed \${C.size} modular screen handler(s):\`,Array.from(C.keys()).join(", "))}function he(){document.readyState==="loading"?document.addEventListener("DOMContentLoaded",V,{once:!0}):V()}const me=\`    <div class="card">
...
\`,ue={hypertrophy:"#hypertrophy-section",strength:"#strength-section",endurance:"#endurance-section",cardio:"#cardio-section",comparison:"#comparison-section",variables:"#variables-section"};function be(e){e.innerHTML=me,e.addEventListener("click",r=>{var i;const n=r.target.closest("[data-learn-scroll]");if(!n)return;r.preventDefault();const t=n.getAttribute("data-learn-scroll"),o=ue[t];o&&((i=e.querySelector(o))==null||i.scrollIntoView({behavior:"smooth",block:"start"}))})}function xe(){const e=document.getElementById("learn");e&&be(e)}window.__fitnessApp={store:B,api:ae,toast:de,openModal:J,confirmDialog:ce};ye("learn","loadLearn",xe);he();
//# sourceMappingURL=index-BGO3M_oJ.js.map
