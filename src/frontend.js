...
(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const s of i.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&n(s)}).observe(document,{childList:!0,subtree:!0});function r(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(o){if(o.ep)return;o.ep=!0;const i=r(o);fetch(o.href,i)}})();const X=Symbol("raw"),Se=Symbol("trusted");class D{constructor(t){this[Se]=!0,this.value=String(t)}toString(){return this.value}}function ee(e){return e==null||e===!1?new D(""):new D(e)}function Te(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ze(e){return String(e).replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;")}function ae(e){return e==null||e===!1?"":e===!0?"true":e instanceof D?e.value:e&&typeof e=="object"&&X in e?e[X]:Array.isArray(e)?e.map(ae).join(""):Te(e)}function a(e,...t){let r=e[0];for(let n=0;n<t.length;n++)r+=ae(t[n])+e[n+1];return new D(r)}function se(e){const t=e instanceof D?e.value:String(e).trim(),r=document.createElement("template");return r.innerHTML=t,r.content.firstElementChild}const le="fitness-coach:state",de={user:null,currentWorkout:null,currentProgram:null,currentTab:"dashboard",ui:{theme:"system",activeModal:null,lastVisitedTab:null},workout:{activeExerciseIndex:0,restTimerEndTime:null,workoutStartTime:null,exerciseHistory:{},modifications:{added:[],deleted:[]},pendingNotes:""},mealTracking:{searchResults:[],selectedFoods:[],currentMealType:null,scannerActive:!1},pastWorkout:{date:null,programId:null,programDayId:null,exercises:[]},analytics:{lastFetch:null,data:null},aiCoach:{conversationHistory:[],lastInsight:null}},ce=["ui"];function K(e,t){return t?t.split(".").reduce((r,n)=>r==null?r:r[n],e):e}function pe(e,t,r){if(!t)return r;const n=t.split("."),o=n.pop(),i=n.reduce((s,l)=>((s[l]==null||typeof s[l]!="object")&&(s[l]={}),s[l]),e);return i[o]=r,e}function te(e){return e==null||typeof e!="object"?e:JSON.parse(JSON.stringify(e))}function \$e(){try{const e=localStorage.getItem(le);return e?JSON.parse(e):{}}catch{return{}}}function Me(e){try{const t={};for(const r of ce){const n=K(e,r);n!==void 0&&pe(t,r,n)}localStorage.setItem(le,JSON.stringify(t))}catch{}}class _e{constructor(t){this.data=te(t),this.subscribers=new Map;const r=\$e();for(const[n,o]of Object.entries(r))this.data[n]={...this.data[n],...o}}get(t){return K(this.data,t)}set(t,r){const n=this.get(t);if(n===r)return;pe(this.data,t,r),ce.some(i=>t===i||t.startsWith(\`\${i}.\`))&&Me(this.data),this.notify(t,r,n);const o=t.split(".");for(let i=o.length-1;i>0;i--){const s=o.slice(0,i).join(".");this.notify(s,this.get(s),null)}}merge(t,r){const n=this.get(t)||{};this.set(t,{...n,...r})}reset(t){const r=K(de,t);this.set(t,te(r))}subscribe(t,r){this.subscribers.has(t)||this.subscribers.set(t,new Set);const n=this.subscribers.get(t);return n.add(r),()=>n.delete(r)}notify(t,r,n){const o=this.subscribers.get(t);if(o)for(const i of o)try{i(r,n)}catch(s){console.error(\`Subscriber error for "\${t}":\`,s)}}}const A=new _e(de);typeof window<"u"&&(window.__store=A);const ge="/api",Re=3e4,Ce=6e4,W=new Map;class G extends Error{constructor(t,{status:r=0,code:n=null,details:o=null}={}){super(t),this.name="ApiError",this.status=r,this.code=n,this.details=o}}async function P(e,t={}){var L;const{method:r="GET",body:n,headers:o={},cache:i=!1,timeout:s=Re,signal:l}=t,c=\`\${ge}\${e}\`,p=\`\${r} \${c}\`;if(r==="GET"&&i){const S=W.get(p);if(S&&Date.now()-S.at<Ce)return S.data}const h=new AbortController,u=setTimeout(()=>h.abort(),s);l&&l.addEventListener("abort",()=>h.abort(),{once:!0});const f={method:r,headers:{"Content-Type":"application/json",...o},signal:h.signal};n!=null&&(n instanceof FormData?(delete f.headers["Content-Type"],f.body=n):typeof n=="string"?f.body=n:f.body=JSON.stringify(n));let k;try{k=await fetch(c,f)}catch(S){throw clearTimeout(u),S.name==="AbortError"?new G("Request timed out",{code:"TIMEOUT"}):new G("Network error",{code:"NETWORK",details:S.message})}clearTimeout(u);const T=(L=k.headers.get("content-type"))==null?void 0:L.includes("application/json"),v=T?await k.json().catch(()=>({})):await k.text();if(!k.ok){const S=T&&(v==null?void 0:v.error)||\`Request failed (\${k.status})\`;throw new G(S,{status:k.status,code:v==null?void 0:v.code,details:v==null?void 0:v.details})}return r==="GET"&&i&&W.set(p,{data:v,at:Date.now()}),v}function Ee(e=""){const t=\`GET \${ge}\${e}\`;for(const r of W.keys())r.startsWith(t)&&W.delete(r)}const g={get:(e,t)=>P(e,{...t,method:"GET"}),post:(e,t,r)=>P(e,{...r,method:"POST",body:t}),put:(e,t,r)=>P(e,{...r,method:"PUT",body:t}),patch:(e,t,r)=>P(e,{...r,method:"PATCH",body:t}),delete:(e,t)=>P(e,{...t,method:"DELETE"}),request:P,invalidateCache:Ee},re={success:"fa-check-circle",error:"fa-exclamation-circle",warning:"fa-exclamation-triangle",info:"fa-info-circle"},Pe=3e3;let x=null;function Ie(){return x&&document.body.contains(x)||(x=document.getElementById("toast-container"),x||(x=document.createElement("div"),x.id="toast-container",x.setAttribute("aria-live","polite"),x.setAttribute("aria-atomic","true"),document.body.appendChild(x))),x}function H(e,t={}){var h;const{type:r="info",duration:n=Pe,icon:o,action:i}=t,s=o?\`fa-\${o}\`:re[r]||re.info,l=se(a\`
    <div class="toast toast-\${ze(r)}" role="alert">
      <i class="fas \${s} toast-icon" aria-hidden="true"></i>
      <div class="toast-message">\${e}</div>
      \${i?a\`<button class="btn btn-sm btn-ghost toast-action">\${i.label}</button>\`:""}
    </div>
  \`);Ie().appendChild(l),i!=null&&i.onClick&&((h=l.querySelector(".toast-action"))==null||h.addEventListener("click",()=>{i.onClick(),p()}));let c=!1;const p=()=>{c||(c=!0,l.style.animation="slide-out-right var(--transition-base) forwards",l.addEventListener("animationend",()=>l.remove(),{once:!0}))};return n>0&&setTimeout(p,n),p}const m={show:(e,t)=>H(e,t),success:(e,t)=>H(e,{...t,type:"success"}),error:(e,t)=>H(e,{...t,type:"error",duration:(t==null?void 0:t.duration)??5e3}),warning:(e,t)=>H(e,{...t,type:"warning"}),info:(e,t)=>H(e,{...t,type:"info"})},I=[];function Ae(){let e=document.getElementById("modal-root");return e||(e=document.createElement("div"),e.id="modal-root",document.body.appendChild(e)),e}function Be(e){const t=e.querySelectorAll('a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])');if(t.length===0)return null;const r=t[0],n=t[t.length-1],o=i=>{i.key==="Tab"&&(i.shiftKey&&document.activeElement===r?(i.preventDefault(),n.focus()):!i.shiftKey&&document.activeElement===n&&(i.preventDefault(),r.focus()))};return e.addEventListener("keydown",o),r.focus(),()=>e.removeEventListener("keydown",o)}function M(e){var Q;const{title:t,content:r,actions:n=[],size:o="default",dismissable:i=!0,onOpen:s,onClose:l}=e,c=o==="wide"?"modal-wide":o==="fullscreen"?"modal-fullscreen":"",p=n.length?a\`
        <div class="modal-footer">
          \${n.map((y,R)=>a\`
            <button
              class="btn \${y.variant||(y.primary?"btn-primary":"btn-outline")}"
              data-modal-action="\${R}"
            >\${y.label}</button>
          \`)}
        </div>
  ...
  \`),f=u.querySelector(".modal"),k=u.querySelector(".modal-body");r instanceof Node?k.appendChild(r):r!=null&&(k.innerHTML=String(r));const T=document.activeElement;let v=!1,L;const S=new Promise(y=>L=y),C=y=>{if(v)return;v=!0;const R=I.indexOf(_);R>=0&&I.splice(R,1),V==null||V(),u.style.animation="fade-out var(--transition-fast) forwards",f.style.animation="slide-up var(--transition-fast) reverse forwards",u.addEventListener("animationend",()=>{var E;u.remove(),(E=T==null?void 0:T.focus)==null||E.call(T)},{once:!0}),I.length===0&&(document.body.style.overflow=""),l==null||l(y),L(y)},_={element:f,backdrop:u,close:C,promise:S};u.querySelectorAll("[data-modal-action]").forEach(y=>{const R=parseInt(y.getAttribute("data-modal-action"),10),E=n[R];y.addEventListener("click",async()=>{E.onClick?await E.onClick(_):C(E.value??R)})}),(Q=u.querySelector("[data-modal-close]"))==null||Q.addEventListener("click",()=>C()),i&&u.addEventListener("click",y=>{y.target===u&&C()});const Y=y=>{y.key==="Escape"&&i&&I[I.length-1]===_&&C()};document.addEventListener("keydown",Y);const ke=C;_.close=y=>{document.removeEventListener("keydown",Y),ke(y)},Ae().appendChild(u),document.body.style.overflow="hidden",I.push(_);const V=Be(f);return s==null||s(_),_}function N(e,t={}){const{title:r="Are you sure?",confirmLabel:n="Confirm",cancelLabel:o="Cancel",confirmVariant:i="btn-primary"}=t;return new Promise(s=>{M({title:r,content:a\`<p>\${e}</p>\`,actions:[{label:o,variant:"btn-outline",onClick:l=>l.close(!1)},{label:n,variant:i,primary:!0,onClick:l=>l.close(!0)}],onClose:l=>s(l===!0)})})}const F=new Map;function b(e,t,r){F.set(e,{legacyGlobal:t,handler:r})}function ne(){for(const[t,{legacyGlobal:r,handler:n}]of F){const o=window[r];window[r]=function(...s){try{return n(...s)}catch(l){if(console.error(\`[bridge] "\${r}" handler failed, falling back to legacy:\`,l),typeof o=="function")return o.apply(this,s);throw l}},window[r].__legacy=o,window[r].__modular=!0}const e=window.switchTab;typeof e=="function"&&!e.__bridged&&(window.switchTab=function(r,...n){return A.set("currentTab",r),e.call(this,r,...n)},window.switchTab.__bridged=!0,window.switchTab.__legacy=e),console.info(\`[bridge] Installed \${F.size} modular screen handler(s):\`,Array.from(F.keys()).join(", "))}function Le(){document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ne,{once:!0}):ne()}const He=\`    <div class="card">
...
\`,qe={hypertrophy:"#hypertrophy-section",strength:"#strength-section",endurance:"#endurance-section",cardio:"#cardio-section",comparison:"#comparison-section",variables:"#variables-section"};function De(e){e.innerHTML=He,e.addEventListener("click",t=>{var i;const r=t.target.closest("[data-learn-scroll]");if(!r)return;t.preventDefault();const n=r.getAttribute("data-learn-scroll"),o=qe[n];o&&((i=e.querySelector(o))==null||i.scrollIntoView({behavior:"smooth",block:"start"}))})}function Fe(){const e=document.getElementById("learn");e&&De(e)}const me=2.20462,ue=1/2.54;function ye(e){return e==null?0:Math.round(e*me*10)/10}function We(e){return e==null?0:Math.round(e/me*100)/100}function Oe(e){return e*ue}function Ne(e){return e/ue}function Ve(e){const t=Math.round(Oe(e)),r=Math.floor(t/12),n=t-r*12;return{feet:r,inches:n}}function Ge(e,t){return Ne((e||0)*12+(t||0))}function Ue(){const e=A.get("user");return e&&e.measurement_system||"metric"}function he(){return Ue()==="imperial"}function Ke(){return he()?"lbs":"kg"}function je(e){return e==null?0:he()?ye(e):e}function w(e,t={}){const{unit:r=!0,precision:n=1}=t;if(e==null)return"N/A";const o=je(e),i=Ke();let s;return Math.abs(o)>=1e3?s=Math.round(o).toLocaleString():o%1===0?s=String(o):s=o.toFixed(n),r?\`\${s} \${i}\`:s}function z(e){if(e==null||e<0)return"00:00";const t=Math.abs(Math.floor(e)),r=Math.floor(t/3600),n=Math.floor(t%3600/60),o=t%60,i=s=>String(s).padStart(2,"0");return r>0?\`\${i(r)}:\${i(n)}:\${i(o)}\`:\`\${i(n)}:\${i(o)}\`}function \$(e,t={month:"short",day:"numeric",year:"numeric"}){if(!e)return"";const[r,n,o]=String(e).split("T")[0].split("-").map(Number);return!r||!n||!o?e:new Date(r,n-1,o).toLocaleDateString("en-US",t)}function Ze(e){if(e==null||Number.isNaN(e))return"—";const t=Math.round(e*10)/10;return t===0?"0%":\`\${t>0?"↑":"↓"} \${Math.abs(t)}%\`}function Je(e){return e==null?"":e<=2?"😴":e<=4?"🙂":e<=6?"💪":e<=8?"🔥":"🥵"}const Ye={consistency:"🔥",strength:"💪",volume:"📊",milestone:"⭐"},Qe={consistency:"Consistency",strength:"Strength",volume:"Volume",milestone:"Milestones"},Xe={bronze:"tier-bronze",silver:"tier-silver",gold:"tier-gold",platinum:"tier-platinum"};function et(e){const t={};for(const r of e){const n=r.category||"other";t[n]||(t[n]=[]),t[n].push(r)}return t}function tt(e,t){return!t||t===0?{text:"First PR!",isFirst:!0}:{text:\`+\${((e-t)/t*100).toFixed(1)}%\`,isFirst:!1}}function rt({currentWeeks:e,longestWeeks:t,totalWorkouts:r,totalPRs:n,earnedCount:o}){return a\`
  ...
  \`}function nt(e){return!e||e.length===0?a\`
    ...
    <div class="table-container">
      <table class="data-table">
        ...
        <tbody>
          \${e.map(t=>{const{text:r,isFirst:n}=tt(t.record_value,t.previous_value);return a\`
              <tr>
  ...
  \`}function ot(e){const t=Object.keys(e);return t.length===0?a\`
      <div class="empty-state">
    ...
    <div class="stack stack-lg">
      \${t.map(r=>{const n=e[r];return a\`
          <div>
            ...
            <div class="grid grid-cols-auto">
              \${n.map(o=>a\`
                <div class="achievement-card \${Xe[o.tier]||""}">
                  ...
                  <div class="achievement-date">
                    <i class="fas fa-calendar"></i> \${\$(o.earned_at)}
                  </div>
                </div>
              \`)}
            </div>
  ...
  \`}function it(e,t,r){return!e.current_streak||e.current_streak<=0?"":a\`
    <div class="streak-card">
      ...
      \${e.last_workout_date?a\`<div class="text-muted" style="font-size: var(--text-sm);">
            Last workout: \${\$(e.last_workout_date)}
          </div>\`:""}
    </div>
  \`}function at(e){return a\`
    <div class="card">
      <div class="empty-state">
        <div class="empty-state-icon">⚠️</div>
  ...
  \`}function st(){return a\`
    <div class="card">
      <div class="grid grid-cols-auto">
        \${[1,2,3,4].map(()=>a\`<div class="skeleton skeleton-card"></div>\`)}
      </div>
    </div>
  \`}async function lt(){const e=document.getElementById("achievements");if(e){e.innerHTML=String(st());try{const[t,r,n]=await Promise.all([g.get("/achievements"),g.get("/achievements/prs?limit=10"),g.get("/achievements/streak")]),o=t.earned||[],i=t.stats||{totalWorkouts:0,totalPRs:0},s=r.prs||[],l=n.streak||{},c=Math.floor((l.current_streak||0)/7),p=Math.floor((l.longest_streak||0)/7),h=et(o);e.innerHTML=String(a\`
      <div class="card">
        ...
        \${rt({currentWeeks:c,longestWeeks:p,totalWorkouts:i.totalWorkouts||0,totalPRs:i.totalPRs||0,earnedCount:o.length})}
    ...
    \`)}catch(t){console.error("Error loading achievements:",t),e.innerHTML=String(at(t.message))}}}function dt(e){return a\`
    <div class="grid grid-cols-auto">
      <div class="stat-card">
      ...
      <div class="stat-card">
        ...
        <div class="stat-value">\${z(e.total_time_seconds||0)}</div>
      </div>
      <div class="stat-card">
        <div class="stat-label">Avg Workout</div>
        <div class="stat-value">\${z(e.average_workout_time||0)}</div>
      </div>
    </div>
  \`}function ct(){return a\`
    <div class="cluster">
  ...
  \`}function pt(e){const t=!!e.completed,r=t?"✓ Complete":"In Progress",n=t?"badge-success":"badge-warning",o=\$(e.start_time,{weekday:"short",month:"short",day:"numeric",year:"numeric"}),i=e.total_weight_kg?w(e.total_weight_kg):"N/A";return a\`
    <div class="workout-card" id="workout-card-\${e.id}">
        ...
        <div class="workout-card-header-main">
          <div class="workout-card-status">
            ...
            <div>
              ...
              <div class="text-muted" style="font-size: var(--text-xs);">\${o}</div>
            </div>
          </div>
          <div class="workout-card-metrics">
            <span class="text-muted">
              <i class="fas fa-clock"></i> \${z(e.total_duration_seconds)}
            </span>
            <span class="text-muted">
      ...
      <div class="workout-card-details" id="workout-details-\${e.id}" hidden>
        <div class="grid grid-cols-auto" style="gap: var(--space-3);">
          \${q("Training Time",z(e.total_duration_seconds))}
          \${q("Exercises",e.exercise_count||0)}
          \${q("Total Sets",e.total_sets||0)}
          \${q("Total Volume",i)}
          \${q("Effort Level",e.perceived_exertion?\`\${e.perceived_exertion}/10 \${Je(e.perceived_exertion)}\`:"Not rated")}
        </div>
  ...
  \`}function gt(e){return!e||e.length===0?a\`
      <div class="empty-state">
        <div class="empty-state-icon">🏋️</div>
  ...
  \`}function yt(e){e.addEventListener("click",t=>{const r=t.target.closest("[data-legacy-call]");if(r){const l=r.getAttribute("data-legacy-call"),c=window[l];typeof c=="function"&&c();return}const n=t.target.closest("[data-tab]");if(n){const l=n.getAttribute("data-tab");typeof window.switchTab=="function"&&window.switchTab(l);return}const o=t.target.closest('[data-action="toggle-details"]');if(o){const l=o.getAttribute("data-workout-id"),c=document.getElementById(\`workout-details-\${l}\`),p=document.getElementById(\`workout-chevron-\${l}\`);c&&(c.hasAttribute("hidden")?(c.removeAttribute("hidden"),p==null||p.style.setProperty("transform","rotate(180deg)")):(c.setAttribute("hidden",""),p==null||p.style.removeProperty("transform")));return}const i=t.target.closest('[data-action="view-workout"]');if(i){t.stopPropagation();const l=parseInt(i.getAttribute("data-workout-id"),10);typeof window.viewWorkout=="function"&&window.viewWorkout(l);return}const s=t.target.closest('[data-action="delete-workout"]');if(s){t.stopPropagation();const l=parseInt(s.getAttribute("data-workout-id"),10);typeof window.deleteDashboardWorkout=="function"&&window.deleteDashboardWorkout(l);return}})}async function ht(){const e=document.getElementById("dashboard");if(e){e.innerHTML=String(mt());try{const[t,,r]=await Promise.all([g.get("/analytics/progress?days=30"),g.get("/programs"),g.get("/workouts?limit=5")]),n=t.overview||{},o=r.workouts||[];e.innerHTML=String(a\`
      <div class="stack stack-lg">
        <div class="card">
          <div class="card-header">
    ...
    \`),yt(e)}catch(t){console.error("Error loading dashboard:",t),e.innerHTML=String(ut(t.message))}}}function vt(e){const r=(e.measurement_system||"metric")==="imperial";let n="",o="";if(r&&e.height_cm){const s=Ve(e.height_cm);n=s.feet,o=s.inches}const i=r&&e.weight_kg?Math.round(ye(e.weight_kg)*10)/10:e.weight_kg||"";return a\`
    <div class="stack stack-md">
      ...
      <div id="imperial-inputs" \${r?"":"hidden"}>
        <div class="form-group">
          ...
          <div class="cluster gap-2">
            ...
            <input type="number" id="profile-height-inches" class="input" value="\${o}" placeholder="Inches" min="0" max="11" style="flex: 1;" />
          </div>
        </div>
        <div class="form-group">
      ...
      <div>
        ...
        <div class="stack stack-sm">
          \${[{id:"weekly",label:"Weekly Report",hint:"Sent every Monday morning"},{id:"monthly",label:"Monthly Report",hint:"Sent on the 1st of each month"},{id:"yearly",label:"Yearly Report",hint:"Sent on January 1st"}].map(s=>a\`
  ...
  \`}function bt(e){const t=e.querySelector("#profile-system"),r=t==null?void 0:t.value,n=e.querySelector("#metric-inputs"),o=e.querySelector("#imperial-inputs");!n||!o||(r==="imperial"?(n.setAttribute("hidden",""),o.removeAttribute("hidden")):(o.setAttribute("hidden",""),n.removeAttribute("hidden")))}async function ft(e){try{const r=(await g.get("/reports/preferences")).preferences||{},n={weekly:"weeklyReport",monthly:"monthlyReport",yearly:"yearlyReport"};for(const[o,i]of Object.entries(n)){const s=e.querySelector(\`#profile-report-\${o}\`);s&&(s.checked=!!r[i])}}catch(t){console.error("Failed to load report preferences:",t)}}async function xt(e){var t,r,n;try{return await g.put("/reports/preferences",{weeklyReport:!!((t=e.querySelector("#profile-report-weekly"))!=null&&t.checked),monthlyReport:!!((r=e.querySelector("#profile-report-monthly"))!=null&&r.checked),yearlyReport:!!((n=e.querySelector("#profile-report-yearly"))!=null&&n.checked)}),!0}catch(o){return console.error("Failed to save report preferences:",o),!1}}function wt(e){m.info(\`Generating \${e} report preview…\`);const t=localStorage.getItem("token")||"",r=t?\`?token=\${encodeURIComponent(t)}\`:"";window.open(\`/api/reports/html/\${e}\${r}\`,"_blank")}async function kt(e,t){const r=e.querySelector("#profile-name").value.trim(),n=parseInt(e.querySelector("#profile-age").value,10)||null,o=e.querySelector("#profile-gender").value,i=e.querySelector("#profile-system").value;let s,l;if(i==="imperial"){const c=parseFloat(e.querySelector("#profile-height-feet").value)||0,p=parseFloat(e.querySelector("#profile-height-inches").value)||0,h=parseFloat(e.querySelector("#profile-weight-lbs").value)||0;s=c||p?Ge(c,p):null,l=h?We(h):null}else s=parseFloat(e.querySelector("#profile-height-cm").value)||null,l=parseFloat(e.querySelector("#profile-weight-kg").value)||null;try{const c=await t.put("/auth/user",{name:r,age:n,gender:o,height_cm:s,weight_kg:l,measurement_system:i});A.set("user",c.user),await xt(e),m.success("Profile updated");const p=window.loadUser;typeof p=="function"&&p()}catch(c){throw m.error(\`Error saving profile: \${c.message}\`),c}}function St(){const e=A.get("user")||{};return M({title:"User Profile",size:"default",content:String(vt(e)),actions:[{label:"Cancel",variant:"btn-outline"},{label:"Save Profile",primary:!0,variant:"btn-primary",onClick:async r=>{try{await kt(r.element,g),r.close("saved")}catch{}}}],onOpen:({element:r})=>{ft(r),r.addEventListener("change",n=>{n.target.matches("#profile-system")&&bt(r)}),r.addEventListener("click",n=>{const o=n.target.closest('[data-action="preview"]');o&&(n.preventDefault(),wt(o.getAttribute("data-period")))})}})}const Tt=[{value:"Smith Machine",label:"Smith Machine",default:!0},{value:"Olympic Bar",label:"Olympic Bar",default:!0},{value:"Cable Trainer",label:"Cable Machine",default:!0},{value:"Leg Extension/Curl",label:"Leg Ext/Curl",default:!0},{value:"Pull-up Bar",label:"Pull-up Bar"},{value:"Landmine",label:"Landmine"},{value:"Dip Bars",label:"Dip Bars"},{value:"Rower",label:"Rower"},{value:"Treadmill",label:"Treadmill"},{value:"Stationary Bike",label:"Bike"}],zt={1:"cardio-zone-low",2:"cardio-zone-low",3:"cardio-zone-mid",4:"cardio-zone-high",5:"cardio-zone-high"};function B(){return ve()}function \$t(e){const t=e.active?a\`<span class="badge badge-success">ACTIVE</span>\`:a\`<button class="btn btn-outline btn-sm" data-action="activate" data-program-id="\${e.id}">Activate</button>\`;return a\`
  ...
  \`}async function ve(){const e=document.getElementById("program");if(e){e.innerHTML=String(a\`
    <div class="stack stack-lg">
      <div class="card">
        <div class="skeleton skeleton-card"></div>
      </div>
    </div>
  \`);try{const r=(await g.get("/programs")).programs||[],n=r.find(o=>o.active);e.innerHTML=String(a\`
      <div class="stack stack-lg">
        <div class="card">
          <div class="card-header">
        ...
        <div class="card">
          ...
          \${r.length>0?a\`<div class="stack stack-sm">\${r.map(\$t)}</div>\`:a\`
                <div class="empty-state">
                  <div class="empty-state-icon">📋</div>
    ...
    \`),Mt(e)}catch(t){console.error("Error loading programs:",t),e.innerHTML=String(a\`
      <div class="card">
        <div class="empty-state">
          <div class="empty-state-icon">⚠️</div>
    ...
    \`)}}}function Mt(e){e.addEventListener("click",t=>{const r=t.target.closest("[data-action]");if(!r)return;const n=r.getAttribute("data-action"),o=parseInt(r.getAttribute("data-program-id"),10);switch(n){case"view":t.stopPropagation(),Z(o);break;case"activate":t.stopPropagation(),J(o);break;case"generate":fe();break;case"create-manual":xe();break}})}function _t(e){return a\`
    ...
    <ul style="margin: 0 0 var(--space-4) var(--space-5); line-height: 1.8;">
      \${(e.stretches||[]).map(t=>a\`<li>\${t.name} — \${t.duration_seconds}s (\${t.muscle_group})</li>\`)}
    </ul>
  ...
  \`}function Rt(e){const t=e.cardio_sessions||[];return a\`
    <strong class="cardio-day-title">
      <i class="fas fa-fire"></i> Cardio Sessions
    </strong>
    <div class="stack stack-sm">
      \${t.map(r=>a\`
        <div class="cardio-session \${zt[r.heart_rate_zone]||"cardio-zone-mid"}">
          ...
          \${r.activity_suggestions?a\`<div class="cardio-session-note"><i class="fas fa-lightbulb"></i> \${r.activity_suggestions}</div>\`:""}
          \${r.interval_structure?a\`<div class="cardio-session-note"><i class="fas fa-stopwatch"></i> \${r.interval_structure}</div>\`:""}
        </div>
      \`)}
    </div>
  ...
  \`}function Ct(e){return a\`
    <div class="program-day-card">
      <h4>
        Day \${e.day_number}: \${e.name}
        \${e.is_cardio_day?a\`<span class="badge badge-danger"><i class="fas fa-heartbeat"></i> Cardio</span>\`:""}
      </h4>
      <p class="text-muted" style="margin-bottom: var(--space-3); font-weight: var(--font-medium);">\${e.focus}</p>
      \${e.is_cardio_day?Rt(e):_t(e)}
    </div>
  \`}async function Z(e){try{const r=(await g.get(\`/programs/\${e}\`)).program,n=r.created_at?\$(r.created_at,{year:"numeric",month:"short",day:"numeric"}):"Unknown";return M({title:"Program Details",size:"wide",content:String(a\`
        ...
        \${r.description?a\`<p class="text-muted" style="margin-top: var(--space-2); font-style: italic;">\${r.description}</p>\`:""}
        \${r.custom_instructions?a\`
      ...
      \`),actions:[{label:"Start Workout",primary:!0,variant:"btn-primary",onClick:i=>{i.close(),Ft(e)}},...r.active?[]:[{label:"Set as Active",variant:"btn-secondary",onClick:async i=>{await J(e,{silent:!1}),i.close()}}],{label:"Delete",variant:"btn-danger",onClick:async i=>{if(await N("Delete this program? This cannot be undone.",{title:"Delete program?",confirmLabel:"Delete",confirmVariant:"btn-danger"}))try{await g.delete(\`/programs/\${e}\`),m.success("Program deleted"),i.close(),B()}catch(l){m.error(\`Error deleting program: \${l.message}\`)}}}],onOpen:({element:i})=>{var s;(s=i.querySelector('[data-action="rename"]'))==null||s.addEventListener("click",()=>{be(e,r.name)})}})}catch(t){m.error(\`Error loading program: \${t.message}\`)}}function be(e,t){M({title:"Rename Program",size:"default",content:String(a\`
      <div class="form-group">
        <label class="form-label" for="rename-input">Program name</label>
        <input type="text" id="rename-input" class="input" value="\${t}" />
      </div>
    \`),actions:[{label:"Cancel",variant:"btn-outline"},{label:"Save Name",primary:!0,onClick:async r=>{const n=r.element.querySelector("#rename-input").value.trim();if(!n){m.warning("Please enter a program name");return}try{await g.patch(\`/programs/\${e}\`,{name:n}),m.success("Program renamed"),r.close(),B(),Z(e)}catch(o){m.error(\`Failed to rename: \${o.message}\`)}}}],onOpen:({element:r})=>{const n=r.querySelector("#rename-input");n==null||n.focus(),n==null||n.select()}})}async function J(e,t={}){try{await g.post(\`/programs/\${e}/activate\`),t.silent||m.success("Program activated"),B()}catch(r){m.error(\`Error activating program: \${r.message}\`)}}async function Et(e){if(await N("Are you sure you want to delete this program?",{title:"Delete program?",confirmLabel:"Delete",confirmVariant:"btn-danger"}))try{await g.delete(\`/programs/\${e}\`),m.success("Program deleted"),B()}catch(r){m.error(\`Error deleting program: \${r.message}\`)}}function fe(){M({title:"Generate AI Program",size:"default",content:String(a\`
      <div class="stack stack-md">
        <div class="form-group">
    ...
    \`),actions:[{label:"Cancel",variant:"btn-outline"},{label:"Generate",primary:!0,variant:"btn-primary",onClick:async e=>{await Pt(e)}}]})}async function Pt(e){const t=e.element,r=parseInt(t.querySelector("#gen-days").value,10),n=t.querySelector("#gen-goal").value,o=t.querySelector("#gen-custom").value.trim(),i=Array.from(t.querySelectorAll('input[name="equipment"]:checked')).map(c=>c.value),s=t.querySelector(".modal-body");s.innerHTML=String(a\`
  ...
  \`);const l=t.querySelector(".modal-footer");l&&(l.style.display="none");try{await g.post("/programs/generate",{days_per_week:r,goal:n,custom_instructions:o,available_equipment:i}),s.innerHTML=String(a\`
      <div class="generate-progress">
    ...
    \`),setTimeout(()=>{e.close(),B()},1500)}catch(c){s.innerHTML=String(a\`
      <div class="generate-progress">
    ...
    \`),l&&(l.style.display="")}}const d={name:"",days_per_week:3,goal:"hypertrophy",days:[],currentDayIndex:0,availableExercises:[],modalApi:null};async function xe(){d.days=[],d.currentDayIndex=0;try{const e=await g.get("/exercises");d.availableExercises=e.exercises||[]}catch{m.error("Error loading exercises");return}It()}function It(){d.modalApi&&d.modalApi.close(),d.modalApi=M({title:"Create Custom Program",size:"wide",content:String(a\`
    ...
    \`),actions:[{label:"Cancel",variant:"btn-outline"},{label:"Next: Configure Days",primary:!0,onClick:e=>{const t=e.element.querySelector("#builder-name").value.trim(),r=parseInt(e.element.querySelector("#builder-days").value,10),n=e.element.querySelector("#builder-goal").value;if(!t){m.warning("Please enter a program name");return}d.name=t,d.days_per_week=r,d.goal=n,d.days=Array.from({length:r},(o,i)=>({day_number:i+1,name:\`Day \${i+1}\`,focus:"",exercises:[]})),d.currentDayIndex=0,O()}}]})}function O(){const e=d.days[d.currentDayIndex],t=At(d.availableExercises),r=d.currentDayIndex===d.days_per_week-1;d.modalApi&&d.modalApi.close(),d.modalApi=M({title:"Create Custom Program",size:"wide",content:String(a\`
    ...
    \`),actions:[...d.currentDayIndex>0?[{label:"← Previous Day",variant:"btn-outline",onClick:()=>{j(),d.currentDayIndex--,O()}}]:[],{label:"Cancel",variant:"btn-ghost"},{label:r?"Finish & Save":"Next Day →",primary:!0,onClick:async()=>{if(j(),e.exercises.length===0){m.warning("Please select at least one exercise for this day");return}r?await Dt():(d.currentDayIndex++,O())}}],onOpen:({element:n})=>Lt(n)})}function j(){var o;const e=(o=d.modalApi)==null?void 0:o.element;if(!e)return;const t=d.days[d.currentDayIndex],r=e.querySelector("#builder-day-name"),n=e.querySelector("#builder-day-focus");r&&(t.name=r.value.trim()||\`Day \${t.day_number}\`),n&&(t.focus=n.value.trim())}function At(e){const t={};for(const r of e){const n=r.muscle_group||"Other";t[n]||(t[n]=[]),t[n].push(r)}return t}function Bt(e,t){const r=t.exercises.find(n=>n.exercise_id===e.id);return a\`
  ...
  \`}function Lt(e){e.addEventListener("change",t=>{const r=t.target.closest("[data-builder-toggle]");if(r){const o=parseInt(r.getAttribute("data-builder-toggle"),10);Ht(o);return}const n=t.target.closest("[data-builder-config]");if(n){const[o,i]=n.getAttribute("data-builder-config").split(":");qt(parseInt(o,10),i,t.target.value)}})}function Ht(e){j();const t=d.days[d.currentDayIndex],r=t.exercises.findIndex(n=>n.exercise_id===e);if(r>=0)t.exercises.splice(r,1);else{const n=d.availableExercises.find(o=>o.id===e);t.exercises.push({exercise_id:e,name:(n==null?void 0:n.name)||"",sets:3,reps:"8-12",rest_seconds:90})}O()}function qt(e,t,r){const o=d.days[d.currentDayIndex].exercises.find(i=>i.exercise_id===e);o&&(t==="reps"?o.reps=r:o[t]=parseInt(r,10)||0)}async function Dt(){var e;try{await g.post("/programs/manual",{name:d.name,days_per_week:d.days_per_week,goal:d.goal,days:d.days}),m.success("Custom program created!"),(e=d.modalApi)==null||e.close(),d.modalApi=null,B()}catch(t){m.error(\`Error creating program: \${t.message}\`)}}async function Ft(e){const t=window.__legacyStartWorkoutFromProgram;if(typeof t=="function")return t(e);typeof window.switchTab=="function"&&window.switchTab("workout")}function U(e){if(e===0||e==null)return a\`<span class="text-muted">—</span>\`;const r=e>0?"text-success":"text-danger";return a\`<span class="\${r}" style="font-weight: var(--font-semibold);">\${Ze(e)}</span>\`}function oe(e,t){const r=n=>\$(n,{month:"short",day:"numeric"});return\`\${r(e)} – \${r(t)}\`}function ie(e,t,r){if(!r)return"";const{current:n,previous:o,changes:i}=r;return a\`
    <div style="margin-bottom: var(--space-5);">
      ...
      <div class="comparison-date-row">
        ...
        <span>\${oe(o.start_date,o.end_date)}</span>
      </div>
      <div class="progress-comparison-grid">
        <div class="progress-comparison-card">
          ...
          <div class="progress-comparison-values">
            <span class="progress-comparison-current">\${w(n.total_volume)}</span>
            <span class="progress-comparison-previous">vs \${w(o.total_volume)}</span>
          </div>
          <div class="progress-comparison-change">\${U(i.total_volume)}</div>
        </div>
        <div class="progress-comparison-card">
          <div class="progress-comparison-label">Workout Time</div>
          <div class="progress-comparison-values">
            <span class="progress-comparison-current">\${z(n.total_time)}</span>
            <span class="progress-comparison-previous">vs \${z(o.total_time)}</span>
          </div>
          <div class="progress-comparison-change">\${U(i.total_time)}</div>
        </div>
        <div class="progress-comparison-card">
          <div class="progress-comparison-label">Workouts</div>
          <div class="progress-comparison-values">
            <span class="progress-comparison-current">\${n.workout_count}</span>
            <span class="progress-comparison-previous">vs \${o.workout_count}</span>
          </div>
          <div class="progress-comparison-change">\${U(i.workout_count)}</div>
        </div>
      </div>
    </div>
  \`}function Wt(e){return a\`
    <div class="grid grid-cols-auto">
      <div class="stat-card">
        <div class="stat-label">Total Workouts</div>
        <div class="stat-value">\${e.total_workouts||0}</div>
  ...
  \`}function Ot(e){return!e||e.length===0?a\`
      <div class="empty-state">
        <div class="empty-state-icon">📊</div>
  ...
  \`}function Vt(e){return!e||e.length===0?a\`
      <div class="empty-state">
  ...
  \`}function Gt(e){return!e||e.length===0?a\`
    ...
    \`:a\`
    <div class="grid grid-cols-auto">
      \${e.map(t=>{const r=t.previous_value?(t.record_value-t.previous_value)/t.previous_value*100:null;return a\`
          <div class="pr-row">
            <div>
            ...
            <div style="text-align: right;">
              ...
              \${r!=null?a\`<div class="text-success" style="font-size: var(--text-xs);">+\${r.toFixed(1)}%</div>\`:""}
            </div>
          </div>
        \`})}
    </div>
  ...
  \`}async function jt(){if(await N("This will recalculate all your Personal Records from your workout history. Continue?",{title:"Recalculate PRs?",confirmLabel:"Recalculate",confirmVariant:"btn-primary"}))try{const t=await g.post("/achievements/prs/recalculate");m.success(t.message||"PRs recalculated"),we()}catch(t){m.error(\`Failed to recalculate PRs: \${t.message}\`)}}function Zt(e){e.addEventListener("click",t=>{if(t.target.closest('[data-action="recalc-prs"]')){jt();return}t.target.closest('[data-action="open-exporter"]')&&(typeof window.openUnifiedExporter=="function"?window.openUnifiedExporter():m.info("Export center is not yet available"))})}async function we(){const e=document.getElementById("analytics");if(e){e.innerHTML=String(Ut());try{const[t,r,n,o,i]=await Promise.all([g.get("/analytics/progress?days=90"),g.get("/analytics/volume?days=90&group_by=week"),g.get("/analytics/bodymap?days=7"),g.get("/achievements/prs?limit=10"),g.get("/analytics/progress-comparison")]),s=o.prs||[],l=t.overview||{},c=r.volume_by_muscle||[],p=n.body_map||[],h=t.top_exercises||[];e.innerHTML=String(a\`
      <div class="stack stack-lg">
        <div class="card">
          <div class="card-header">
            <h2 class="card-title"><i class="fas fa-chart-line"></i> Progress Comparison</h2>
          </div>
          \${ie("This Week vs Last Week","fa-calendar-week",i.weekly)}
          \${ie("This Month vs Last Month","fa-calendar-alt",i.monthly)}
        </div>
    ...
    \`),Zt(e);const u=window.loadWorkoutHistory;if(typeof u=="function")try{await u(e)}catch(f){console.warn("Legacy loadWorkoutHistory failed:",f)}}catch(t){console.error("Error loading analytics:",t),e.innerHTML=String(Kt(t.message))}}}window.__fitnessApp={store:A,api:g,toast:m,openModal:M,confirmDialog:N};b("learn","loadLearn",Fe);b("achievements","loadAchievements",lt);b("dashboard","loadDashboard",ht);b("profile","showProfile",St);b("program","loadPrograms",ve);b("programs:view","viewProgram",Z);b("programs:activate","activateProgram",J);b("programs:delete","deleteProgram",Et);b("programs:generate","showGenerateProgram",fe);b("programs:manual","showCreateManualProgram",xe);b("programs:rename","showRenameProgramModal",be);b("analytics","loadAnalytics",we);Le();
//# sourceMappingURL=index-94sJKG9S.js.map
